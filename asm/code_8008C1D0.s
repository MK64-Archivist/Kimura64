...
/* 08CFF4 8008C3F4 0C023555 */  jal   MakeShakeHitcamera
...
/* 08D0D4 8008C4D4 0C023D69 */  jal   ResetRolloverFall
...
/* 08D1DC 8008C5DC 0C03243D */  jal   NaPlyVoiceStart
...
/* 08D1EC 8008C5EC 0C032418 */  jal   NaPlyTrgStart
...
/* 08D23C 8008C63C 0C00C7D2 */  jal   AcceleOff
...
/* 08D2A0 8008C6A0 3C0D800E */  lui   $t5, %hi(gGameMode) # $t5, 0x800e
/* 08D2A4 8008C6A4 8DADC53C */  lw    $t5, %lo(gGameMode)($t5)
...
/* 08D498 8008C898 0C03243D */  jal   NaPlyVoiceStart
...
/* 08D54C 8008C94C 3C0A800E */  lui   $t2, %hi(gGameMode) # $t2, 0x800e
...
.L8008C97C:
/* 08D57C 8008C97C 8D4AC53C */  lw    $t2, %lo(gGameMode)($t2)
...
/* 08D5C8 8008C9C8 8F1843B8 */  lw    $t8, %lo(OgawaRank)($t8)
...
/* 08D63C 8008CA3C 0C00C7D2 */  jal   AcceleOff
...
/* 08D690 8008CA90 0C00C7D2 */  jal   AcceleOff
...
/* 08D7C4 8008CBC4 3C0D800E */  lui   $t5, %hi(gGameMode) # $t5, 0x800e
/* 08D7C8 8008CBC8 5D600061 */  bgtzl $t3, .L8008CD50
/* 08D7CC 8008CBCC 83A20047 */   lb    $v0, 0x47($sp)
/* 08D7D0 8008CBD0 8DADC53C */  lw    $t5, %lo(gGameMode)($t5)
...
/* 08D92C 8008CD2C 3C09800E */  lui   $t1, %hi(gGameMode) # $t1, 0x800e
/* 08D930 8008CD30 8D29C53C */  lw    $t1, %lo(gGameMode)($t1)
...
.L8008CE8C:
/* 08DA8C 8008CE8C 0C0231CF */  jal   SetSpin
...
/* 08DBC4 8008CFC4 0C0231CF */  jal   SetSpin
...
/* 08DC30 8008D030 0C03243D */  jal   NaPlyVoiceStart
...
/* 08DCB8 8008D0B8 0C0231CF */  jal   SetSpin
...
/* 08DE98 8008D298 0C0231CF */  jal   SetSpin
...
/* 08DF00 8008D300 0C03243D */  jal   NaPlyVoiceStart
...
/* 08DF88 8008D388 0C0231CF */  jal   SetSpin
...
/* 08E014 8008D414 3C0A8016 */  lui   $t2, %hi(gReplayFlag) # $t2, 0x8016
/* 08E018 8008D418 E6040DBC */  swc1  $f4, 0xdbc($s0)
/* 08E01C 8008D41C 954AF890 */  lhu   $t2, %lo(gReplayFlag)($t2)
/* 08E020 8008D420 24010001 */  li    $at, 1
/* 08E024 8008D424 3C0D800E */  lui   $t5, %hi(gKart1) # $t5, 0x800e
...
/* 08E050 8008D450 0C032494 */  jal   NaPlyDashStart
...
/* 08E060 8008D460 0C032418 */  jal   NaPlyTrgStart
...
/* 08E090 8008D490 0C032418 */  jal   NaPlyTrgStart
...
/* 08E0F0 8008D4F0 0C008973 */  jal   ChaseFNumber
...
/* 08E10C 8008D50C 0C008973 */  jal   ChaseFNumber
...
/* 08E240 8008D640 0C032418 */  jal   NaPlyTrgStart
...
/* 08E280 8008D680 0C03243D */  jal   NaPlyVoiceStart
...
/* 08E49C 8008D89C 0C03243D */  jal   NaPlyVoiceStart
...
/* 08E7C0 8008DBC0 0C03243D */  jal   NaPlyVoiceStart
...
/* 08E91C 8008DD1C 0C032418 */  jal   NaPlyTrgStart
...
/* 08E968 8008DD68 0C032418 */  jal   NaPlyTrgStart
...
/* 08EB80 8008DF80 0C03243D */  jal   NaPlyVoiceStart
...
/* 08EC18 8008E018 3C01800E */  lui   $at, %hi(gRaceTimer) # $at, 0x800e
...
/* 08EC40 8008E040 C424C598 */  lwc1  $f4, %lo(gRaceTimer)($at)
...
/* 08ECC8 8008E0C8 0C03243D */  jal   NaPlyVoiceStart
...
.L8008E0E0:
/* 08ECE0 8008E0E0 3C0B800E */  lui   $t3, %hi(gGameMode) # $t3, 0x800e
/* 08ECE4 8008E0E4 8D6BC53C */  lw    $t3, %lo(gGameMode)($t3)
...
/* 08EDC0 8008E1C0 0C0236AF */  jal   SetBroken
...
.L8008E280:
/* 08EE80 8008E280 0C00C7D2 */  jal   AcceleOff
...
/* 08EEEC 8008E2EC 0C03243D */  jal   NaPlyVoiceStart
...
/* 08EF18 8008E318 0C008973 */  jal   ChaseFNumber
...
/* 08EF58 8008E358 0C008973 */  jal   ChaseFNumber
...
/* 08EFA4 8008E3A4 0C03243D */  jal   NaPlyVoiceStart
...
/* 08EFE0 8008E3E0 0C008973 */  jal   ChaseFNumber
...
/* 08F008 8008E408 0C008973 */  jal   ChaseFNumber
...
/* 08F194 8008E594 3C18800E */   lui   $t8, %hi(gGameMode) # $t8, 0x800e
...
.L8008E5B0:
/* 08F1B0 8008E5B0 8F18C53C */  lw    $t8, %lo(gGameMode)($t8)
...
/* 08F240 8008E640 3C19800E */  lui   $t9, %hi(gGameMode) # $t9, 0x800e
/* 08F244 8008E644 8F39C53C */  lw    $t9, %lo(gGameMode)($t9)
...
/* 08F368 8008E768 3C0B800E */   lui   $t3, %hi(gGameMode) # $t3, 0x800e
/* 08F36C 8008E76C 8D6BC53C */  lw    $t3, %lo(gGameMode)($t3)
...
/* 08F384 8008E784 3C0D800E */   lui   $t5, %hi(gDemoFlag) # $t5, 0x800e
/* 08F388 8008E788 95ADC51C */  lhu   $t5, %lo(gDemoFlag)($t5)
...
/* 08F3B4 8008E7B4 0C03243D */  jal   NaPlyVoiceStart
/* 08F3B8 8008E7B8 AFA40020 */   sw    $a0, 0x20($sp)
/* 08F3BC 8008E7BC 3C0E800E */  lui   $t6, %hi(gGameMode) # $t6, 0x800e
/* 08F3C0 8008E7C0 8DCEC53C */  lw    $t6, %lo(gGameMode)($t6)
...
/* 08F3D4 8008E7D4 3C19800E */  lui   $t9, %hi(gDemoFlag) # $t9, 0x800e
...
/* 08F3E4 8008E7E4 9739C51C */  lhu   $t9, %lo(gDemoFlag)($t9)
...
/* 08F400 8008E800 0C032418 */  jal   NaPlyTrgStart
...
/* 08F5B4 8008E9B4 3C0E800E */  lui   $t6, %hi(gGameMode) # $t6, 0x800e
...
.L8008E9E4:
/* 08F5E4 8008E9E4 8DCEC53C */  lw    $t6, %lo(gGameMode)($t6)
...
/* 08F688 8008EA88 3C09800E */  lui   $t1, %hi(gGameMode) # $t1, 0x800e
...
.L8008EAB8:
/* 08F6B8 8008EAB8 8D29C53C */  lw    $t1, %lo(gGameMode)($t1)
...
/* 08F790 8008EB90 0C03243D */  jal   NaPlyVoiceStart
...
/* 08F7A0 8008EBA0 0C032418 */  jal   NaPlyTrgStart
...
/* 08F8E8 8008ECE8 3C0A8016 */  lui   $t2, %hi(gReplayFlag) # $t2, 0x8016
/* 08F8EC 8008ECEC E6040DBC */  swc1  $f4, 0xdbc($s0)
/* 08F8F0 8008ECF0 954AF890 */  lhu   $t2, %lo(gReplayFlag)($t2)
/* 08F8F4 8008ECF4 24010001 */  li    $at, 1
/* 08F8F8 8008ECF8 3C0E800E */  lui   $t6, %hi(gKart1) # $t6, 0x800e
...
/* 08F934 8008ED34 0C03243D */  jal   NaPlyVoiceStart
...
/* 08F944 8008ED44 0C032418 */  jal   NaPlyTrgStart
...
.L8008ED54:
/* 08F954 8008ED54 8DCEC4DC */  lw    $t6, %lo(gKart1)($t6)
...
/* 08F978 8008ED78 0C03243D */  jal   NaPlyVoiceStart
...
/* 08F988 8008ED88 0C032418 */  jal   NaPlyTrgStart
...
/* 08FA1C 8008EE1C 0C008973 */  jal   ChaseFNumber
...
/* 08FA34 8008EE34 0C008973 */  jal   ChaseFNumber
...
/* 08FB34 8008EF34 3C0A8016 */  lui   $t2, %hi(gReplayFlag) # $t2, 0x8016
/* 08FB38 8008EF38 954AF890 */  lhu   $t2, %lo(gReplayFlag)($t2)
/* 08FB3C 8008EF3C 24010001 */  li    $at, 1
/* 08FB40 8008EF40 3C0E800E */  lui   $t6, %hi(gKart1) # $t6, 0x800e
...
/* 08FB7C 8008EF7C 0C03243D */  jal   NaPlyVoiceStart
...
/* 08FB8C 8008EF8C 0C032418 */  jal   NaPlyTrgStart
...
.L8008EF9C:
/* 08FB9C 8008EF9C 8DCEC4DC */  lw    $t6, %lo(gKart1)($t6)
...
/* 08FBC0 8008EFC0 0C03243D */  jal   NaPlyVoiceStart
...
/* 08FBD0 8008EFD0 0C032418 */  jal   NaPlyTrgStart
...
/* 08FC58 8008F058 0C008973 */  jal   ChaseFNumber
...
/* 08FC78 8008F078 0C008973 */  jal   ChaseFNumber
...
/* 08FDA0 8008F1A0 0C03243D */  jal   NaPlyVoiceStart
...
/* 090074 8008F474 0C0241DE */  jal   SetJugemu
/* 090078 8008F478 AFA40018 */   sw    $a0, 0x18($sp)
/* 09007C 8008F47C 0C02421A */  jal   CallJugemu
...
.L8008F4D4:
/* 0900D4 8008F4D4 3C09800E */   lui   $t1, %hi(gGameMode) # $t1, 0x800e
/* 0900D8 8008F4D8 8D29C53C */  lw    $t1, %lo(gGameMode)($t1)
...
/* 09018C 8008F58C 0C03243D */  jal   NaPlyVoiceStart
...
glabel Star
/* 090250 8008F650 3C01800E */  lui   $at, %hi(gRaceTimer) # $at, 0x800e
/* 090254 8008F654 C424C598 */  lwc1  $f4, %lo(gRaceTimer)($at)
...
/* 0902E4 8008F6E4 3C01800E */  lui   $at, %hi(gRaceTimer) # $at, 0x800e
/* 0902E8 8008F6E8 8FA70020 */  lw    $a3, 0x20($sp)
/* 0902EC 8008F6EC AC400000 */  sw    $zero, ($v0)
/* 0902F0 8008F6F0 C428C598 */  lwc1  $f8, %lo(gRaceTimer)($at)
...
/* 090328 8008F728 3C01800E */  lui   $at, %hi(gRaceTimer) # $at, 0x800e
/* 09032C 8008F72C 8FA70020 */  lw    $a3, 0x20($sp)
/* 090330 8008F730 AC400000 */  sw    $zero, ($v0)
/* 090334 8008F734 C430C598 */  lwc1  $f16, %lo(gRaceTimer)($at)
...
/* 0903C0 8008F7C0 3C01800E */  lui   $at, %hi(gRaceTimer) # $at, 0x800e
/* 0903C4 8008F7C4 AC9900BC */  sw    $t9, 0xbc($a0)
/* 0903C8 8008F7C8 AC89000C */  sw    $t1, 0xc($a0)
/* 0903CC 8008F7CC C424C598 */  lwc1  $f4, %lo(gRaceTimer)($at)
...
glabel VsGhost
/* 0904DC 8008F8DC 3C01800E */  lui   $at, %hi(gRaceTimer) # $at, 0x800e
/* 0904E0 8008F8E0 C424C598 */  lwc1  $f4, %lo(gRaceTimer)($at)
...
/* 0906D0 8008FAD0 3C01800E */  lui   $at, %hi(gRaceTimer) # $at, 0x800e
/* 0906D4 8008FAD4 ACCE00BC */  sw    $t6, 0xbc($a2)
/* 0906D8 8008FAD8 ACD8000C */  sw    $t8, 0xc($a2)
/* 0906DC 8008FADC C424C598 */  lwc1  $f4, %lo(gRaceTimer)($at)
...
/* 090838 8008FC38 0C009F40 */  jal   CheckKartNumber
...
/* 09084C 8008FC4C 0C015AA5 */  jal   KWFinishBombKart
...
/* 0908C4 8008FCC4 0C015A7D */  jal   KWStartBombKart
...
.L8008FD34:
/* 090934 8008FD34 0C015A90 */  jal   KWSetBombKartAlpha
...
/* 090B08 8008FF08 3C18800E */  lui   $t8, %hi(gMapNumber) # $t8, 0x800e
/* 090B0C 8008FF0C 8718C5A0 */  lh    $t8, %lo(gMapNumber)($t8)
...
/* 090B2C 8008FF2C 3C01800F */  lui   $at, %hi(jtbl_800EF5B0)
/* 090B30 8008FF30 00390821 */  addu  $at, $at, $t9
/* 090B34 8008FF34 8C39F5B0 */  lw    $t9, %lo(jtbl_800EF5B0)($at)
...
/* 090B9C 8008FF9C 3C0C8016 */  lui   $t4, %hi(gCenterLineMaxBP) # $t4, 0x8016
/* 090BA0 8008FFA0 04410073 */  bgez  $v0, .L80090170
/* 090BA4 8008FFA4 00000000 */   nop
/* 090BA8 8008FFA8 958C45C8 */  lhu   $t4, %lo(gCenterLineMaxBP)($t4)
...
/* 090BF4 8008FFF4 3C198016 */  lui   $t9, %hi(gCenterLineMaxBP) # $t9, 0x8016
/* 090BF8 8008FFF8 0441005D */  bgez  $v0, .L80090170
/* 090BFC 8008FFFC 00000000 */   nop
/* 090C00 80090000 973945C8 */  lhu   $t9, %lo(gCenterLineMaxBP)($t9)
...
/* 090C60 80090060 3C0D8016 */  lui   $t5, %hi(gCenterLineMaxBP) # $t5, 0x8016
...
/* 090C74 80090074 95AD45C8 */  lhu   $t5, %lo(gCenterLineMaxBP)($t5)
...
/* 090CBC 800900BC 3C198016 */  lui   $t9, %hi(gCenterLineMaxBP) # $t9, 0x8016
...
/* 090CD0 800900D0 973945C8 */  lhu   $t9, %lo(gCenterLineMaxBP)($t9)
...
/* 090D1C 8009011C 3C0C8016 */  lui   $t4, %hi(gCenterLineMaxBP) # $t4, 0x8016
/* 090D20 80090120 04410013 */  bgez  $v0, .L80090170
/* 090D24 80090124 00000000 */   nop
/* 090D28 80090128 958C45C8 */  lhu   $t4, %lo(gCenterLineMaxBP)($t4)
...
/* 090D50 80090150 3C188016 */  lui   $t8, %hi(gCenterLineMaxBP) # $t8, 0x8016
...
/* 090D64 80090164 971845C8 */  lhu   $t8, %lo(gCenterLineMaxBP)($t8)
...
/* 091018 80090418 3C19800E */  lui   $t9, %hi(gMapNumber) # $t9, 0x800e
...
/* 09104C 8009044C 8739C5A0 */  lh    $t9, %lo(gMapNumber)($t9)
...
/* 091060 80090460 3C01800F */  lui   $at, %hi(jtbl_800EF5F8)
/* 091064 80090464 002E0821 */  addu  $at, $at, $t6
/* 091068 80090468 8C2EF5F8 */  lw    $t6, %lo(jtbl_800EF5F8)($at)
...
/* 0912CC 800906CC 3C0F8016 */  lui   $t7, %hi(gCenterLineMaxBP) # $t7, 0x8016
...
/* 0912F0 800906F0 95EF45C8 */  lhu   $t7, %lo(gCenterLineMaxBP)($t7)
...
/* 091384 80090784 0C009F40 */  jal   CheckKartNumber
...
/* 091484 80090884 0C009F40 */  jal   CheckKartNumber
...
/* 0914D8 800908D8 3C03800E */  lui   $v1, %hi(gMapNumber) # $v1, 0x800e
...
/* 0914FC 800908FC 2463C5A0 */  addiu $v1, %lo(gMapNumber) # addiu $v1, $v1, -0x3a60
...
/* 091658 80090A58 0C008973 */  jal   ChaseFNumber
...
/* 091678 80090A78 0C00898D */  jal   ChaseSNumber
...
/* 0916F0 80090AF0 0C008973 */  jal   ChaseFNumber
...
/* 091710 80090B10 0C00898D */  jal   ChaseSNumber
...
/* 09179C 80090B9C 0C027822 */  jal   SetFadeOutScreen
...
/* 0917E4 80090BE4 0C008973 */  jal   ChaseFNumber
...
/* 091844 80090C44 0C008973 */  jal   ChaseFNumber
...
/* 09189C 80090C9C 0C0AD489 */  jal   CalcDirection
...
/* 09190C 80090D0C 0C027808 */  jal   SetFadeInScreen
...
/* 09197C 80090D7C 0C0AE00E */  jal   CosT
...
/* 0919AC 80090DAC 0C0AE006 */  jal   SinT
...
/* 091A34 80090E34 0C0AE00E */  jal   CosT
...
/* 091A60 80090E60 0C0AE006 */  jal   SinT
...
/* 091AF8 80090EF8 0C008973 */  jal   ChaseFNumber
...
.L80090F60:
/* 091B60 80090F60 3C0D800E */  lui   $t5, %hi(gGameMode) # $t5, 0x800e
/* 091B64 80090F64 8DADC53C */  lw    $t5, %lo(gGameMode)($t5)
...
/* 091BE0 80090FE0 0C023C41 */  jal   SetRapidAcc
...
/* 092060 80091460 3C19800F */  lui   $t9, %hi(gKartData) # $t9, 0x800f
/* 092064 80091464 27396990 */  addiu $t9, %lo(gKartData) # addiu $t9, $t9, 0x6990
...
/* 0920A0 800914A0 3C0E800E */  lui   $t6, %hi(gMyKart1) # $t6, 0x800e
/* 0920A4 800914A4 8DCEC4FC */  lw    $t6, %lo(gMyKart1)($t6)
...
/* 092154 80091554 3C09800E */  lui   $t1, %hi(gMyKart1) # $t1, 0x800e
/* 092158 80091558 00412024 */  and   $a0, $v0, $at
/* 09215C 8009155C 2529C4FC */  addiu $t1, %lo(gMyKart1) # addiu $t1, $t1, -0x3b04
...
/* 0921C0 800915C0 3C09800E */  lui   $t1, %hi(gMyKart1) # $t1, 0x800e
...
/* 0921D0 800915D0 2529C4FC */   addiu $t1, %lo(gMyKart1) # addiu $t1, $t1, -0x3b04
.L800915D4:
...
/* 092200 80091600 3C09800E */  lui   $t1, %hi(gMyKart1) # $t1, 0x800e
/* 092204 80091604 3C088015 */  lui   $t0, %hi(D_80152308) # $t0, 0x8015
/* 092208 80091608 95082308 */  lhu   $t0, %lo(D_80152308)($t0)
/* 09220C 8009160C 2529C4FC */  addiu $t1, %lo(gMyKart1) # addiu $t1, $t1, -0x3b04
.L80091610:
...
/* 0922B0 800916B0 0C0AB772 */  jal   CheckBump
...
/* 0922FC 800916FC 0C0ADE0C */  jal   Atan2t
...
/* 092328 80091728 0C0ADE0C */  jal   Atan2t
