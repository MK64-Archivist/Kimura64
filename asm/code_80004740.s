...
/* 00576C 80004B6C 3C0C8015 */  lui   $t4, %hi(gDynamicIcp) # $t4, 0x8015
/* 005770 80004B70 8D8CEF40 */  lw    $t4, %lo(gDynamicIcp)($t4)
...
/* 00578C 80004B8C 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 005790 80004B90 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
...
/* 0057C4 80004BC4 3C0B8015 */  lui   $t3, %hi(gDynamicIcp) # $t3, 0x8015
/* 0057C8 80004BC8 8D6BEF40 */  lw    $t3, %lo(gDynamicIcp)($t3)
...
/* 0057F4 80004BF4 0C0A9EF5 */  jal   SegmentToVirtual
/* 0057F8 80004BF8 00C02025 */   move  $a0, $a2
/* 0057FC 80004BFC 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 005800 80004C00 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
...
/* 00586C 80004C6C 0C0A9EF5 */  jal   SegmentToVirtual
/* 005870 80004C70 A7A60052 */   sh    $a2, 0x52($sp)
/* 005874 80004C74 AFA20040 */  sw    $v0, 0x40($sp)
/* 005878 80004C78 0C0A9EF5 */  jal   SegmentToVirtual
...
/* 0058FC 80004CFC 3C118015 */  lui   $s1, %hi(gGraphPtr) # $s1, 0x8015
/* 005900 80004D00 2454000C */  addiu $s4, $v0, 0xc
/* 005904 80004D04 A6A00000 */  sh    $zero, ($s5)
/* 005908 80004D08 26310298 */  addiu $s1, %lo(gGraphPtr) # addiu $s1, $s1, 0x298
...
/* 005A1C 80004E1C 0C0A9EF5 */  jal   SegmentToVirtual
/* 005A20 80004E20 AFA70034 */   sw    $a3, 0x34($sp)
/* 005A24 80004E24 AFA20024 */  sw    $v0, 0x24($sp)
/* 005A28 80004E28 0C0A9EF5 */  jal   SegmentToVirtual
...
/* 005A3C 80004E3C 0C0A9EF5 */  jal   SegmentToVirtual
...
/* 005AB4 80004EB4 0C0A9EF5 */  jal   SegmentToVirtual
...
/* 005AC8 80004EC8 0C0A9EF5 */  jal   SegmentToVirtual
