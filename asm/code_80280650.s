...
/* 123F04 802808C4 0C0AE006 */  jal   SinT
...
/* 124088 80280A48 0C008784 */  jal   CreateAffine
...
/* 1240B0 80280A70 3C0F8016 */  lui   $t7, %hi(gEffectCount) # $t7, 0x8016
/* 1240B4 80280A74 460C4282 */  mul.s $f10, $f8, $f12
/* 1240B8 80280A78 C4480014 */  lwc1  $f8, 0x14($v0)
/* 1240BC 80280A7C 85EF4AF0 */  lh    $t7, %lo(gEffectCount)($t7)
...
/* 1240F8 80280AB8 3C0E8015 */  lui   $t6, %hi(gDynamicIcp) # $t6, 0x8015
/* 1240FC 80280ABC 460C4282 */  mul.s $f10, $f8, $f12
/* 124100 80280AC0 E7B20038 */  swc1  $f18, 0x38($sp)
/* 124104 80280AC4 8DCEEF40 */  lw    $t6, %lo(gDynamicIcp)($t6)
...
/* 124128 80280AE8 0C008860 */  jal   Affine2Mtx
/* 12412C 80280AEC 27A50020 */   addiu $a1, $sp, 0x20
/* 124130 80280AF0 3C048015 */  lui   $a0, %hi(gGraphPtr) # $a0, 0x8015
/* 124134 80280AF4 24840298 */  addiu $a0, %lo(gGraphPtr) # addiu $a0, $a0, 0x298
...
/* 12414C 80280B0C 3C0A8016 */  lui   $t2, %hi(gEffectCount) # $t2, 0x8016
/* 124150 80280B10 AC680000 */  sw    $t0, ($v1)
/* 124154 80280B14 854A4AF0 */  lh    $t2, %lo(gEffectCount)($t2)
/* 124158 80280B18 3C098015 */  lui   $t1, %hi(gDynamicIcp) # $t1, 0x8015
/* 12415C 80280B1C 8D29EF40 */  lw    $t1, %lo(gDynamicIcp)($t1)
...
/* 1241A8 80280B68 3C0F800E */  lui   $t7, %hi(gCamera1) # $t7, 0x800e
/* 1241AC 80280B6C 8DEFDB40 */  lw    $t7, %lo(gCamera1)($t7)
...
/* 1241E8 80280BA8 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 1241EC 80280BAC 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 12430C 80280CCC 0C012CD7 */  jal   Toumeimode
/* 124310 80280CD0 00183403 */   sra   $a2, $t8, 0x10
/* 124314 80280CD4 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 124318 80280CD8 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
/* 12431C 80280CDC 8C620000 */  lw    $v0, ($v1)
/* 124320 80280CE0 3C180D01 */  lui   $t8, %hi(D_0D008E48) # $t8, 0xd01
/* 124324 80280CE4 3C058016 */  lui   $a1, %hi(gEffectCount) # $a1, 0x8016
...
/* 124338 80280CF8 24A54AF0 */  addiu $a1, %lo(gEffectCount) # addiu $a1, $a1, 0x4af0
...
/* 124600 80280FC0 0C0A9EDC */  jal   AllocateMemory
...
/* 124B4C 8028150C 3C0E8015 */  lui   $t6, %hi(gGraphPtr) # $t6, 0x8015
/* 124B50 80281510 8DCE0298 */  lw    $t6, %lo(gGraphPtr)($t6)
...
glabel ResultSequence
/* 124B88 80281548 3C018015 */  lui   $at, %hi(gMatrixCount) # $at, 0x8015
/* 124B8C 8028154C 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 124B90 80281550 A4200112 */  sh    $zero, %lo(gMatrixCount)($at)
...
/* 124BA4 80281564 0C00A3DC */  jal   KartPosControlFull
/* 124BA8 80281568 00000000 */   nop   
/* 124BAC 8028156C 0C0089D1 */  jal   KenStartegy
/* 124BB0 80281570 00000000 */   nop   
/* 124BB4 80281574 0C0166B2 */  jal   KWVideoFramesYori
/* 124BB8 80281578 00000000 */   nop   
/* 124BBC 8028157C 0C0166B2 */  jal   KWVideoFramesYori
/* 124BC0 80281580 00000000 */   nop   
/* 124BC4 80281584 0C01681C */  jal   KWGameFramesYori
...
/* 124BE4 802815A4 0C0025F8 */  jal   EtcEnemyDrive
...
/* 124BFC 802815BC 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 124C00 802815C0 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
