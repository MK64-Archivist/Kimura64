...
/* 123648 80280008 0C0A59A8 */  jal   MapStrategy
/* 12364C 8028000C 00000000 */   nop
/* 123650 80280010 0C0166B2 */  jal   KWVideoFramesYori
/* 123654 80280014 00000000 */   nop
/* 123658 80280018 0C0166B2 */  jal   KWVideoFramesYori
/* 12365C 8028001C 00000000 */   nop
/* 123660 80280020 0C01681C */  jal   KWGameFramesYori
...
/* 123678 80280038 3C018015 */  lui   $at, %hi(gMatrixCount) # $at, 0x8015
/* 12367C 8028003C A4200112 */  sh    $zero, %lo(gMatrixCount)($at)
/* 123680 80280040 3C018016 */  lui   $at, %hi(gEffectCount) # $at, 0x8016
/* 123684 80280044 27BDFF70 */  addiu $sp, $sp, -0x90
/* 123688 80280048 A4204AF0 */  sh    $zero, %lo(gEffectCount)($at)
/* 12368C 8028004C AFBF002C */  sw    $ra, 0x2c($sp)
/* 123690 80280050 3C018019 */  lui   $at, %hi(D_8018D120) # $at, 0x8019
/* 123694 80280054 0C0A8F8F */  jal   InitRDP
/* 123698 80280058 AC20D120 */   sw    $zero, %lo(D_8018D120)($at)
/* 12369C 8028005C 0C0A94E9 */  jal   InitialDrawCommon
/* 1236A0 80280060 00000000 */   nop
/* 1236A4 80280064 0C0A8F8F */  jal   InitRDP
/* 1236A8 80280068 00000000 */   nop
/* 1236AC 8028006C 0C015FF1 */  jal   func_80057FC4
/* 1236B0 80280070 00002025 */   move  $a0, $zero
/* 1236B4 80280074 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 1236B8 80280078 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 1236EC 802800AC 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 1236F0 802800B0 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 1236F4 802800B4 44814000 */  mtc1  $at, $f8
/* 1236F8 802800B8 3C068015 */  lui   $a2, %hi(D_80150130) # $a2, 0x8015
/* 1236FC 802800BC 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 123700 802800C0 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 123720 802800E0 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 123724 802800E4 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 123744 80280104 3C0A8015 */  lui   $t2, %hi(gDynamicIcp) # $t2, 0x8015
...
/* 123754 80280114 254AEF40 */  addiu $t2, %lo(gDynamicIcp) # addiu $t2, $t2, -0x10c0
...
/* 1237E8 802801A8 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 1237EC 802801AC 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 123804 802801C4 3C0D8015 */  lui   $t5, %hi(gDynamicIcp) # $t5, 0x8015
/* 123808 802801C8 AC4C0000 */  sw    $t4, ($v0)
/* 12380C 802801CC 8DADEF40 */  lw    $t5, %lo(gDynamicIcp)($t5)
...
/* 12382C 802801EC 3C01800E */  lui   $at, %hi(gMapNumber) # $at, 0x800e
/* 123830 802801F0 27A40044 */  addiu $a0, $sp, 0x44
/* 123834 802801F4 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 123838 802801F8 A438C5A0 */   sh    $t8, %lo(gMapNumber)($at)
/* 12383C 802801FC 27A40044 */  addiu $a0, $sp, 0x44
/* 123840 80280200 0C0AD3FE */  jal   SetMatrix
/* 123844 80280204 00002825 */   move  $a1, $zero
/* 123848 80280208 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 12384C 8028020C 0C0A568E */  jal   DisplayMap
/* 123850 80280210 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 123854 80280214 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 123858 80280218 0C0A8C02 */  jal   DisplayObject
/* 12385C 8028021C 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 123860 80280220 0C016024 */  jal   KWDisplay3D
/* 123864 80280224 00002025 */   move  $a0, $zero
/* 123868 80280228 0C01614E */  jal   KWDisplay3DAfter
...
/* 1238AC 8028026C 3C01800E */  lui   $at, %hi(gFadeoutFlag) # $at, 0x800e
/* 1238B0 80280270 A42EC5C0 */  sh    $t6, %lo(gFadeoutFlag)($at)
/* 1238B4 80280274 3C01800E */  lui   $at, %hi(gFadeoutCount) # $at, 0x800e
/* 1238B8 80280278 240F0005 */  li    $t7, 5
/* 1238BC 8028027C A42FC5C4 */  sh    $t7, %lo(gFadeoutCount)($at)
...
glabel EndingSequence
/* 1238EC 802802AC 3C03800E */  lui   $v1, %hi(gFadeoutFlag) # $v1, 0x800e
/* 1238F0 802802B0 3C018028 */  lui   $at, %hi(D_802874A0) # $at, 0x8028
/* 1238F4 802802B4 2463C5C0 */  addiu $v1, %lo(gFadeoutFlag) # addiu $v1, $v1, -0x3a40
...
/* 123910 802802D0 3C02800E */  lui   $v0, %hi(gFadeoutCount) # $v0, 0x800e
/* 123914 802802D4 2442C5C4 */  addiu $v0, %lo(gFadeoutCount) # addiu $v0, $v0, -0x3a3c
/* 123918 802802D8 944F0000 */  lhu   $t7, ($v0)
/* 12391C 802802DC 24080009 */  li    $t0, 9
/* 123920 802802E0 3C01800E */  lui   $at, %hi(gNewSequenceMode) # $at, 0x800e
...
/* 123938 802802F8 AC28C524 */  sw    $t0, %lo(gNewSequenceMode)($at)
...
/* 123948 80280308 AC29C50C */   sw    $t1, %lo(gSequenceMode)($at)
.L8028030C:
...
/* 1239A0 80280360 0C0ADE0C */  jal   Atan2t
...
/* 1239CC 8028038C 0C0ADE0C */  jal   Atan2t
...
/* 123A18 802803D8 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 123A1C 802803DC 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
...
/* 123A68 80280428 3C01800E */  lui   $at, %hi(gMapNumber) # $at, 0x800e
/* 123A6C 8028042C 24020001 */  li    $v0, 1
/* 123A70 80280430 A42EC5A0 */  sh    $t6, %lo(gMapNumber)($at)
/* 123A74 80280434 3C01800E */  lui   $at, %hi(gBackgroundFlag) # $at, 0x800e
/* 123A78 80280438 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 123A7C 8028043C A422C5B4 */  sh    $v0, %lo(gBackgroundFlag)($at)
/* 123A80 80280440 AFBF0014 */  sw    $ra, 0x14($sp)
/* 123A84 80280444 3C01800E */  lui   $at, %hi(gDisplayFlag) # $at, 0x800e
/* 123A88 80280448 0C0A9346 */  jal   InitialPerspective
/* 123A8C 8028044C A422C518 */   sh    $v0, %lo(gDisplayFlag)($at)
/* 123A90 80280450 0C0A9D2F */  jal   InitialScreenData
...
/* 123AA4 80280464 3C02800E */  lui   $v0, %hi(gScreen1) # $v0, 0x800e
/* 123AA8 80280468 E42047A4 */  swc1  $f0, %lo(D_801647A4)($at)
/* 123AAC 8028046C 3C018015 */  lui   $at, %hi(D_80150130) # $at, 0x8015
/* 123AB0 80280470 2442C5EC */  addiu $v0, %lo(gScreen1) # addiu $v0, $v0, -0x3a14
...
/* 123ADC 8028049C 3C01800E */  lui   $at, %hi(gRaceScreenMode) # $at, 0x800e
/* 123AE0 802804A0 3C0D8016 */  lui   $t5, %hi(gStaticMemoryPointer) # $t5, 0x8016
/* 123AE4 802804A4 A5490030 */  sh    $t1, 0x30($t2)
/* 123AE8 802804A8 8C4C0000 */  lw    $t4, ($v0)
/* 123AEC 802804AC 3C04800E */  lui   $a0, %hi(gMapNumber) # $a0, 0x800e
/* 123AF0 802804B0 A58B0032 */  sh    $t3, 0x32($t4)
/* 123AF4 802804B4 AC20C530 */  sw    $zero, %lo(gRaceScreenMode)($at)
/* 123AF8 802804B8 3C01800E */  lui   $at, %hi(gScreenMode) # $at, 0x800e
/* 123AFC 802804BC 8DADF734 */  lw    $t5, %lo(gStaticMemoryPointer)($t5)
/* 123B00 802804C0 AC20C52C */  sw    $zero, %lo(gScreenMode)($at)
/* 123B04 802804C4 3C018016 */  lui   $at, %hi(gFreeMemoryPointer) # $at, 0x8016
/* 123B08 802804C8 8484C5A0 */  lh    $a0, %lo(gMapNumber)($a0)
/* 123B0C 802804CC 0C0AAA46 */  jal   LoadMapData
/* 123B10 802804D0 AC2DF728 */   sw    $t5, %lo(gFreeMemoryPointer)($at)
/* 123B14 802804D4 3C0E8016 */  lui   $t6, %hi(gFreeMemoryPointer) # $t6, 0x8016
/* 123B18 802804D8 8DCEF728 */  lw    $t6, %lo(gFreeMemoryPointer)($t6)
...
/* 123B30 802804F0 0C0AAA23 */  jal   LoadPressData
/* 123B34 802804F4 AC2EF730 */   sw    $t6, %lo(D_8015F730)($at)
/* 123B38 802804F8 2404000B */  li    $a0, 11
/* 123B3C 802804FC 0C0A9EE5 */  jal   SetSegment
...
/* 123BA4 80280564 3C01800E */  lui   $at, %hi(gFogFlag) # $at, 0x800e
/* 123BA8 80280568 A420C5BC */  sh    $zero, %lo(gFogFlag)($at)
/* 123BAC 8028056C 3C0F8016 */  lui   $t7, %hi(gFreeMemoryPointer) # $t7, 0x8016
/* 123BB0 80280570 8DEFF728 */  lw    $t7, %lo(gFreeMemoryPointer)($t7)
...
/* 123C24 802805E4 0C000C10 */  jal   InitializeEndingMap
/* 123C28 802805E8 00000000 */   nop
/* 123C2C 802805EC 0C01BA70 */  jal   InitializeParams
...
/* 123C44 80280604 3C188016 */  lui   $t8, %hi(gLastMemoryPointer) # $t8, 0x8016
/* 123C48 80280608 3C198016 */  lui   $t9, %hi(gFreeMemoryPointer) # $t9, 0x8016
/* 123C4C 8028060C 8F39F728 */  lw    $t9, %lo(gFreeMemoryPointer)($t9)
/* 123C50 80280610 8F18F72C */  lw    $t8, %lo(gLastMemoryPointer)($t8)
