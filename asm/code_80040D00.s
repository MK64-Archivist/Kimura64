...
/* 041908 80040D08 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 04190C 80040D0C 3C01800E */  lui   $at, %hi(D_800E43A8) # $at, 0x800e
/* 041910 80040D10 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 041998 80040D98 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 04199C 80040D9C 44050000 */  mfc1  $a1, $f0
/* 0419A0 80040DA0 44070000 */  mfc1  $a3, $f0
/* 0419A4 80040DA4 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
...
/* 0419C0 80040DC0 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 0419C4 80040DC4 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 0419F8 80040DF8 3C0E8015 */  lui   $t6, %hi(gDynamicIcp) # $t6, 0x8015
/* 0419FC 80040DFC AC4D0000 */  sw    $t5, ($v0)
/* 041A00 80040E00 8DCEEF40 */  lw    $t6, %lo(gDynamicIcp)($t6)
