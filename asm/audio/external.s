...
/* 0C2ECC 800C22CC 3C02800E */  lui   $v0, %hi(gRaceScreenMode) # $v0, 0x800e
/* 0C2ED0 800C22D0 8C42C530 */  lw    $v0, %lo(gRaceScreenMode)($v0)
...
/* 0C2EF4 800C22F4 3C08800E */   lui   $t0, %hi(gPlayerNumber) # $t0, 0x800e
...
.L800C2308:
/* 0C2F08 800C2308 8D08C538 */  lw    $t0, %lo(gPlayerNumber)($t0)
...
/* 0C3008 800C2408 0C006AAB */  jal   OgawaSoundCameraSet
...
/* 0C3074 800C2474 3C0E800E */  lui   $t6, %hi(gCamera1) # $t6, 0x800e
/* 0C3078 800C2478 8DCEDB40 */  lw    $t6, %lo(gCamera1)($t6)
...
/* 0C308C 800C248C 3C0F800E */  lui   $t7, %hi(gCamera2) # $t7, 0x800e
/* 0C3090 800C2490 AC4E0000 */  sw    $t6, ($v0)
/* 0C3094 800C2494 8DEFDB44 */  lw    $t7, %lo(gCamera2)($t7)
/* 0C3098 800C2498 3C18800E */  lui   $t8, %hi(gCamera3) # $t8, 0x800e
/* 0C309C 800C249C 3C19800E */  lui   $t9, %hi(gCamera4) # $t9, 0x800e
/* 0C30A0 800C24A0 AC4F0004 */  sw    $t7, 4($v0)
/* 0C30A4 800C24A4 8F18DB48 */  lw    $t8, %lo(gCamera3)($t8)
...
/* 0C30B4 800C24B4 8F39DB4C */  lw    $t9, %lo(gCamera4)($t9)
...
/* 0C31AC 800C25AC 3C08800F */  lui   $t0, %hi(gKartData) # $t0, 0x800f
...
/* 0C31BC 800C25BC 25086990 */  addiu $t0, %lo(gKartData) # addiu $t0, $t0, 0x6990
...
/* 0C69D0 800C5DD0 0C032529 */  jal   NaPlayEngStart
...
/* 0C6A74 800C5E74 3C18800F */  lui   $t8, %hi(gKartData) # $t8, 0x800f
/* 0C6A78 800C5E78 27186990 */  addiu $t8, %lo(gKartData) # addiu $t8, $t8, 0x6990
...
/* 0C6BD4 800C5FD4 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C6BF8 800C5FF8 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C6D3C 800C613C 3C18800F */  lui   $t8, %hi(gKartData) # $t8, 0x800f
/* 0C6D40 800C6140 27186990 */  addiu $t8, %lo(gKartData) # addiu $t8, $t8, 0x6990
...
/* 0C70FC 800C64FC 3C09800F */  lui   $t1, %hi(gKartData) # $t1, 0x800f
/* 0C7100 800C6500 25296990 */  addiu $t1, %lo(gKartData) # addiu $t1, $t1, 0x6990
...
/* 0C7194 800C6594 3C0C800F */  lui   $t4, %hi(gKartData) # $t4, 0x800f
/* 0C7198 800C6598 004A1821 */  addu  $v1, $v0, $t2
/* 0C719C 800C659C 258C6990 */  addiu $t4, %lo(gKartData) # addiu $t4, $t4, 0x6990
...
/* 0C71D0 800C65D0 3C18800F */  lui   $t8, %hi(gKartData) # $t8, 0x800f
/* 0C71D4 800C65D4 27186990 */  addiu $t8, %lo(gKartData) # addiu $t8, $t8, 0x6990
...
/* 0C7240 800C6640 3C09800F */  lui   $t1, %hi(gKartData) # $t1, 0x800f
/* 0C7244 800C6644 00591821 */  addu  $v1, $v0, $t9
/* 0C7248 800C6648 25296990 */  addiu $t1, %lo(gKartData) # addiu $t1, $t1, 0x6990
...
/* 0C753C 800C693C 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7574 800C6974 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C75AC 800C69AC 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C75F0 800C69F0 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7634 800C6A34 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C767C 800C6A7C 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C76C0 800C6AC0 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7704 800C6B04 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7748 800C6B48 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C778C 800C6B8C 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C77D0 800C6BD0 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7814 800C6C14 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7858 800C6C58 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C789C 800C6C9C 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C78E0 800C6CE0 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7924 800C6D24 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7968 800C6D68 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C79AC 800C6DAC 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C79F0 800C6DF0 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7A34 800C6E34 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7A78 800C6E78 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7ABC 800C6EBC 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7B00 800C6F00 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7B44 800C6F44 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7B88 800C6F88 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7BCC 800C6FCC 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7C10 800C7010 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7C54 800C7054 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C7D0C 800C710C 3C19800F */  lui   $t9, %hi(gKartData) # $t9, 0x800f
/* 0C7D10 800C7110 27396990 */  addiu $t9, %lo(gKartData) # addiu $t9, $t9, 0x6990
...
/* 0C7D44 800C7144 3C0E800F */  lui   $t6, %hi(gKartData) # $t6, 0x800f
/* 0C7D48 800C7148 25CE6990 */  addiu $t6, %lo(gKartData) # addiu $t6, $t6, 0x6990
...
/* 0C8380 800C7780 3C02800E */  lui   $v0, %hi(gGameMode) # $v0, 0x800e
/* 0C8384 800C7784 8C42C53C */  lw    $v0, %lo(gGameMode)($v0)
...
/* 0C83EC 800C77EC 0C032418 */  jal   NaPlyTrgStart
...
/* 0C8470 800C7870 0C0326A2 */  jal   NaEnmLevelStart
...
/* 0C84A8 800C78A8 0C0326A2 */  jal   NaEnmLevelStart
...
/* 0C84F0 800C78F0 0C032418 */  jal   NaPlyTrgStart
...
/* 0C8558 800C7958 0C0326A2 */  jal   NaEnmLevelStart
...
/* 0C85BC 800C79BC 0C0326A2 */  jal   NaEnmLevelStart
...
/* 0C8678 800C7A78 0C0326A2 */  jal   NaEnmLevelStart
...
/* 0C8698 800C7A98 0C032418 */  jal   NaPlyTrgStart
...
/* 0C871C 800C7B1C 0C032418 */  jal   NaPlyTrgStart
...
/* 0C877C 800C7B7C 0C0326A2 */  jal   NaEnmLevelStart
...
/* 0C8888 800C7C88 0C0323BE */  jal   NaFanStart
...
/* 0C88D4 800C7CD4 0C0323BE */  jal   NaFanStart
...
/* 0C89A8 800C7DA8 0C0323BE */  jal   NaFanStart
/* 0C89AC 800C7DAC 24040017 */   li    $a0, 23
/* 0C89B0 800C7DB0 3C19800E */  lui   $t9, %hi(gWinKart) # $t9, 0x800e
/* 0C89B4 800C7DB4 8F39C5E8 */  lw    $t9, %lo(gWinKart)($t9)
...
/* 0C8A00 800C7E00 0C03243D */  jal   NaPlyVoiceStart
...
/* 0C8A54 800C7E54 0C0323BE */  jal   NaFanStart
/* 0C8A58 800C7E58 24040017 */   li    $a0, 23
/* 0C8A5C 800C7E5C 3C0E800E */  lui   $t6, %hi(gWinKart) # $t6, 0x800e
/* 0C8A60 800C7E60 8DCEC5E8 */  lw    $t6, %lo(gWinKart)($t6)
...
/* 0C8AAC 800C7EAC 0C03243D */  jal   NaPlyVoiceStart
...
/* 0C8B10 800C7F10 0C0323BE */  jal   NaFanStart
/* 0C8B14 800C7F14 24040017 */   li    $a0, 23
/* 0C8B18 800C7F18 3C0C800E */  lui   $t4, %hi(gWinKart) # $t4, 0x800e
/* 0C8B1C 800C7F1C 8D8CC5E8 */  lw    $t4, %lo(gWinKart)($t4)
...
/* 0C8B8C 800C7F8C 8C42C53C */   lw    $v0, %lo(gGameMode)($v0)
...
/* 0C8BD4 800C7FD4 3C19800F */  lui   $t9, %hi(gKartData) # $t9, 0x800f
/* 0C8BD8 800C7FD8 27396990 */  addiu $t9, %lo(gKartData) # addiu $t9, $t9, 0x6990
...
/* 0C8C14 800C8014 0C03243D */  jal   NaPlyVoiceStart
...
/* 0C8C4C 800C804C 0C03243D */  jal   NaPlyVoiceStart
...
/* 0C8C74 800C8074 0C03243D */  jal   NaPlyVoiceStart
/* 0C8C78 800C8078 A3C40043 */   sb    $a0, 0x43($fp)
.L800C807C:
/* 0C8C7C 800C807C 3C02800E */  lui   $v0, %hi(gGameMode) # $v0, 0x800e
/* 0C8C80 800C8080 8C42C53C */  lw    $v0, %lo(gGameMode)($v0)
...
/* 0C8CA4 800C80A4 3C18800F */  lui   $t8, %hi(gKartData) # $t8, 0x800f
/* 0C8CA8 800C80A8 27186990 */  addiu $t8, %lo(gKartData) # addiu $t8, $t8, 0x6990
...
/* 0C8CE4 800C80E4 0C03243D */  jal   NaPlyVoiceStart
/* 0C8CE8 800C80E8 A3C40043 */   sb    $a0, 0x43($fp)
/* 0C8CEC 800C80EC 3C02800E */  lui   $v0, %hi(gGameMode) # $v0, 0x800e
/* 0C8CF0 800C80F0 8C42C53C */  lw    $v0, %lo(gGameMode)($v0)
...
/* 0C8D54 800C8154 0C03243D */  jal   NaPlyVoiceStart
/* 0C8D58 800C8158 A3C40043 */   sb    $a0, 0x43($fp)
/* 0C8D5C 800C815C 3C02800E */  lui   $v0, %hi(gGameMode) # $v0, 0x800e
/* 0C8D60 800C8160 8C42C53C */  lw    $v0, %lo(gGameMode)($v0)
...
/* 0C8DC0 800C81C0 0C03243D */  jal   NaPlyVoiceStart
/* 0C8DC4 800C81C4 A3C40043 */   sb    $a0, 0x43($fp)
/* 0C8DC8 800C81C8 3C02800E */  lui   $v0, %hi(gGameMode) # $v0, 0x800e
/* 0C8DCC 800C81CC 8C42C53C */  lw    $v0, %lo(gGameMode)($v0)
...
/* 0C90A0 800C84A0 3C0F800F */  lui   $t7, %hi(gKartData) # $t7, 0x800f
/* 0C90A4 800C84A4 25EF6990 */  addiu $t7, %lo(gKartData) # addiu $t7, $t7, 0x6990
...
/* 0C914C 800C854C 0C032529 */  jal   NaPlayEngStart
/* 0C9150 800C8550 A04C0000 */   sb    $t4, ($v0)
/* 0C9154 800C8554 3C02800E */  lui   $v0, %hi(gMapNumber) # $v0, 0x800e
/* 0C9158 800C8558 8442C5A0 */  lh    $v0, %lo(gMapNumber)($v0)
...
/* 0C9204 800C8604 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C9240 800C8640 0C032529 */  jal   NaPlayEngStart
/* 0C9244 800C8644 A04B0000 */   sb    $t3, ($v0)
/* 0C9248 800C8648 8FC20038 */  lw    $v0, 0x38($fp)
/* 0C924C 800C864C 3C0C800E */  lui   $t4, %hi(gMapNumber) # $t4, 0x800e
/* 0C9250 800C8650 24010006 */  li    $at, 6
/* 0C9254 800C8654 A0400000 */  sb    $zero, ($v0)
/* 0C9258 800C8658 858CC5A0 */  lh    $t4, %lo(gMapNumber)($t4)
...
/* 0C92B8 800C86B8 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C92F4 800C86F4 3C18800F */  lui   $t8, %hi(gKartData) # $t8, 0x800f
/* 0C92F8 800C86F8 27186990 */  addiu $t8, %lo(gKartData) # addiu $t8, $t8, 0x6990
...
/* 0C9354 800C8754 0C03243D */  jal   NaPlyVoiceStart
...
/* 0C953C 800C893C 3C03800F */  lui   $v1, %hi(gKartData) # $v1, 0x800f
/* 0C9540 800C8940 24636990 */  addiu $v1, %lo(gKartData) # addiu $v1, $v1, 0x6990
...
/* 0C96E4 800C8AE4 3C0E800E */  lui   $t6, %hi(gMapNumber) # $t6, 0x800e
/* 0C96E8 800C8AE8 85CEC5A0 */  lh    $t6, %lo(gMapNumber)($t6)
...
.L800C8D6C:
/* 0C996C 800C8D6C 3C0F800E */  lui   $t7, %hi(gGameMode) # $t7, 0x800e
/* 0C9970 800C8D70 8DEFC53C */  lw    $t7, %lo(gGameMode)($t7)
...
/* 0C9A2C 800C8E2C 3C0E800E */  lui   $t6, %hi(gMapNumber) # $t6, 0x800e
/* 0C9A30 800C8E30 85CEC5A0 */  lh    $t6, %lo(gMapNumber)($t6)
...
/* 0C9A58 800C8E58 3C0F800E */  lui   $t7, %hi(gMapNumber) # $t7, 0x800e
/* 0C9A5C 800C8E5C 85EFC5A0 */  lh    $t7, %lo(gMapNumber)($t7)
...
/* 0C9A90 800C8E90 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C9BFC 800C8FFC 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C9CD8 800C90D8 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C9DF8 800C91F8 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C9E34 800C9234 0C031052 */  jal   NaiFxFlagEntry
...
/* 0C9EB0 800C92B0 0C03243D */  jal   NaPlyVoiceStart
...
/* 0C9F5C 800C935C 3C19800F */  lui   $t9, %hi(gKartData) # $t9, 0x800f
/* 0C9F60 800C9360 27396990 */  addiu $t9, %lo(gKartData) # addiu $t9, $t9, 0x6990
...
/* 0CA018 800C9418 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CA044 800C9444 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CA3A8 800C97A8 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CA3E4 800C97E4 3C19800F */  lui   $t9, %hi(gKartData) # $t9, 0x800f
/* 0CA3E8 800C97E8 AFB1002C */  sw    $s1, 0x2c($sp)
/* 0CA3EC 800C97EC 27396990 */  addiu $t9, %lo(gKartData) # addiu $t9, $t9, 0x6990
...
/* 0CA584 800C9984 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CA708 800C9B08 3C19800F */  lui   $t9, %hi(gKartData) # $t9, 0x800f
/* 0CA70C 800C9B0C 27396990 */  addiu $t9, %lo(gKartData) # addiu $t9, $t9, 0x6990
...
/* 0CA8B0 800C9CB0 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CA928 800C9D28 3C0F800F */  lui   $t7, %hi(gKartData) # $t7, 0x800f
/* 0CA92C 800C9D2C 27BDFFD0 */  addiu $sp, $sp, -0x30
/* 0CA930 800C9D30 25EF6990 */  addiu $t7, %lo(gKartData) # addiu $t7, $t7, 0x6990
...
/* 0CAA70 800C9E70 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CAA94 800C9E94 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CABB0 800C9FB0 0C032384 */  jal   NaSystemStart
...
/* 0CABD8 800C9FD8 0C032384 */  jal   NaSystemStart
...
/* 0CB0E0 800CA4E0 0C032418 */  jal   NaPlyTrgStart
...
/* 0CB118 800CA518 0C0323BE */  jal   NaFanStart
...
/* 0CB148 800CA548 0C0323BE */  jal   NaFanStart
...
/* 0CB234 800CA634 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CB3E0 800CA7E0 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CB4B0 800CA8B0 0C0323AB */  jal   NaSeqStart
...
/* 0CB530 800CA930 0C0323AB */  jal   NaSeqStart
...
/* 0CB558 800CA958 0C0323AB */  jal   NaSeqStart
...
/* 0CB604 800CAA04 3C09800F */  lui   $t1, %hi(gKartData) # $t1, 0x800f
/* 0CB608 800CAA08 25296990 */  addiu $t1, %lo(gKartData) # addiu $t1, $t1, 0x6990
...
/* 0CB670 800CAA70 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CB70C 800CAB0C 3C19800F */  lui   $t9, %hi(gKartData) # $t9, 0x800f
/* 0CB710 800CAB10 27396990 */  addiu $t9, %lo(gKartData) # addiu $t9, $t9, 0x6990
...
/* 0CB7B0 800CABB0 0C032418 */  jal   NaPlyTrgStart
...
/* 0CB7E0 800CABE0 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CB8B4 800CACB4 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CB918 800CAD18 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CBAA8 800CAEA8 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CBB70 800CAF70 3C04800E */   lui   $a0, %hi(gMapNumber) # $a0, 0x800e
...
.L800CAF98:
/* 0CBB98 800CAF98 8484C5A0 */  lh    $a0, %lo(gMapNumber)($a0)
/* 0CBB9C 800CAF9C AFA20010 */  sw    $v0, 0x10($sp)
/* 0CBBA0 800CAFA0 AFAB0014 */  sw    $t3, 0x14($sp)
/* 0CBBA4 800CAFA4 0C031052 */  jal   NaiFxFlagEntry
...
/* 0CBC24 800CB024 0C032418 */  jal   NaPlyTrgStart
...
/* 0CBD00 800CB100 0C03243D */  jal   NaPlyVoiceStart
...
/* 0CBD80 800CB180 0C0323AB */  jal   NaSeqStart
...
/* 0CBDA8 800CB1A8 0C0323AB */  jal   NaSeqStart
...
/* 0CBDBC 800CB1BC 0C0323BE */  jal   NaFanStart
...
/* 0CBE9C 800CB29C 0C0323AB */  jal   NaSeqStart
