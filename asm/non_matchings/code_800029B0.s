...
glabel InitialRaceSequence
/* 003618 80002A18 3C0E8019 */  lui   $t6, %hi(D_8018EDF3) # $t6, 0x8019
/* 00361C 80002A1C 81CEEDF3 */  lb    $t6, %lo(D_8018EDF3)($t6)
/* 003620 80002A20 3C0F800E */  lui   $t7, %hi(gSequenceMode) # $t7, 0x800e
/* 003624 80002A24 8DEFC50C */  lw    $t7, %lo(gSequenceMode)($t7)
/* 003628 80002A28 3C01800E */  lui   $at, %hi(gPlayerNumber) # $at, 0x800e
/* 00362C 80002A2C AC2EC538 */  sw    $t6, %lo(gPlayerNumber)($at)
...
/* 003640 80002A40 3C01800E */  lui   $at, %hi(gScreenFlip) # $at, 0x800e
/* 003644 80002A44 AC20C604 */  sw    $zero, %lo(gScreenFlip)($at)
.L80002A48:
/* 003648 80002A48 3C18800E */  lui   $t8, %hi(gScreenFlip) # $t8, 0x800e
/* 00364C 80002A4C 8F18C604 */  lw    $t8, %lo(gScreenFlip)($t8)
/* 003650 80002A50 3C02800E */  lui   $v0, %hi(D_800DC5A4) # $v0, 0x800e
/* 003654 80002A54 3C19800E */  lui   $t9, %hi(gGameMode) # $t9, 0x800e
...
.L80002A84:
/* 003684 80002A84 8F39C53C */  lw    $t9, %lo(gGameMode)($t9)
/* 003688 80002A88 3C0E800E */  lui   $t6, %hi(gRaceScreenMode) # $t6, 0x800e
/* 00368C 80002A8C 3C04800E */  lui   $a0, %hi(gMapNumber) # $a0, 0x800e
/* 003690 80002A90 1720000C */  bnez  $t9, .L80002AC4
/* 003694 80002A94 3C088019 */   lui   $t0, %hi(gCupSelection) # $t0, 0x8019
/* 003698 80002A98 3C0A8019 */  lui   $t2, %hi(gCircuitSelect) # $t2, 0x8019
/* 00369C 80002A9C 814AEE0B */  lb    $t2, %lo(gCircuitSelect)($t2)
...
/* 0036BC 80002ABC 3C01800E */  lui   $at, %hi(gMapNumber) # $at, 0x800e
/* 0036C0 80002AC0 A42DC5A0 */  sh    $t5, %lo(gMapNumber)($at)
.L80002AC4:
/* 0036C4 80002AC4 8DCEC530 */  lw    $t6, %lo(gRaceScreenMode)($t6)
/* 0036C8 80002AC8 3C01800E */  lui   $at, %hi(gScreenMode) # $at, 0x800e
/* 0036CC 80002ACC 8484C5A0 */  lh    $a0, %lo(gMapNumber)($a0)
/* 0036D0 80002AD0 AC2EC52C */  sw    $t6, %lo(gScreenMode)($at)
/* 0036D4 80002AD4 844F0000 */  lh    $t7, ($v0)
/* 0036D8 80002AD8 11E4000F */  beq   $t7, $a0, .L80002B18
/* 0036DC 80002ADC 3C018015 */   lui   $at, %hi(gRaceClearFlag) # $at, 0x8015
/* 0036E0 80002AE0 AC200120 */  sw    $zero, %lo(gRaceClearFlag)($at)
/* 0036E4 80002AE4 A4440000 */  sh    $a0, ($v0)
/* 0036E8 80002AE8 3C188016 */  lui   $t8, %hi(gStaticMemoryPointer) # $t8, 0x8016
/* 0036EC 80002AEC 8F18F734 */  lw    $t8, %lo(gStaticMemoryPointer)($t8)
/* 0036F0 80002AF0 3C018016 */  lui   $at, %hi(gFreeMemoryPointer) # $at, 0x8016
/* 0036F4 80002AF4 0C0AAA46 */  jal   LoadMapData
/* 0036F8 80002AF8 AC38F728 */   sw    $t8, %lo(gFreeMemoryPointer)($at)
/* 0036FC 80002AFC 0C0A5762 */  jal   InitialMap
/* 003700 80002B00 00000000 */   nop   
/* 003704 80002B04 3C198016 */  lui   $t9, %hi(gFreeMemoryPointer) # $t9, 0x8016
/* 003708 80002B08 8F39F728 */  lw    $t9, %lo(gFreeMemoryPointer)($t9)
...
/* 003720 80002B20 3C018016 */  lui   $at, %hi(gFreeMemoryPointer) # $at, 0x8016
/* 003724 80002B24 AC28F728 */  sw    $t0, %lo(gFreeMemoryPointer)($at)
.L80002B28:
/* 003728 80002B28 0C0A5A7E */  jal   InitialMap2
/* 00372C 80002B2C 00000000 */   nop   
/* 003730 80002B30 0C0014C4 */  jal   InitialGhost
/* 003734 80002B34 00000000 */   nop   
/* 003738 80002B38 0C00F420 */  jal   InitialGame
/* 00373C 80002B3C 00000000 */   nop   
/* 003740 80002B40 0C01BA70 */  jal   InitializeParams
/* 003744 80002B44 00000000 */   nop   
/* 003748 80002B48 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 00374C 80002B4C AC20C510 */  sw    $zero, %lo(gRaceControlMode)($at)
/* 003750 80002B50 3C018016 */  lui   $at, %hi(D_8015F6FE) # $at, 0x8016
/* 003754 80002B54 A420F6FE */  sh    $zero, %lo(D_8015F6FE)($at)
/* 003758 80002B58 3C01800E */  lui   $at, %hi(gTwoDFlag) # $at, 0x800e
/* 00375C 80002B5C A420C5B8 */  sh    $zero, %lo(gTwoDFlag)($at)
/* 003760 80002B60 3C018015 */  lui   $at, %hi(D_80152308) # $at, 0x8015
/* 003764 80002B64 A4202308 */  sh    $zero, %lo(D_80152308)($at)
/* 003768 80002B68 3C01802C */  lui   $at, %hi(gFinishCount) # $at, 0x802c
/* 00376C 80002B6C 240AFFFF */  li    $t2, -1
/* 003770 80002B70 AC2AA038 */  sw    $t2, %lo(gFinishCount)($at)
/* 003774 80002B74 3C01802C */  lui   $at, %hi(D_802BA048) # $at, 0x802c
/* 003778 80002B78 0C0A9D2F */  jal   InitialScreenData
/* 00377C 80002B7C A420A048 */   sh    $zero, %lo(D_802BA048)($at)
/* 003780 80002B80 0C0A9346 */  jal   InitialPerspective
/* 003784 80002B84 00000000 */   nop   
/* 003788 80002B88 0C0247E9 */  jal   InitKawanoGame
/* 00378C 80002B8C 00000000 */   nop   
/* 003790 80002B90 0C0A7856 */  jal   InitialObject
/* 003794 80002B94 00000000 */   nop   
/* 003798 80002B98 3C09800E */  lui   $t1, %hi(gGameMode) # $t1, 0x800e
/* 00379C 80002B9C 8D29C53C */  lw    $t1, %lo(gGameMode)($t1)
/* 0037A0 80002BA0 24010003 */  li    $at, 3
/* 0037A4 80002BA4 3C028016 */  lui   $v0, %hi(gCenterLine) # $v0, 0x8016
/* 0037A8 80002BA8 11210046 */  beq   $t1, $at, .L80002CC4
/* 0037AC 80002BAC 3C05800E */   lui   $a1, %hi(gMapNumber) # $a1, 0x800e
/* 0037B0 80002BB0 8C424490 */  lw    $v0, %lo(gCenterLine)($v0)
...
/* 0037C0 80002BC0 3C04800E */  lui   $a0, %hi(gMapNumber) # $a0, 0x800e
/* 0037C4 80002BC4 2401000A */  li    $at, 10
/* 0037C8 80002BC8 256CFFF1 */  addiu $t4, $t3, -0xf
/* 0037CC 80002BCC 448C4000 */  mtc1  $t4, $f8
/* 0037D0 80002BD0 3C0E800E */  lui   $t6, %hi(gScreenFlip) # $t6, 0x800e
...
/* 0037F0 80002BF0 8484C5A0 */  lh    $a0, %lo(gMapNumber)($a0)
/* 0037F4 80002BF4 54810017 */  bnel  $a0, $at, .L80002C54
/* 0037F8 80002BF8 2401000E */   li    $at, 14
/* 0037FC 80002BFC 8DCEC604 */  lw    $t6, %lo(gScreenFlip)($t6)
...
/* 003858 80002C58 3C19800E */   lui   $t9, %hi(gScreenFlip) # $t9, 0x800e
/* 00385C 80002C5C 8F39C604 */  lw    $t9, %lo(gScreenFlip)($t9)
...
.L80002CC4:
/* 0038C4 80002CC4 3C0B800E */  lui   $t3, %hi(gDemoFlag) # $t3, 0x800e
/* 0038C8 80002CC8 956BC51C */  lhu   $t3, %lo(gDemoFlag)($t3)
/* 0038CC 80002CCC 3C04800E */  lui   $a0, %hi(gPlayerNumber) # $a0, 0x800e
/* 0038D0 80002CD0 1560000C */  bnez  $t3, .L80002D04
/* 0038D4 80002CD4 00000000 */   nop   
/* 0038D8 80002CD8 8C84C538 */  lw    $a0, %lo(gPlayerNumber)($a0)
/* 0038DC 80002CDC 84A5C5A0 */  lh    $a1, %lo(gMapNumber)($a1)
...
/* 0038F4 80002CF4 0C032802 */  jal   NaChangeSoundMode
/* 0038F8 80002CF8 01A02825 */   move  $a1, $t5
/* 0038FC 80002CFC 0C032CB1 */  jal   NasAudioInput
/* 003900 80002D00 00000000 */   nop   
.L80002D04:
/* 003904 80002D04 3C02800E */  lui   $v0, %hi(gCont1P) # $v0, 0x800e
/* 003908 80002D08 8C42C4BC */  lw    $v0, %lo(gCont1P)($v0)
...
glabel DelayInitialMap
/* 0039AC 80002DAC 3C0E800E */  lui   $t6, %hi(gMapNumber) # $t6, 0x800e
/* 0039B0 80002DB0 95CEC5A0 */  lhu   $t6, %lo(gMapNumber)($t6)
...
/* 0039EC 80002DEC 0C0AD4A7 */  jal   SetFVector
...
/* 003A08 80002E08 0C032760 */  jal   NaSceneLevelStart
...
/* 003A2C 80002E2C 0C0AD4A7 */  jal   SetFVector
...
/* 003A48 80002E48 0C032760 */  jal   NaSceneLevelStart
...
/* 003A68 80002E68 0C0AD4A7 */  jal   SetFVector
...
/* 003A84 80002E84 0C032760 */  jal   NaSceneLevelStart
...
/* 003AA8 80002EA8 0C0AD4A7 */  jal   SetFVector
...
/* 003AC4 80002EC4 0C032760 */  jal   NaSceneLevelStart
...
/* 003AE0 80002EE0 0C0AD4A7 */  jal   SetFVector
...
/* 003AFC 80002EFC 0C032760 */  jal   NaSceneLevelStart
...
/* 003B1C 80002F1C 0C0AD4A7 */  jal   SetFVector
...
/* 003B38 80002F38 0C032760 */  jal   NaSceneLevelStart
...
/* 003B58 80002F58 0C0AD4A7 */  jal   SetFVector
...
/* 003B74 80002F74 0C032760 */  jal   NaSceneLevelStart
...
/* 003B98 80002F98 0C0AD4A7 */  jal   SetFVector
...
/* 003BB4 80002FB4 0C032760 */  jal   NaSceneLevelStart
...
/* 003BDC 80002FDC 0C0AD4A7 */  jal   SetFVector
...
/* 003BF8 80002FF8 0C032760 */  jal   NaSceneLevelStart
...
/* 003C88 80003088 3C058016 */  lui   $a1, %hi(gFreeMemoryPointer) # $a1, 0x8016
/* 003C8C 8000308C 24040003 */  li    $a0, 3
/* 003C90 80003090 A5210004 */  sh    $at, 4($t1)
/* 003C94 80003094 3C01800E */  lui   $at, %hi(gFogFlag) # $at, 0x800e
/* 003C98 80003098 A420C5BC */  sh    $zero, %lo(gFogFlag)($at)
...
/* 003CAC 800030AC 3C01800E */  lui   $at, %hi(gScreenFlip) # $at, 0x800e
/* 003CB0 800030B0 AC20C604 */  sw    $zero, %lo(gScreenFlip)($at)
...
/* 003CC0 800030C0 8CA5F728 */  lw    $a1, %lo(gFreeMemoryPointer)($a1)
/* 003CC4 800030C4 E424F784 */  swc1  $f4, %lo(D_8015F784)($at)
/* 003CC8 800030C8 3C01800E */  lui   $at, %hi(gPlayerNumber) # $at, 0x800e
/* 003CCC 800030CC AC39C538 */  sw    $t9, %lo(gPlayerNumber)($at)
...
/* 003CD8 800030D8 0C0A9EE5 */  jal   SetSegment
/* 003CDC 800030DC 00A12821 */   addu  $a1, $a1, $at
/* 003CE0 800030E0 0C0A76AE */  jal   InitialObjectBuffer
/* 003CE4 800030E4 00000000 */   nop   
/* 003CE8 800030E8 3C18800E */  lui   $t8, %hi(gMapNumber) # $t8, 0x800e
/* 003CEC 800030EC 9718C5A0 */  lhu   $t8, %lo(gMapNumber)($t8)
...
/* 003D4C 8000314C 0C0ABE2F */  jal   MakeWaterVertex
...
/* 003D70 80003170 0C0ABE2F */  jal   MakeWaterVertex
...
/* 003D94 80003194 0C0AD4A7 */  jal   SetFVector
...
/* 003DBC 800031BC 0C0A7B22 */  jal   AddObjectBuffer
...
/* 003DD8 800031D8 0C0AA13D */  jal   DecodeMapImage1
...
/* 003DEC 800031EC 0C0AA13D */  jal   DecodeMapImage1
...
/* 003E00 80003200 0C0AA13D */  jal   DecodeMapImage1
...
/* 003E14 80003214 0C0AA13D */  jal   DecodeMapImage1
...
/* 003E28 80003228 0C0AA13D */  jal   DecodeMapImage1
...
/* 003E3C 8000323C 0C0AA13D */  jal   DecodeMapImage1
...
/* 003E50 80003250 0C0AA13D */  jal   DecodeMapImage1
...
/* 003E64 80003264 0C0AA13D */  jal   DecodeMapImage1
...
/* 003E78 80003278 0C0AA13D */  jal   DecodeMapImage1
...
/* 003E8C 8000328C 0C0AA13D */  jal   DecodeMapImage1
...
/* 003EA0 800032A0 0C0AA13D */  jal   DecodeMapImage1
...
/* 003EE8 800032E8 0C0ABE2F */  jal   MakeWaterVertex
...
/* 003F08 80003308 0C0ABE2F */  jal   MakeWaterVertex
...
/* 003F30 80003330 0C0ABE2F */  jal   MakeWaterVertex
...
/* 003F50 80003350 0C0ABE2F */  jal   MakeWaterVertex
...
/* 003F6C 8000336C 0C0ABE2F */  jal   MakeWaterVertex
...
/* 003F88 80003388 0C0AD4A7 */  jal   SetFVector
...
/* 003F9C 8000339C 0C0A7B22 */  jal   AddObjectBuffer
...
/* 003FB4 800033B4 0C0AD4A7 */  jal   SetFVector
...
/* 003FC8 800033C8 0C0A7B22 */  jal   AddObjectBuffer
...
/* 003FE4 800033E4 0C0AD4A7 */  jal   SetFVector
...
/* 003FF8 800033F8 0C0A7B22 */  jal   AddObjectBuffer
...
/* 004018 80003418 0C0ABE2F */  jal   MakeWaterVertex
...
/* 004038 80003438 0C0ABE2F */  jal   MakeWaterVertex
...
/* 004058 80003458 0C0ABE2F */  jal   MakeWaterVertex
...
/* 004078 80003478 0C0ABE2F */  jal   MakeWaterVertex
...
/* 004098 80003498 0C0ABE2F */  jal   MakeWaterVertex
...
/* 0040B8 800034B8 0C0ABE2F */  jal   MakeWaterVertex
...
/* 0040D8 800034D8 0C0ABE2F */  jal   MakeWaterVertex
...
/* 0040F8 800034F8 0C0ABE2F */  jal   MakeWaterVertex
...
/* 004120 80003520 0C0ABE2F */  jal   MakeWaterVertex
