glabel FlushDisplayList
/* 001B34 80000F34 27BDFFE0 */  addiu $sp, $sp, -0x20
/* 001B38 80000F38 AFBF001C */  sw    $ra, 0x1c($sp)
/* 001B3C 80000F3C AFB00018 */  sw    $s0, 0x18($sp)
/* 001B40 80000F40 0C000D54 */  jal   SetGraphCPUTime
/* 001B44 80000F44 24040002 */   li    $a0, 2
/* 001B48 80000F48 3C048015 */  lui   $a0, %hi(gRdpMessageQ) # $a0, 0x8015
/* 001B4C 80000F4C 3C058015 */  lui   $a1, %hi(gDummyMessage) # $a1, 0x8015
/* 001B50 80000F50 24A5F098 */  addiu $a1, %lo(gDummyMessage) # addiu $a1, $a1, -0xf68
/* 001B54 80000F54 2484EF88 */  addiu $a0, %lo(gRdpMessageQ) # addiu $a0, $a0, -0x1078
/* 001B58 80000F58 0C0335D4 */  jal   osRecvMesg
/* 001B5C 80000F5C 24060001 */   li    $a2, 1
/* 001B60 80000F60 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 001B64 80000F64 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 001B68 80000F68 3C010002 */  lui   $at, (0x00028B20 >> 16) # lui $at, 2
/* 001B6C 80000F6C 34218B20 */  ori   $at, (0x00028B20 & 0xFFFF) # ori $at, $at, 0x8b20
/* 001B70 80000F70 0C000310 */  jal   StartGraphicTask
/* 001B74 80000F74 00812021 */   addu  $a0, $a0, $at
/* 001B78 80000F78 0C000D54 */  jal   SetGraphCPUTime
/* 001B7C 80000F7C 24040003 */   li    $a0, 3
/* 001B80 80000F80 3C048015 */  lui   $a0, %hi(gRtcMessageQ) # $a0, 0x8015
/* 001B84 80000F84 3C058015 */  lui   $a1, %hi(gDummyMessage) # $a1, 0x8015
/* 001B88 80000F88 24A5F098 */  addiu $a1, %lo(gDummyMessage) # addiu $a1, $a1, -0xf68
/* 001B8C 80000F8C 2484EF70 */  addiu $a0, %lo(gRtcMessageQ) # addiu $a0, $a0, -0x1090
/* 001B90 80000F90 0C0335D4 */  jal   osRecvMesg
/* 001B94 80000F94 24060001 */   li    $a2, 1
/* 001B98 80000F98 3C10800E */  lui   $s0, %hi(gDispFrame) # $s0, 0x800e
/* 001B9C 80000F9C 2610C55C */  addiu $s0, %lo(gDispFrame) # addiu $s0, $s0, -0x3aa4
...
/* 001BC4 80000FC4 0C000D54 */  jal   SetGraphCPUTime
/* 001BC8 80000FC8 24040004 */   li    $a0, 4
/* 001BCC 80000FCC 3C048015 */  lui   $a0, %hi(gRtcMessageQ) # $a0, 0x8015
/* 001BD0 80000FD0 3C058015 */  lui   $a1, %hi(gDummyMessage) # $a1, 0x8015
/* 001BD4 80000FD4 24A5F098 */  addiu $a1, %lo(gDummyMessage) # addiu $a1, $a1, -0xf68
/* 001BD8 80000FD8 2484EF70 */  addiu $a0, %lo(gRtcMessageQ) # addiu $a0, $a0, -0x1090
...
.L8000101C:
/* 001C1C 8000101C 2442C560 */  addiu $v0, %lo(gDrawFrame) # addiu $v0, $v0, -0x3aa0
...
.L80001038:
/* 001C38 80001038 3C02800E */  lui   $v0, %hi(gFrameCounter) # $v0, 0x800e
/* 001C3C 8000103C 2442C54C */  addiu $v0, %lo(gFrameCounter) # addiu $v0, $v0, -0x3ab4
