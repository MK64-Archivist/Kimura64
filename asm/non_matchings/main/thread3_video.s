...
/* 002FE8 800023E8 3C038015 */  lui   $v1, %hi(gCfbPtrs) # $v1, 0x8015
/* 002FEC 800023EC 246302A8 */  addiu $v1, %lo(gCfbPtrs) # addiu $v1, $v1, 0x2a8
/* 002FF0 800023F0 3C0E8032 */  lui   $t6, %hi(gCfb16a) # $t6, 0x8032
/* 002FF4 800023F4 3C0F8034 */  lui   $t7, %hi(gCfb16b) # $t7, 0x8034
/* 002FF8 800023F8 3C188037 */  lui   $t8, %hi(gCfb16c) # $t8, 0x8037
/* 002FFC 800023FC 25CEF780 */  addiu $t6, %lo(gCfb16a) # addiu $t6, $t6, -0x880
/* 003000 80002400 25EF4F80 */  addiu $t7, %lo(gCfb16b) # addiu $t7, $t7, 0x4f80
/* 003004 80002404 2718A780 */  addiu $t8, %lo(gCfb16c) # addiu $t8, $t8, -0x5880
/* 003008 80002408 AC6E0000 */  sw    $t6, ($v1)
/* 00300C 8000240C AC6F0004 */  sw    $t7, 4($v1)
/* 003010 80002410 AC780008 */  sw    $t8, 8($v1)
/* 003014 80002414 3C038037 */  lui   $v1, %hi(gCfb16c) # $v1, 0x8037
/* 003018 80002418 3C028034 */  lui   $v0, %hi(gCfb16b) # $v0, 0x8034
...
/* 00303C 8000243C 24424F80 */  addiu $v0, %lo(gCfb16b) # addiu $v0, $v0, 0x4f80
/* 003040 80002440 2463A780 */  addiu $v1, %lo(gCfb16c) # addiu $v1, $v1, -0x5880
.L80002444:
...
/* 00308C 8000248C 0C000178 */  jal   SetupMessageQueue
/* 003090 80002490 00000000 */   nop   
/* 003094 80002494 0C000499 */  jal   InitializeSystemWorks
/* 003098 80002498 00000000 */   nop   
/* 00309C 8000249C 3C108016 */  lui   $s0, %hi(gAudioThread) # $s0, 0x8016
/* 0030A0 800024A0 3C198016 */  lui   $t9, %hi(gAudioThreadStack) # $t9, 0x8016
/* 0030A4 800024A4 2610AB80 */  addiu $s0, %lo(gAudioThread) # addiu $s0, $s0, -0x5480
/* 0030A8 800024A8 2739CD30 */  addiu $t9, %lo(gAudioThreadStack) # addiu $t9, $t9, -0x32d0
/* 0030AC 800024AC 3C068000 */  lui   $a2, %hi(AudioProc) # $a2, 0x8000
/* 0030B0 800024B0 24180014 */  li    $t8, 20
/* 0030B4 800024B4 AFB80014 */  sw    $t8, 0x14($sp)
/* 0030B8 800024B8 24C628E4 */  addiu $a2, %lo(AudioProc) # addiu $a2, $a2, 0x28e4
/* 0030BC 800024BC AFB90010 */  sw    $t9, 0x10($sp)
/* 0030C0 800024C0 02002025 */  move  $a0, $s0
/* 0030C4 800024C4 24050004 */  li    $a1, 4
/* 0030C8 800024C8 0C000114 */  jal   SysCreateThread
/* 0030CC 800024CC 00003825 */   move  $a3, $zero
/* 0030D0 800024D0 0C0330D8 */  jal   osStartThread
/* 0030D4 800024D4 02002025 */   move  $a0, $s0
/* 0030D8 800024D8 3C108016 */  lui   $s0, %hi(gGameThread) # $s0, 0x8016
/* 0030DC 800024DC 3C088016 */  lui   $t0, %hi(gAudioThread) # $t0, 0x8016
/* 0030E0 800024E0 261089D0 */  addiu $s0, %lo(gGameThread) # addiu $s0, $s0, -0x7630
/* 0030E4 800024E4 2508AB80 */  addiu $t0, %lo(gAudioThread) # addiu $t0, $t0, -0x5480
...
/* 003104 80002504 0C000114 */  jal   SysCreateThread
/* 003108 80002508 00003825 */   move  $a3, $zero
/* 00310C 8000250C 0C0330D8 */  jal   osStartThread
/* 003110 80002510 02002025 */   move  $a0, $s0
/* 003114 80002514 3C108015 */  lui   $s0, %hi(gIrqMessageQ) # $s0, 0x8015
/* 003118 80002518 2610EFB8 */  addiu $s0, %lo(gIrqMessageQ) # addiu $s0, $s0, -0x1048
