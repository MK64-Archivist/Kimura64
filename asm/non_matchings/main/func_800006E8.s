glabel BuildGraphicsTask
/* 0012E8 800006E8 3C028015 */  lui   $v0, %hi(gTListP) # $v0, 0x8015
/* 0012EC 800006EC 2442029C */  addiu $v0, %lo(gTListP) # addiu $v0, $v0, 0x29c
/* 0012F0 800006F0 8C4F0000 */  lw    $t7, ($v0)
/* 0012F4 800006F4 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 0012F8 800006F8 3C0E8015 */  lui   $t6, %hi(gRdpMessageQ) # $t6, 0x8015
/* 0012FC 800006FC AFBF0014 */  sw    $ra, 0x14($sp)
/* 001300 80000700 25CEEF88 */  addiu $t6, %lo(gRdpMessageQ) # addiu $t6, $t6, -0x1078
...
/* 00134C 8000074C 3C0F800E */  lui   $t7, %hi(gSequenceMode) # $t7, 0x800e
/* 001350 80000750 24010004 */  li    $at, 4
/* 001354 80000754 ADCD000C */  sw    $t5, 0xc($t6)
/* 001358 80000758 8DEFC50C */  lw    $t7, %lo(gSequenceMode)($t7)
/* 00135C 8000075C 3C18800E */  lui   $t8, %hi(gPlayerNumber) # $t8, 0x800e
...
/* 00136C 8000076C 8F18C538 */  lw    $t8, %lo(gPlayerNumber)($t8)
...
/* 001400 80000800 3C038015 */  lui   $v1, %hi(gDynamicIcp) # $v1, 0x8015
...
/* 001410 80000810 2463EF40 */  addiu $v1, %lo(gDynamicIcp) # addiu $v1, $v1, -0x10c0
...
/* 001424 80000824 3C0C8015 */  lui   $t4, %hi(gGraphPtr) # $t4, 0x8015
...
/* 001448 80000848 8D8C0298 */  lw    $t4, %lo(gGraphPtr)($t4)
...
/* 001470 80000870 3C028015 */  lui   $v0, %hi(gTListP) # $v0, 0x8015
/* 001474 80000874 2442029C */  addiu $v0, %lo(gTListP) # addiu $v0, $v0, 0x29c
