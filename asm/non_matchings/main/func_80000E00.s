glabel InitialGameframe
/* 001A00 80000E00 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 001A04 80000E04 3C028015 */  lui   $v0, %hi(gDynamicIcp) # $v0, 0x8015
/* 001A08 80000E08 3C0E8010 */  lui   $t6, 0x8010
/* 001A0C 80000E0C 2442EF40 */  addiu $v0, %lo(gDynamicIcp) # addiu $v0, $v0, -0x10c0
/* 001A10 80000E10 AFBF0014 */  sw    $ra, 0x14($sp)
/* 001A14 80000E14 25C5D860 */  addiu $a1, $t6, -0x27a0
/* 001A18 80000E18 AC450000 */  sw    $a1, ($v0)
/* 001A1C 80000E1C 0C0A9EE5 */  jal   SetSegment
/* 001A20 80000E20 24040001 */   li    $a0, 1
/* 001A24 80000E24 3C028015 */  lui   $v0, %hi(gDynamicIcp) # $v0, 0x8015
/* 001A28 80000E28 8C42EF40 */  lw    $v0, %lo(gDynamicIcp)($v0)
...
/* 001A38 80000E38 3C018015 */  lui   $at, %hi(gTListP) # $at, 0x8015
/* 001A3C 80000E3C AC2F029C */  sw    $t7, %lo(gTListP)($at)
...
/* 001A4C 80000E4C 3C018015 */  lui   $at, %hi(gGraphPtr) # $at, 0x8015
/* 001A50 80000E50 0C00032A */  jal   BeginDrawing
/* 001A54 80000E54 AC380298 */   sw    $t8, %lo(gGraphPtr)($at)
/* 001A58 80000E58 0C00034F */  jal   SoftwareBlanking
/* 001A5C 80000E5C 00002025 */   move  $a0, $zero
/* 001A60 80000E60 0C00033A */  jal   EndDrawing
/* 001A64 80000E64 00000000 */   nop   
/* 001A68 80000E68 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 001A6C 80000E6C 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 001A70 80000E70 3C010002 */  lui   $at, (0x00028B20 >> 16) # lui $at, 2
/* 001A74 80000E74 34218B20 */  ori   $at, (0x00028B20 & 0xFFFF) # ori $at, $at, 0x8b20
/* 001A78 80000E78 0C000310 */  jal   StartGraphicTask
/* 001A7C 80000E7C 00812021 */   addu  $a0, $a0, $at
/* 001A80 80000E80 3C02800E */  lui   $v0, %hi(gDrawFrame) # $v0, 0x800e
/* 001A84 80000E84 3C03800E */  lui   $v1, %hi(gFrameCounter) # $v1, 0x800e
/* 001A88 80000E88 2463C54C */  addiu $v1, %lo(gFrameCounter) # addiu $v1, $v1, -0x3ab4
/* 001A8C 80000E8C 2442C560 */  addiu $v0, %lo(gDrawFrame) # addiu $v0, $v0, -0x3aa0
