...
/* 001854 80000C54 3C02800E */  lui   $v0, %hi(gGameTask) # $v0, 0x800e
/* 001858 80000C58 2442C4B0 */  addiu $v0, %lo(gGameTask) # addiu $v0, $v0, -0x3b50
/* 00185C 80000C5C ACE00048 */  sw    $zero, 0x48($a3)
/* 001860 80000C60 8C4E0000 */  lw    $t6, ($v0)
/* 001864 80000C64 3C048015 */  lui   $a0, %hi(gIrqMessageQ) # $a0, 0x8015
/* 001868 80000C68 2484EFB8 */  addiu $a0, %lo(gIrqMessageQ) # addiu $a0, $a0, -0x1048
/* 00186C 80000C6C 15C00009 */  bnez  $t6, .L80000C94
/* 001870 80000C70 3C01800E */   lui   $at, 0x800e
/* 001874 80000C74 AC470000 */  sw    $a3, ($v0)
/* 001878 80000C78 3C01800E */  lui   $at, %hi(gGameNext) # $at, 0x800e
/* 00187C 80000C7C AC20C4B8 */  sw    $zero, %lo(gGameNext)($at)
...
.L80000C94:
/* 001894 80000C94 AC27C4B8 */  sw    $a3, %lo(gGameNext)($at)
