glabel BeginGameframe
/* 001AB4 80000EB4 3C0E800E */  lui   $t6, %hi(gFrameCounter) # $t6, 0x800e
/* 001AB8 80000EB8 8DCEC54C */  lw    $t6, %lo(gFrameCounter)($t6)
...
/* 001AD4 80000ED4 3C028015 */  lui   $v0, %hi(gDynamicIcp) # $v0, 0x8015
/* 001AD8 80000ED8 2739D860 */  addiu $t9, %lo(D_800FD860) # addiu $t9, $t9, -0x27a0
/* 001ADC 80000EDC 2442EF40 */  addiu $v0, %lo(gDynamicIcp) # addiu $v0, $v0, -0x10c0
...
/* 001AF0 80000EF0 0C0A9EE5 */  jal   SetSegment
/* 001AF4 80000EF4 AC450000 */   sw    $a1, ($v0)
/* 001AF8 80000EF8 3C028015 */  lui   $v0, %hi(gDynamicIcp) # $v0, 0x8015
/* 001AFC 80000EFC 8C42EF40 */  lw    $v0, %lo(gDynamicIcp)($v0)
...
/* 001B0C 80000F0C 3C018015 */  lui   $at, %hi(gGraphPtr) # $at, 0x8015
/* 001B10 80000F10 AC290298 */  sw    $t1, %lo(gGraphPtr)($at)
...
/* 001B24 80000F24 3C018015 */  lui   $at, %hi(gTListP) # $at, 0x8015
/* 001B28 80000F28 AC2A029C */  sw    $t2, %lo(gTListP)($at)
