...
/* 001E7C 8000127C 3C018016 */  lui   $at, %hi(gLastMemoryPointer) # $at, 0x8016
/* 001E80 80001280 AC2EF72C */  sw    $t6, %lo(gLastMemoryPointer)($at)
/* 001E84 80001284 00002025 */  move  $a0, $zero
/* 001E88 80001288 0C0A9EE5 */  jal   SetSegment
...
/* 001E9C 8000129C 0C0A9F3C */  jal   InitialFreeMemory
/* 001EA0 800012A0 248478D0 */   addiu $a0, %lo(D_801978D0) # addiu $a0, $a0, 0x78d0
/* 001EA4 800012A4 0C0002FB */  jal   AllocDepthBuffer
...
/* 001EC0 800012C0 3C198015 */  lui   $t9, %hi(gDMAMessageQ) # $t9, 0x8015
/* 001EC4 800012C4 2739EF58 */  addiu $t9, %lo(gDMAMessageQ) # addiu $t9, $t9, -0x10a8
/* 001EC8 800012C8 35EFA370 */  ori   $t7, (0x802BA370 & 0xFFFF) # ori $t7, $t7, 0xa370
/* 001ECC 800012CC 3C048015 */  lui   $a0, %hi(gDMAIOMessageBuf) # $a0, 0x8015
...
/* 001EE0 800012E0 2484F0A0 */  addiu $a0, %lo(gDMAIOMessageBuf) # addiu $a0, $a0, -0xf60
...
/* 001EF8 800012F8 3C048015 */  lui   $a0, %hi(gDMAMessageQ) # $a0, 0x8015
/* 001EFC 800012FC 3C058015 */  lui   $a1, %hi(gDummyMessage) # $a1, 0x8015
/* 001F00 80001300 24A5F098 */  addiu $a1, %lo(gDummyMessage) # addiu $a1, $a1, -0xf68
/* 001F04 80001304 2484EF58 */  addiu $a0, %lo(gDMAMessageQ) # addiu $a0, $a0, -0x10a8
...
/* 001F58 80001358 3C0C8015 */  lui   $t4, %hi(gDMAMessageQ) # $t4, 0x8015
/* 001F5C 8000135C 258CEF58 */  addiu $t4, %lo(gDMAMessageQ) # addiu $t4, $t4, -0x10a8
/* 001F60 80001360 016A4023 */  subu  $t0, $t3, $t2
/* 001F64 80001364 3C048015 */  lui   $a0, %hi(gDMAIOMessageBuf) # $a0, 0x8015
/* 001F68 80001368 2484F0A0 */  addiu $a0, %lo(gDMAIOMessageBuf) # addiu $a0, $a0, -0xf60
...
/* 001F8C 8000138C 3C048015 */  lui   $a0, %hi(gDMAMessageQ) # $a0, 0x8015
/* 001F90 80001390 3C058015 */  lui   $a1, %hi(gDummyMessage) # $a1, 0x8015
/* 001F94 80001394 24A5F098 */  addiu $a1, %lo(gDummyMessage) # addiu $a1, $a1, -0xf68
/* 001F98 80001398 2484EF58 */  addiu $a0, %lo(gDMAMessageQ) # addiu $a0, $a0, -0x10a8
/* 001F9C 8000139C 0C0335D4 */  jal   osRecvMesg
/* 001FA0 800013A0 24060001 */   li    $a2, 1
/* 001FA4 800013A4 8FA4002C */  lw    $a0, 0x2c($sp)
/* 001FA8 800013A8 3C058016 */  lui   $a1, %hi(gFreeMemoryPointer) # $a1, 0x8016
/* 001FAC 800013AC 8CA5F728 */  lw    $a1, %lo(gFreeMemoryPointer)($a1)
...
/* 001FC4 800013C4 0C010034 */  jal   SlideC1
/* 001FC8 800013C8 AFAD0040 */   sw    $t5, 0x40($sp)
/* 001FCC 800013CC 8FA50038 */  lw    $a1, 0x38($sp)
/* 001FD0 800013D0 0C0A9EE5 */  jal   SetSegment
/* 001FD4 800013D4 2404000D */   li    $a0, 13
/* 001FD8 800013D8 3C048016 */  lui   $a0, %hi(gFreeMemoryPointer) # $a0, 0x8016
/* 001FDC 800013DC 2484F728 */  addiu $a0, %lo(gFreeMemoryPointer) # addiu $a0, $a0, -0x8d8
/* 001FE0 800013E0 8FA30040 */  lw    $v1, 0x40($sp)
/* 001FE4 800013E4 8C8E0000 */  lw    $t6, ($a0)
/* 001FE8 800013E8 8FBF0024 */  lw    $ra, 0x24($sp)
/* 001FEC 800013EC 3C018016 */  lui   $at, %hi(gStaticMemoryPointer) # $at, 0x8016
/* 001FF0 800013F0 01C37821 */  addu  $t7, $t6, $v1
/* 001FF4 800013F4 AC8F0000 */  sw    $t7, ($a0)
/* 001FF8 800013F8 AC2FF734 */  sw    $t7, %lo(gStaticMemoryPointer)($at)
