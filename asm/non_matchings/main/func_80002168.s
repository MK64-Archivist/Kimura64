glabel InterruptSequence
/* 002D68 80002168 3C02800E */  lui   $v0, %hi(gTimer) # $v0, 0x800e
/* 002D6C 8000216C 2442C594 */  addiu $v0, %lo(gTimer) # addiu $v0, $v0, -0x3a6c
...
/* 002D80 80002180 3C03800E */  lui   $v1, %hi(gVideoFrame) # $v1, 0x800e
/* 002D84 80002184 46283280 */  add.d $f10, $f6, $f8
/* 002D88 80002188 2463C58C */  addiu $v1, %lo(gVideoFrame) # addiu $v1, $v1, -0x3a74
...
/* 002DA4 800021A4 0C0007EB */  jal   GetTaskMessage
/* 002DA8 800021A8 E4500000 */   swc1  $f16, ($v0)
/* 002DAC 800021AC 3C18800E */  lui   $t8, %hi(gAudioTask) # $t8, 0x800e
/* 002DB0 800021B0 8F18C4AC */  lw    $t8, %lo(gAudioTask)($t8)
/* 002DB4 800021B4 3C19800E */  lui   $t9, %hi(gCurrentTask) # $t9, 0x800e
/* 002DB8 800021B8 3C08800E */  lui   $t0, %hi(gCurrentTask) # $t0, 0x800e
/* 002DBC 800021BC 1300000E */  beqz  $t8, .L800021F8
/* 002DC0 800021C0 00000000 */   nop   
/* 002DC4 800021C4 8F39C4A8 */  lw    $t9, %lo(gCurrentTask)($t9)
/* 002DC8 800021C8 13200005 */  beqz  $t9, .L800021E0
/* 002DCC 800021CC 00000000 */   nop   
/* 002DD0 800021D0 0C0007DC */  jal   YieldRSPTask
/* 002DD4 800021D4 00000000 */   nop   
/* 002DD8 800021D8 10000016 */  b     .L80002234
/* 002DDC 800021DC 00000000 */   nop   
.L800021E0:
/* 002DE0 800021E0 0C000DBB */  jal   SetGraphicRCPTime
/* 002DE4 800021E4 00000000 */   nop   
/* 002DE8 800021E8 0C00019F */  jal   StartRSPTask
/* 002DEC 800021EC 24040002 */   li    $a0, 2
/* 002DF0 800021F0 10000010 */  b     .L80002234
/* 002DF4 800021F4 00000000 */   nop   
.L800021F8:
/* 002DF8 800021F8 8D08C4A8 */  lw    $t0, %lo(gCurrentTask)($t0)
/* 002DFC 800021FC 3C02800E */  lui   $v0, %hi(gGameTask) # $v0, 0x800e
/* 002E00 80002200 1500000C */  bnez  $t0, .L80002234
/* 002E04 80002204 00000000 */   nop   
/* 002E08 80002208 8C42C4B0 */  lw    $v0, %lo(gGameTask)($v0)
...
/* 002E24 80002224 0C000D97 */  jal   SetGraphicRCPTime
/* 002E28 80002228 00002025 */   move  $a0, $zero
/* 002E2C 8000222C 0C00019F */  jal   StartRSPTask
/* 002E30 80002230 24040001 */   li    $a0, 1
.L80002234:
/* 002E34 80002234 3C02800E */  lui   $v0, %hi(gAudioClient) # $v0, 0x800e
/* 002E38 80002238 8C42C4A0 */  lw    $v0, %lo(gAudioClient)($v0)
...
.L80002254:
/* 002E54 80002254 3C02800E */  lui   $v0, %hi(gGraphClient) # $v0, 0x800e
/* 002E58 80002258 8C42C4A4 */  lw    $v0, %lo(gGraphClient)($v0)
