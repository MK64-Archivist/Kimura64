glabel RSPDoneSequence
/* 002EDC 800022DC 3C02800E */  lui   $v0, %hi(gCurrentTask) # $v0, 0x800e
/* 002EE0 800022E0 2442C4A8 */  addiu $v0, %lo(gCurrentTask) # addiu $v0, $v0, -0x3b58
...
/* 002F20 80002320 0C000D97 */  jal   SetGraphicRCPTime
/* 002F24 80002324 24040001 */   li    $a0, 1
.L80002328:
/* 002F28 80002328 0C000DBB */  jal   SetGraphicRCPTime
/* 002F2C 8000232C 00000000 */   nop   
/* 002F30 80002330 0C00019F */  jal   StartRSPTask
...
/* 002F54 80002354 0C000DBB */  jal   SetGraphicRCPTime
/* 002F58 80002358 AFA7001C */   sw    $a3, 0x1c($sp)
/* 002F5C 8000235C 3C02800E */  lui   $v0, %hi(gGameTask) # $v0, 0x800e
/* 002F60 80002360 8C42C4B0 */  lw    $v0, %lo(gGameTask)($v0)
...
/* 002F88 80002388 0C000D97 */  jal   SetGraphicRCPTime
/* 002F8C 8000238C AFA7001C */   sw    $a3, 0x1c($sp)
/* 002F90 80002390 8FA7001C */  lw    $a3, 0x1c($sp)
.L80002394:
/* 002F94 80002394 24040001 */  li    $a0, 1
/* 002F98 80002398 0C00019F */  jal   StartRSPTask
/* 002F9C 8000239C AFA7001C */   sw    $a3, 0x1c($sp)
/* 002FA0 800023A0 8FA7001C */  lw    $a3, 0x1c($sp)
.L800023A4:
/* 002FA4 800023A4 3C01800E */  lui   $at, %hi(gAudioTask) # $at, 0x800e
/* 002FA8 800023A8 AC20C4AC */  sw    $zero, %lo(gAudioTask)($at)
...
.L800023CC:
/* 002FCC 800023CC 0C000D97 */  jal   SetGraphicRCPTime
