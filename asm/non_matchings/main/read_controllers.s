glabel ReadController
/* 001628 80000A28 27BDFFE0 */  addiu $sp, $sp, -0x20
/* 00162C 80000A2C AFBF0014 */  sw    $ra, 0x14($sp)
/* 001630 80000A30 3C048015 */  lui   $a0, %hi(gIntMesgQueue) # $a0, 0x8015
/* 001634 80000A34 0C03353C */  jal   osContStartReadData
/* 001638 80000A38 2484F0B8 */   addiu $a0, %lo(gIntMesgQueue) # addiu $a0, $a0, -0xf48
/* 00163C 80000A3C 3C048015 */  lui   $a0, %hi(gIntMesgQueue) # $a0, 0x8015
/* 001640 80000A40 2484F0B8 */  addiu $a0, %lo(gIntMesgQueue) # addiu $a0, $a0, -0xf48
/* 001644 80000A44 27A5001C */  addiu $a1, $sp, 0x1c
/* 001648 80000A48 0C0335D4 */  jal   osRecvMesg
/* 00164C 80000A4C 24060001 */   li    $a2, 1
/* 001650 80000A50 3C048015 */  lui   $a0, %hi(gRData) # $a0, 0x8015
/* 001654 80000A54 0C03356D */  jal   osContGetReadData
/* 001658 80000A58 2484F0F0 */   addiu $a0, %lo(gRData) # addiu $a0, $a0, -0xf10
/* 00165C 80000A5C 0C00024D */  jal   CheckController
/* 001660 80000A60 00002025 */   move  $a0, $zero
/* 001664 80000A64 0C00024D */  jal   CheckController
/* 001668 80000A68 24040001 */   li    $a0, 1
/* 00166C 80000A6C 0C00024D */  jal   CheckController
/* 001670 80000A70 24040002 */   li    $a0, 2
/* 001674 80000A74 0C00024D */  jal   CheckController
/* 001678 80000A78 24040003 */   li    $a0, 3
/* 00167C 80000A7C 3C03800E */  lui   $v1, %hi(gCont1P) # $v1, 0x800e
/* 001680 80000A80 3C04800E */  lui   $a0, %hi(gCont2P) # $a0, 0x800e
/* 001684 80000A84 2484C4C0 */  addiu $a0, %lo(gCont2P) # addiu $a0, $a0, -0x3b40
/* 001688 80000A88 2463C4BC */  addiu $v1, %lo(gCont1P) # addiu $v1, $v1, -0x3b44
/* 00168C 80000A8C 3C05800E */  lui   $a1, %hi(gCont3P) # $a1, 0x800e
/* 001690 80000A90 8C6E0000 */  lw    $t6, ($v1)
/* 001694 80000A94 8C980000 */  lw    $t8, ($a0)
/* 001698 80000A98 24A5C4C4 */  addiu $a1, %lo(gCont3P) # addiu $a1, $a1, -0x3b3c
/* 00169C 80000A9C 3C06800E */  lui   $a2, %hi(gCont4P) # $a2, 0x800e
/* 0016A0 80000AA0 8CA90000 */  lw    $t1, ($a1)
/* 0016A4 80000AA4 24C6C4C8 */  addiu $a2, %lo(gCont4P) # addiu $a2, $a2, -0x3b38
...
/* 0016B8 80000AB8 3C02800E */  lui   $v0, %hi(gContOR) # $v0, 0x800e
/* 0016BC 80000ABC 958D0004 */  lhu   $t5, 4($t4)
/* 0016C0 80000AC0 2442C4CC */  addiu $v0, %lo(gContOR) # addiu $v0, $v0, -0x3b34
