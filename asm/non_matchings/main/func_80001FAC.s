...
/* 002BF4 80001FF4 3C16800E */   lui   $s6, %hi(gGameNext) # $s6, 0x800e
...
/* 002C00 80002000 26D6C4B8 */  addiu $s6, %lo(gGameNext) # addiu $s6, $s6, -0x3b48
...
.L80002054:
/* 002C54 80002054 3C03800E */  lui   $v1, %hi(gAudioTask) # $v1, 0x800e
/* 002C58 80002058 2463C4AC */  addiu $v1, %lo(gAudioTask) # addiu $v1, $v1, -0x3b54
/* 002C5C 8000205C 8C680000 */  lw    $t0, ($v1)
/* 002C60 80002060 3C13800E */  lui   $s3, %hi(D_800DC4B4) # $s3, 0x800e
/* 002C64 80002064 3C16800E */  lui   $s6, %hi(gGameNext) # $s6, 0x800e
/* 002C68 80002068 26D6C4B8 */  addiu $s6, %lo(gGameNext) # addiu $s6, $s6, -0x3b48
...
.L80002088:
/* 002C88 80002088 3C03800E */  lui   $v1, %hi(gGameTask) # $v1, 0x800e
/* 002C8C 8000208C 2463C4B0 */  addiu $v1, %lo(gGameTask) # addiu $v1, $v1, -0x3b50
