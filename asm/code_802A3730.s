...
/* 10CD8C 802A377C 3C0A8015 */  lui   $t2, %hi(gGraphPtr) # $t2, 0x8015
/* 10CD90 802A3780 A499001A */  sh    $t9, 0x1a($a0)
/* 10CD94 802A3784 254A0298 */  addiu $t2, %lo(gGraphPtr) # addiu $t2, $t2, 0x298
...
glabel FadeoutSequence
/* 10CEC4 802A38B4 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 10CEC8 802A38B8 AFBF0014 */  sw    $ra, 0x14($sp)
/* 10CECC 802A38BC 0C0A8F8F */  jal   InitRDP
/* 10CED0 802A38C0 00000000 */   nop   
/* 10CED4 802A38C4 0C0A9075 */  jal   ClearFrameBuffer
/* 10CED8 802A38C8 00000000 */   nop   
/* 10CEDC 802A38CC 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 10CEE0 802A38D0 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
/* 10CEE4 802A38D4 8CA20000 */  lw    $v0, ($a1)
/* 10CEE8 802A38D8 3C0FE900 */  lui   $t7, 0xe900
/* 10CEEC 802A38DC 3C07800E */  lui   $a3, %hi(gFadeoutCount) # $a3, 0x800e
...
/* 10CF08 802A38F8 24E7C5C4 */  addiu $a3, %lo(gFadeoutCount) # addiu $a3, $a3, -0x3a3c
...
/* 10CF24 802A3914 3C028015 */  lui   $v0, %hi(gNextSequenceMode) # $v0, 0x8015
...
.L802A3928:
/* 10CF38 802A3928 8C420124 */  lw    $v0, %lo(gNextSequenceMode)($v0)
/* 10CF3C 802A392C 3C01800E */  lui   $at, %hi(gNewSequenceMode) # $at, 0x800e
/* 10CF40 802A3930 240900FF */  li    $t1, 255
/* 10CF44 802A3934 AC22C524 */  sw    $v0, %lo(gNewSequenceMode)($at)
/* 10CF48 802A3938 3C01800E */  lui   $at, %hi(gSequenceMode) # $at, 0x800e
/* 10CF4C 802A393C AC29C50C */  sw    $t1, %lo(gSequenceMode)($at)
/* 10CF50 802A3940 3C01800E */  lui   $at, %hi(gFadeoutFlag) # $at, 0x800e
/* 10CF54 802A3944 A420C5C0 */  sh    $zero, %lo(gFadeoutFlag)($at)
...
.L802A3980:
/* 10CF90 802A3980 3C02800F */  lui   $v0, %hi(gKBGNumber) # $v0, 0x800f
/* 10CF94 802A3984 244286A0 */  addiu $v0, %lo(gKBGNumber) # addiu $v0, $v0, -0x7960
...
.L802A39A4:
/* 10CFB4 802A39A4 3C02800F */  lui   $v0, %hi(gKBGNumber) # $v0, 0x800f
/* 10CFB8 802A39A8 244286A0 */  addiu $v0, %lo(gKBGNumber) # addiu $v0, $v0, -0x7960
/* 10CFBC 802A39AC 10000008 */  b     .L802A39D0
/* 10CFC0 802A39B0 AC4C0000 */   sw    $t4, ($v0)
.L802A39B4:
/* 10CFC4 802A39B4 3C02800F */  lui   $v0, %hi(gKBGNumber) # $v0, 0x800f
/* 10CFC8 802A39B8 244286A0 */  addiu $v0, %lo(gKBGNumber) # addiu $v0, $v0, -0x7960
/* 10CFCC 802A39BC 10000004 */  b     .L802A39D0
/* 10CFD0 802A39C0 AC4D0000 */   sw    $t5, ($v0)
.L802A39C4:
/* 10CFD4 802A39C4 3C02800F */  lui   $v0, %hi(gKBGNumber) # $v0, 0x800f
/* 10CFD8 802A39C8 244286A0 */  addiu $v0, %lo(gKBGNumber) # addiu $v0, $v0, -0x7960
...
/* 10D058 802A3A48 3C038015 */   lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10D05C 802A3A4C 240B0140 */  li    $t3, 320
.L802A3A50:
/* 10D060 802A3A50 298100F1 */  slti  $at, $t4, 0xf1
/* 10D064 802A3A54 14200002 */  bnez  $at, .L802A3A60
/* 10D068 802A3A58 24630298 */   addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
glabel ClearZBuffer
/* 10D2C0 802A3CB0 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10D2C4 802A3CB4 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
glabel InitRDP
/* 10D44C 802A3E3C 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10D450 802A3E40 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 10D6F4 802A40E4 3C068015 */  lui   $a2, %hi(gGraphPtr) # $a2, 0x8015
/* 10D6F8 802A40E8 24C60298 */  addiu $a2, %lo(gGraphPtr) # addiu $a2, $a2, 0x298
...
/* 10D710 802A4100 3C18800E */  lui   $t8, %hi(gScreen1) # $t8, 0x800e
/* 10D714 802A4104 AC4F0000 */  sw    $t7, ($v0)
/* 10D718 802A4108 8F18C5EC */  lw    $t8, %lo(gScreen1)($t8)
...
glabel InitRSP
/* 10D770 802A4160 3C068015 */  lui   $a2, %hi(gGraphPtr) # $a2, 0x8015
/* 10D774 802A4164 24C60298 */  addiu $a2, %lo(gGraphPtr) # addiu $a2, $a2, 0x298
...
/* 10D7E4 802A41D4 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10D7E8 802A41D8 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 10D800 802A41F0 3C18800E */  lui   $t8, %hi(gDrawFrame) # $t8, 0x800e
/* 10D804 802A41F4 AC4F0000 */  sw    $t7, ($v0)
/* 10D808 802A41F8 9718C560 */  lhu   $t8, %lo(gDrawFrame)($t8)
...
glabel MakeBorder
/* 10D910 802A4300 3C0E800E */  lui   $t6, %hi(gScreenMode) # $t6, 0x800e
/* 10D914 802A4304 8DCEC52C */  lw    $t6, %lo(gScreenMode)($t6)
/* 10D918 802A4308 3C0F800E */  lui   $t7, %hi(gClearCFBFlag) # $t7, 0x800e
/* 10D91C 802A430C 11C0007D */  beqz  $t6, .L802A4504
/* 10D920 802A4310 00000000 */   nop   
/* 10D924 802A4314 95EFC5B0 */  lhu   $t7, %lo(gClearCFBFlag)($t7)
/* 10D928 802A4318 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10D92C 802A431C 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 10D984 802A4374 3C0E800E */  lui   $t6, %hi(gDrawFrame) # $t6, 0x800e
/* 10D988 802A4378 AC590000 */  sw    $t9, ($v0)
/* 10D98C 802A437C 95CEC560 */  lhu   $t6, %lo(gDrawFrame)($t6)
...
/* 10DA1C 802A440C 3C0B800E */  lui   $t3, %hi(gScreenMode) # $t3, 0x800e
...
/* 10DA34 802A4424 8D6BC52C */  lw    $t3, %lo(gScreenMode)($t3)
...
glabel initialBackground
/* 10DB1C 802A450C 3C0E800E */  lui   $t6, %hi(gFogFlag) # $t6, 0x800e
/* 10DB20 802A4510 95CEC5BC */  lhu   $t6, %lo(gFogFlag)($t6)
/* 10DB24 802A4514 3C03800E */  lui   $v1, %hi(gMapNumber) # $v1, 0x800e
/* 10DB28 802A4518 00802825 */  move  $a1, $a0
/* 10DB2C 802A451C 11C00040 */  beqz  $t6, .L802A4620
/* 10DB30 802A4520 2463C5A0 */   addiu $v1, %lo(gMapNumber) # addiu $v1, $v1, -0x3a60
...
/* 10DEA0 802A4890 0C0A8F8F */  jal   InitRDP
/* 10DEA4 802A4894 AFA70034 */   sw    $a3, 0x34($sp)
/* 10DEA8 802A4898 3C0E800E */  lui   $t6, %hi(gMapNumber) # $t6, 0x800e
/* 10DEAC 802A489C 85CEC5A0 */  lh    $t6, %lo(gMapNumber)($t6)
/* 10DEB0 802A48A0 2401000D */  li    $at, 13
/* 10DEB4 802A48A4 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10DEB8 802A48A8 11C10054 */  beq   $t6, $at, .L802A49FC
/* 10DEBC 802A48AC 24630298 */   addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 10DF20 802A4910 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 10DF24 802A4914 44050000 */  mfc1  $a1, $f0
/* 10DF28 802A4918 44070000 */  mfc1  $a3, $f0
/* 10DF2C 802A491C 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
...
/* 10DF48 802A4938 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10DF4C 802A493C 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 10DF80 802A4970 3C0A8015 */  lui   $t2, %hi(gDynamicIcp) # $t2, 0x8015
/* 10DF84 802A4974 AC590000 */  sw    $t9, ($v0)
/* 10DF88 802A4978 8D4AEF40 */  lw    $t2, %lo(gDynamicIcp)($t2)
...
/* 10E03C 802A4A2C 0C0A9143 */  jal   initialBackground
...
/* 10E07C 802A4A6C 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 10E080 802A4A70 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 10E0A4 802A4A94 0C0AD5E5 */  jal   MakeGULookAt
...
/* 10E0B4 802A4AA4 0C0ADC73 */  jal   MultAffineMtx
...
/* 10E180 802A4B70 0C0A8F8F */  jal   InitRDP
/* 10E184 802A4B74 A60D0072 */   sh    $t5, 0x72($s0)
/* 10E188 802A4B78 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10E18C 802A4B7C 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 10E1F0 802A4BE0 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 10E1F4 802A4BE4 44050000 */  mfc1  $a1, $f0
/* 10E1F8 802A4BE8 44070000 */  mfc1  $a3, $f0
/* 10E1FC 802A4BEC 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
...
/* 10E218 802A4C08 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10E21C 802A4C0C 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 10E250 802A4C40 3C0F8015 */  lui   $t7, %hi(gDynamicIcp) # $t7, 0x8015
/* 10E254 802A4C44 AC580000 */  sw    $t8, ($v0)
/* 10E258 802A4C48 8DEFEF40 */  lw    $t7, %lo(gDynamicIcp)($t7)
...
/* 10E2CC 802A4CBC 3C0E800E */  lui   $t6, %hi(gMapNumber) # $t6, 0x800e
/* 10E2D0 802A4CC0 AC4B0000 */  sw    $t3, ($v0)
/* 10E2D4 802A4CC4 AC4C0004 */  sw    $t4, 4($v0)
/* 10E2D8 802A4CC8 85CEC5A0 */  lh    $t6, %lo(gMapNumber)($t6)
...
glabel InitialPerspective
/* 10E328 802A4D18 3C0E800E */  lui   $t6, %hi(gSequenceMode) # $t6, 0x800e
/* 10E32C 802A4D1C 8DCEC50C */  lw    $t6, %lo(gSequenceMode)($t6)
/* 10E330 802A4D20 24010004 */  li    $at, 4
/* 10E334 802A4D24 3C0F800E */  lui   $t7, %hi(gMapNumber) # $t7, 0x800e
...
.L802A4D50:
/* 10E360 802A4D50 95EFC5A0 */  lhu   $t7, %lo(gMapNumber)($t7)
...
.L802A4E6C:
/* 10E47C 802A4E6C 3C02800E */  lui   $v0, %hi(gRaceScreenMode) # $v0, 0x800e
/* 10E480 802A4E70 8C42C530 */  lw    $v0, %lo(gRaceScreenMode)($v0)
...
/* 10E4B8 802A4EA8 3C018015 */  lui   $at, %hi(gAspectRatio)
/* 10E4BC 802A4EAC 03E00008 */  jr    $ra
/* 10E4C0 802A4EB0 E4300148 */   swc1  $f16, %lo(gAspectRatio)($at)

.L802A4EB4:
/* 10E4C4 802A4EB4 3C01802C */  lui   $at, %hi(D_802B9C20) # $at, 0x802c
/* 10E4C8 802A4EB8 C4329C20 */  lwc1  $f18, %lo(D_802B9C20)($at)
/* 10E4CC 802A4EBC 3C018015 */  lui   $at, %hi(gAspectRatio)
/* 10E4D0 802A4EC0 03E00008 */  jr    $ra
/* 10E4D4 802A4EC4 E4320148 */   swc1  $f18, %lo(gAspectRatio)($at)

.L802A4EC8:
/* 10E4D8 802A4EC8 3C01802C */  lui   $at, %hi(D_802B9C24) # $at, 0x802c
/* 10E4DC 802A4ECC C4249C24 */  lwc1  $f4, %lo(D_802B9C24)($at)
/* 10E4E0 802A4ED0 3C018015 */  lui   $at, %hi(gAspectRatio)
/* 10E4E4 802A4ED4 03E00008 */  jr    $ra
/* 10E4E8 802A4ED8 E4240148 */   swc1  $f4, %lo(gAspectRatio)($at)

.L802A4EDC:
/* 10E4EC 802A4EDC 3C01802C */  lui   $at, %hi(D_802B9C28) # $at, 0x802c
/* 10E4F0 802A4EE0 C4269C28 */  lwc1  $f6, %lo(D_802B9C28)($at)
/* 10E4F4 802A4EE4 3C018015 */  lui   $at, %hi(gAspectRatio) # $at, 0x8015
/* 10E4F8 802A4EE8 E4260148 */  swc1  $f6, %lo(gAspectRatio)($at)
/* 10E4FC 802A4EEC 03E00008 */  jr    $ra
/* 10E500 802A4EF0 00000000 */   nop   

glabel SetupPerspective
/* 10E504 802A4EF4 3C02800E */  lui   $v0, %hi(gScreenMode) # $v0, 0x800e
/* 10E508 802A4EF8 8C42C52C */  lw    $v0, %lo(gScreenMode)($v0)
...
/* 10E53C 802A4F2C 3C04800E */   lui   $a0, %hi(gKart1) # $a0, 0x800e
...
/* 10E554 802A4F44 8C84C4DC */   lw    $a0, %lo(gKart1)($a0)
...
/* 10E570 802A4F60 3C04800E */  lui   $a0, %hi(gKart2) # $a0, 0x800e
...
/* 10E580 802A4F70 8C84C4E0 */   lw    $a0, %lo(gKart2)($a0)
...
/* 10E59C 802A4F8C 3C04800E */  lui   $a0, %hi(gKart2) # $a0, 0x800e
...
/* 10E5AC 802A4F9C 8C84C4E0 */   lw    $a0, %lo(gKart2)($a0)
...
/* 10E5C8 802A4FB8 3C04800E */  lui   $a0, %hi(gKart2) # $a0, 0x800e
...
/* 10E5D8 802A4FC8 8C84C4E0 */   lw    $a0, %lo(gKart2)($a0)
/* 10E5DC 802A4FCC 3C04800E */  lui   $a0, %hi(gKart3) # $a0, 0x800e
...
/* 10E5EC 802A4FDC 8C84C4E4 */   lw    $a0, %lo(gKart3)($a0)
/* 10E5F0 802A4FE0 3C04800E */  lui   $a0, %hi(gKart4) # $a0, 0x800e
...
/* 10E600 802A4FF0 8C84C4E8 */   lw    $a0, %lo(gKart4)($a0)
...
glabel InitialDrawRight
/* 10E614 802A5004 27BDFFE0 */  addiu $sp, $sp, -0x20
/* 10E618 802A5008 AFBF001C */  sw    $ra, 0x1c($sp)
/* 10E61C 802A500C 0C0A8F8F */  jal   InitRDP
/* 10E620 802A5010 00000000 */   nop   
/* 10E624 802A5014 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10E628 802A5018 0C0A8DCC */  jal   func_802A3730
/* 10E62C 802A501C 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10E630 802A5020 3C068015 */  lui   $a2, %hi(gGraphPtr) # $a2, 0x8015
/* 10E634 802A5024 24C60298 */  addiu $a2, %lo(gGraphPtr) # addiu $a2, $a2, 0x298
...
/* 10E66C 802A505C 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10E670 802A5060 AC480000 */  sw    $t0, ($v0)
/* 10E674 802A5064 AC490004 */  sw    $t1, 4($v0)
/* 10E678 802A5068 0C0A8E78 */  jal   func_802A39E0
/* 10E67C 802A506C 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10E680 802A5070 3C0A800E */  lui   $t2, %hi(gBackgroundFlag) # $t2, 0x800e
/* 10E684 802A5074 954AC5B4 */  lhu   $t2, %lo(gBackgroundFlag)($t2)
...
/* 10E694 802A5084 3C05800E */   lui   $a1, %hi(gScreen2) # $a1, 0x800e
...
/* 10E6A4 802A5094 8CA5C5F0 */  lw    $a1, %lo(gScreen2)($a1)
/* 10E6A8 802A5098 24060140 */  li    $a2, 320
/* 10E6AC 802A509C 0C0A9283 */  jal   DisplayBackground
...
/* 10E6C8 802A50B8 3C05800E */  lui   $a1, %hi(gScreen2) # $a1, 0x800e
/* 10E6CC 802A50BC 8CA5C5F0 */  lw    $a1, %lo(gScreen2)($a1)
...
/* 10E6DC 802A50CC 0C0A921F */  jal   DisplayBackground2
...
/* 10E704 802A50F4 0C0A8F8F */  jal   InitRDP
/* 10E708 802A50F8 00000000 */   nop   
/* 10E70C 802A50FC 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10E710 802A5100 0C0A8DCC */  jal   func_802A3730
/* 10E714 802A5104 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10E718 802A5108 3C068015 */  lui   $a2, %hi(gGraphPtr) # $a2, 0x8015
/* 10E71C 802A510C 24C60298 */  addiu $a2, %lo(gGraphPtr) # addiu $a2, $a2, 0x298
...
/* 10E754 802A5144 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10E758 802A5148 AC480000 */  sw    $t0, ($v0)
/* 10E75C 802A514C AC490004 */  sw    $t1, 4($v0)
/* 10E760 802A5150 0C0A8E78 */  jal   func_802A39E0
/* 10E764 802A5154 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10E768 802A5158 3C0A800E */  lui   $t2, %hi(gBackgroundFlag) # $t2, 0x800e
/* 10E76C 802A515C 954AC5B4 */  lhu   $t2, %lo(gBackgroundFlag)($t2)
...
/* 10E77C 802A516C 3C05800E */   lui   $a1, %hi(gScreen1) # $a1, 0x800e
...
/* 10E78C 802A517C 8CA5C5EC */  lw    $a1, %lo(gScreen1)($a1)
/* 10E790 802A5180 24060140 */  li    $a2, 320
/* 10E794 802A5184 0C0A9283 */  jal   DisplayBackground
...
/* 10E7B0 802A51A0 3C05800E */  lui   $a1, %hi(gScreen1) # $a1, 0x800e
/* 10E7B4 802A51A4 8CA5C5EC */  lw    $a1, %lo(gScreen1)($a1)
...
/* 10E7C4 802A51B4 0C0A921F */  jal   DisplayBackground2
...
/* 10E7EC 802A51DC 0C0A8F8F */  jal   InitRDP
/* 10E7F0 802A51E0 00000000 */   nop   
/* 10E7F4 802A51E4 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10E7F8 802A51E8 0C0A8E78 */  jal   func_802A39E0
/* 10E7FC 802A51EC 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10E800 802A51F0 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10E804 802A51F4 0C0A8DCC */  jal   func_802A3730
/* 10E808 802A51F8 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10E80C 802A51FC 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 10E810 802A5200 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
...
/* 10E848 802A5238 3C0A800E */  lui   $t2, %hi(gBackgroundFlag) # $t2, 0x800e
/* 10E84C 802A523C AC480000 */  sw    $t0, ($v0)
/* 10E850 802A5240 AC490004 */  sw    $t1, 4($v0)
/* 10E854 802A5244 954AC5B4 */  lhu   $t2, %lo(gBackgroundFlag)($t2)
...
/* 10E864 802A5254 3C05800E */   lui   $a1, %hi(gScreen1) # $a1, 0x800e
...
/* 10E874 802A5264 8CA5C5EC */  lw    $a1, %lo(gScreen1)($a1)
/* 10E878 802A5268 24060140 */  li    $a2, 320
/* 10E87C 802A526C 0C0A9283 */  jal   DisplayBackground
...
/* 10E898 802A5288 3C05800E */  lui   $a1, %hi(gScreen1) # $a1, 0x800e
/* 10E89C 802A528C 8CA5C5EC */  lw    $a1, %lo(gScreen1)($a1)
...
/* 10E8AC 802A529C 0C0A921F */  jal   DisplayBackground2
...
/* 10E8D4 802A52C4 0C0A8F8F */  jal   InitRDP
/* 10E8D8 802A52C8 00000000 */   nop   
/* 10E8DC 802A52CC 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10E8E0 802A52D0 0C0A8E78 */  jal   func_802A39E0
/* 10E8E4 802A52D4 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10E8E8 802A52D8 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10E8EC 802A52DC 0C0A8DCC */  jal   func_802A3730
/* 10E8F0 802A52E0 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10E8F4 802A52E4 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 10E8F8 802A52E8 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
...
/* 10E930 802A5320 3C0A800E */  lui   $t2, %hi(gBackgroundFlag) # $t2, 0x800e
/* 10E934 802A5324 AC480000 */  sw    $t0, ($v0)
/* 10E938 802A5328 AC490004 */  sw    $t1, 4($v0)
/* 10E93C 802A532C 954AC5B4 */  lhu   $t2, %lo(gBackgroundFlag)($t2)
...
/* 10E94C 802A533C 3C05800E */   lui   $a1, %hi(gScreen2) # $a1, 0x800e
...
/* 10E95C 802A534C 8CA5C5F0 */  lw    $a1, %lo(gScreen2)($a1)
/* 10E960 802A5350 24060140 */  li    $a2, 320
/* 10E964 802A5354 0C0A9283 */  jal   DisplayBackground
...
/* 10E980 802A5370 3C05800E */  lui   $a1, %hi(gScreen2) # $a1, 0x800e
/* 10E984 802A5374 8CA5C5F0 */  lw    $a1, %lo(gScreen2)($a1)
...
/* 10E994 802A5384 0C0A921F */  jal   DisplayBackground2
...
glabel InitialDrawCommon
/* 10E9B4 802A53A4 27BDFFE0 */  addiu $sp, $sp, -0x20
/* 10E9B8 802A53A8 AFBF001C */  sw    $ra, 0x1c($sp)
/* 10E9BC 802A53AC 0C0A9F02 */  jal   StoreSegments
/* 10E9C0 802A53B0 00000000 */   nop   
/* 10E9C4 802A53B4 0C0A8F8F */  jal   InitRDP
/* 10E9C8 802A53B8 00000000 */   nop   
/* 10E9CC 802A53BC 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10E9D0 802A53C0 0C0A8DCC */  jal   func_802A3730
/* 10E9D4 802A53C4 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10E9D8 802A53C8 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 10E9DC 802A53CC 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
...
/* 10EA18 802A5408 0C0A8F2C */  jal   ClearZBuffer
/* 10EA1C 802A540C AC490004 */   sw    $t1, 4($v0)
/* 10EA20 802A5410 0C0A9075 */  jal   ClearFrameBuffer
/* 10EA24 802A5414 00000000 */   nop   
/* 10EA28 802A5418 3C0A800E */  lui   $t2, %hi(gBackgroundFlag) # $t2, 0x800e
/* 10EA2C 802A541C 954AC5B4 */  lhu   $t2, %lo(gBackgroundFlag)($t2)
...
/* 10EA3C 802A542C 3C05800E */   lui   $a1, %hi(gScreen1) # $a1, 0x800e
...
/* 10EA4C 802A543C 8CA5C5EC */  lw    $a1, %lo(gScreen1)($a1)
/* 10EA50 802A5440 24060140 */  li    $a2, 320
/* 10EA54 802A5444 0C0A9283 */  jal   DisplayBackground
/* 10EA58 802A5448 240700F0 */   li    $a3, 240
/* 10EA5C 802A544C 3C0C800E */  lui   $t4, %hi(gSequenceMode) # $t4, 0x800e
/* 10EA60 802A5450 8D8CC50C */  lw    $t4, %lo(gSequenceMode)($t4)
...
/* 10EA84 802A5474 3C05800E */  lui   $a1, %hi(gScreen1) # $a1, 0x800e
/* 10EA88 802A5478 8CA5C5EC */  lw    $a1, %lo(gScreen1)($a1)
...
/* 10EA98 802A5488 0C0A921F */  jal   DisplayBackground2
...
/* 10EAC0 802A54B0 0C0A8F8F */  jal   InitRDP
/* 10EAC4 802A54B4 00000000 */   nop   
/* 10EAC8 802A54B8 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10EACC 802A54BC 0C0A8E78 */  jal   func_802A39E0
/* 10EAD0 802A54C0 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10EAD4 802A54C4 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10EAD8 802A54C8 0C0A8DCC */  jal   func_802A3730
/* 10EADC 802A54CC 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10EAE0 802A54D0 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 10EAE4 802A54D4 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
...
/* 10EB1C 802A550C 3C0A800E */  lui   $t2, %hi(gBackgroundFlag) # $t2, 0x800e
/* 10EB20 802A5510 AC480000 */  sw    $t0, ($v0)
/* 10EB24 802A5514 AC490004 */  sw    $t1, 4($v0)
/* 10EB28 802A5518 954AC5B4 */  lhu   $t2, %lo(gBackgroundFlag)($t2)
...
/* 10EB38 802A5528 3C05800E */   lui   $a1, %hi(gScreen1) # $a1, 0x800e
...
/* 10EB48 802A5538 8CA5C5EC */  lw    $a1, %lo(gScreen1)($a1)
/* 10EB4C 802A553C 24060140 */  li    $a2, 320
/* 10EB50 802A5540 0C0A9283 */  jal   DisplayBackground
...
/* 10EB6C 802A555C 3C05800E */  lui   $a1, %hi(gScreen1) # $a1, 0x800e
/* 10EB70 802A5560 8CA5C5EC */  lw    $a1, %lo(gScreen1)($a1)
...
/* 10EB80 802A5570 0C0A921F */  jal   DisplayBackground2
...
/* 10EBA8 802A5598 0C0A8F8F */  jal   InitRDP
/* 10EBAC 802A559C 00000000 */   nop   
/* 10EBB0 802A55A0 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10EBB4 802A55A4 0C0A8E78 */  jal   func_802A39E0
/* 10EBB8 802A55A8 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10EBBC 802A55AC 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10EBC0 802A55B0 0C0A8DCC */  jal   func_802A3730
/* 10EBC4 802A55B4 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10EBC8 802A55B8 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 10EBCC 802A55BC 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
...
/* 10EC04 802A55F4 3C0A800E */  lui   $t2, %hi(gBackgroundFlag) # $t2, 0x800e
/* 10EC08 802A55F8 AC480000 */  sw    $t0, ($v0)
/* 10EC0C 802A55FC AC490004 */  sw    $t1, 4($v0)
/* 10EC10 802A5600 954AC5B4 */  lhu   $t2, %lo(gBackgroundFlag)($t2)
...
/* 10EC20 802A5610 3C05800E */   lui   $a1, %hi(gScreen2) # $a1, 0x800e
...
/* 10EC30 802A5620 8CA5C5F0 */  lw    $a1, %lo(gScreen2)($a1)
/* 10EC34 802A5624 24060140 */  li    $a2, 320
/* 10EC38 802A5628 0C0A9283 */  jal   DisplayBackground
...
/* 10EC54 802A5644 3C05800E */  lui   $a1, %hi(gScreen2) # $a1, 0x800e
/* 10EC58 802A5648 8CA5C5F0 */  lw    $a1, %lo(gScreen2)($a1)
...
/* 10EC68 802A5658 0C0A921F */  jal   DisplayBackground2
...
/* 10EC90 802A5680 0C0A8F8F */  jal   InitRDP
/* 10EC94 802A5684 00000000 */   nop   
/* 10EC98 802A5688 3C04800E */  lui   $a0, %hi(gScreen3) # $a0, 0x800e
/* 10EC9C 802A568C 0C0A8E78 */  jal   func_802A39E0
/* 10ECA0 802A5690 8C84C5F4 */   lw    $a0, %lo(gScreen3)($a0)
/* 10ECA4 802A5694 3C04800E */  lui   $a0, %hi(gScreen3) # $a0, 0x800e
/* 10ECA8 802A5698 0C0A8DCC */  jal   func_802A3730
/* 10ECAC 802A569C 8C84C5F4 */   lw    $a0, %lo(gScreen3)($a0)
/* 10ECB0 802A56A0 3C058015 */  lui   $a1, %hi(gGraphPtr) # $a1, 0x8015
/* 10ECB4 802A56A4 24A50298 */  addiu $a1, %lo(gGraphPtr) # addiu $a1, $a1, 0x298
...
/* 10ECEC 802A56DC 3C0A800E */  lui   $t2, %hi(gBackgroundFlag) # $t2, 0x800e
/* 10ECF0 802A56E0 AC480000 */  sw    $t0, ($v0)
/* 10ECF4 802A56E4 AC490004 */  sw    $t1, 4($v0)
/* 10ECF8 802A56E8 954AC5B4 */  lhu   $t2, %lo(gBackgroundFlag)($t2)
...
/* 10ED08 802A56F8 3C05800E */   lui   $a1, %hi(gScreen3) # $a1, 0x800e
...
/* 10ED18 802A5708 8CA5C5F4 */  lw    $a1, %lo(gScreen3)($a1)
/* 10ED1C 802A570C 24060140 */  li    $a2, 320
/* 10ED20 802A5710 0C0A9283 */  jal   DisplayBackground
...
/* 10ED3C 802A572C 3C05800E */  lui   $a1, %hi(gScreen3) # $a1, 0x800e
/* 10ED40 802A5730 8CA5C5F4 */  lw    $a1, %lo(gScreen3)($a1)
...
/* 10ED50 802A5740 0C0A921F */  jal   DisplayBackground2
...
/* 10ED78 802A5768 0C0A8F8F */  jal   InitRDP
/* 10ED7C 802A576C 00000000 */   nop   
/* 10ED80 802A5770 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10ED84 802A5774 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 10EDBC 802A57AC 3C18800E */  lui   $t8, %hi(gPlayerNumber) # $t8, 0x800e
/* 10EDC0 802A57B0 AC4E0000 */  sw    $t6, ($v0)
/* 10EDC4 802A57B4 AC4F0004 */  sw    $t7, 4($v0)
/* 10EDC8 802A57B8 8F18C538 */  lw    $t8, %lo(gPlayerNumber)($t8)
...
/* 10EDE4 802A57D4 3C04800E */  lui   $a0, %hi(gScreen4) # $a0, 0x800e
...
/* 10EDFC 802A57EC 8C84C5F8 */   lw    $a0, %lo(gScreen4)($a0)
/* 10EE00 802A57F0 3C038015 */  lui   $v1, %hi(gGraphPtr) # $v1, 0x8015
/* 10EE04 802A57F4 24630298 */  addiu $v1, %lo(gGraphPtr) # addiu $v1, $v1, 0x298
...
/* 10EE3C 802A582C 3C0F800E */  lui   $t7, %hi(gDrawFrame) # $t7, 0x800e
/* 10EE40 802A5830 AC4E0000 */  sw    $t6, ($v0)
/* 10EE44 802A5834 95EFC560 */  lhu   $t7, %lo(gDrawFrame)($t7)
...
/* 10EEEC 802A58DC 3C04800E */  lui   $a0, %hi(gScreen4) # $a0, 0x800e
...
/* 10EF18 802A5908 8C84C5F8 */   lw    $a0, %lo(gScreen4)($a0)
...
/* 10EF2C 802A591C 3C04800E */  lui   $a0, %hi(gScreen4) # $a0, 0x800e
/* 10EF30 802A5920 0C0A8E78 */  jal   func_802A39E0
/* 10EF34 802A5924 8C84C5F8 */   lw    $a0, %lo(gScreen4)($a0)
/* 10EF38 802A5928 3C0F800E */  lui   $t7, %hi(gBackgroundFlag) # $t7, 0x800e
/* 10EF3C 802A592C 95EFC5B4 */  lhu   $t7, %lo(gBackgroundFlag)($t7)
...
/* 10EF4C 802A593C 3C05800E */   lui   $a1, %hi(gScreen4) # $a1, 0x800e
...
/* 10EF5C 802A594C 8CA5C5F8 */  lw    $a1, %lo(gScreen4)($a1)
/* 10EF60 802A5950 24060140 */  li    $a2, 320
/* 10EF64 802A5954 0C0A9283 */  jal   DisplayBackground
...
/* 10EF80 802A5970 3C05800E */  lui   $a1, %hi(gScreen4) # $a1, 0x800e
/* 10EF84 802A5974 8CA5C5F8 */  lw    $a1, %lo(gScreen4)($a1)
...
/* 10EF94 802A5984 0C0A921F */  jal   DisplayBackground2
...
glabel DrawFullScreen
/* 10EFB4 802A59A4 27BDFF40 */  addiu $sp, $sp, -0xc0
/* 10EFB8 802A59A8 AFBF0034 */  sw    $ra, 0x34($sp)
/* 10EFBC 802A59AC 0C0A94E9 */  jal   InitialDrawCommon
/* 10EFC0 802A59B0 AFB00030 */   sw    $s0, 0x30($sp)
/* 10EFC4 802A59B4 0C0A8F8F */  jal   InitRDP
/* 10EFC8 802A59B8 00000000 */   nop   
/* 10EFCC 802A59BC 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10EFD0 802A59C0 0C0A8DCC */  jal   func_802A3730
/* 10EFD4 802A59C4 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10EFD8 802A59C8 3C108015 */  lui   $s0, %hi(gGraphPtr) # $s0, 0x8015
/* 10EFDC 802A59CC 26100298 */  addiu $s0, %lo(gGraphPtr) # addiu $s0, $s0, 0x298
...
/* 10F038 802A5A28 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 10F03C 802A5A2C 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 10F040 802A5A30 44814000 */  mtc1  $at, $f8
/* 10F044 802A5A34 3C068015 */  lui   $a2, %hi(D_80150130) # $a2, 0x8015
/* 10F048 802A5A38 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 10F04C 802A5A3C 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 10F088 802A5A78 3C098015 */  lui   $t1, %hi(gDynamicIcp) # $t1, 0x8015
...
/* 10F098 802A5A88 2529EF40 */  addiu $t1, %lo(gDynamicIcp) # addiu $t1, $t1, -0x10c0
...
/* 10F150 802A5B40 3C0F8015 */  lui   $t7, %hi(gDynamicIcp) # $t7, 0x8015
/* 10F154 802A5B44 AC4E0000 */  sw    $t6, ($v0)
/* 10F158 802A5B48 8DEFEF40 */  lw    $t7, %lo(gDynamicIcp)($t7)
...
/* 10F170 802A5B60 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10F174 802A5B64 AC590004 */   sw    $t9, 4($v0)
/* 10F178 802A5B68 27A4005C */  addiu $a0, $sp, 0x5c
/* 10F17C 802A5B6C 0C0AD3FE */  jal   SetMatrix
...
/* 10F1A0 802A5B90 3C0C8015 */  lui   $t4, %hi(gDynamicIcp) # $t4, 0x8015
/* 10F1A4 802A5B94 AC4B0000 */  sw    $t3, ($v0)
/* 10F1A8 802A5B98 8D8CEF40 */  lw    $t4, %lo(gDynamicIcp)($t4)
...
.L802A5BB0:
/* 10F1C0 802A5BB0 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F1C4 802A5BB4 0C0A568E */  jal   DisplayMap
/* 10F1C8 802A5BB8 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
...
/* 10F1F4 802A5BE4 3C0A8015 */  lui   $t2, %hi(gDynamicIcp) # $t2, 0x8015
/* 10F1F8 802A5BE8 AC590000 */  sw    $t9, ($v0)
/* 10F1FC 802A5BEC 8D4AEF40 */  lw    $t2, %lo(gDynamicIcp)($t2)
...
/* 10F214 802A5C04 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10F218 802A5C08 AC4C0004 */   sw    $t4, 4($v0)
/* 10F21C 802A5C0C 27A4005C */  addiu $a0, $sp, 0x5c
/* 10F220 802A5C10 0C0AD3FE */  jal   SetMatrix
/* 10F224 802A5C14 00002825 */   move  $a1, $zero
.L802A5C18:
/* 10F228 802A5C18 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F22C 802A5C1C 0C0A8C02 */  jal   DisplayObject
/* 10F230 802A5C20 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10F234 802A5C24 0C016024 */  jal   KWDisplay3D
/* 10F238 802A5C28 00002025 */   move  $a0, $zero
/* 10F23C 802A5C2C 0C0084AD */  jal   DrawKart
/* 10F240 802A5C30 00000000 */   nop   
/* 10F244 802A5C34 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F248 802A5C38 8C84C5EC */  lw    $a0, %lo(gScreen1)($a0)
/* 10F24C 802A5C3C 0C0A448B */  jal   DisplayMap2
/* 10F250 802A5C40 00002825 */   move  $a1, $zero
/* 10F254 802A5C44 0C0086C3 */  jal   DrawKartAfter
/* 10F258 802A5C48 00000000 */   nop   
/* 10F25C 802A5C4C 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F260 802A5C50 0C0A8BCD */  jal   DisplayObject2
/* 10F264 802A5C54 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10F268 802A5C58 0C01614E */  jal   KWDisplay3DAfter
/* 10F26C 802A5C5C 00002025 */   move  $a0, $zero
/* 10F270 802A5C60 0C0162FD */  jal   KWDisplay2DInit
/* 10F274 802A5C64 00000000 */   nop   
/* 10F278 802A5C68 3C10800E */  lui   $s0, %hi(gTwoDFlag) # $s0, 0x800e
/* 10F27C 802A5C6C 2610C5B8 */  addiu $s0, %lo(gTwoDFlag) # addiu $s0, $s0, -0x3a48
/* 10F280 802A5C70 960D0000 */  lhu   $t5, ($s0)
/* 10F284 802A5C74 11A00003 */  beqz  $t5, .L802A5C84
/* 10F288 802A5C78 00000000 */   nop   
/* 10F28C 802A5C7C 0C016308 */  jal   KWDisplay2D
/* 10F290 802A5C80 00002025 */   move  $a0, $zero
.L802A5C84:
/* 10F294 802A5C84 0C024E97 */  jal   KawanoDraw2
...
/* 10F2A8 802A5C98 0C01636D */  jal   KWdisplay2DAfter
...
/* 10F2D4 802A5CC4 0C0A8F8F */  jal   InitRDP
/* 10F2D8 802A5CC8 00000000 */   nop   
/* 10F2DC 802A5CCC 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F2E0 802A5CD0 0C0A8DCC */  jal   func_802A3730
/* 10F2E4 802A5CD4 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10F2E8 802A5CD8 3C108015 */  lui   $s0, %hi(gGraphPtr) # $s0, 0x8015
/* 10F2EC 802A5CDC 26100298 */  addiu $s0, %lo(gGraphPtr) # addiu $s0, $s0, 0x298
...
/* 10F320 802A5D10 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 10F324 802A5D14 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 10F328 802A5D18 44814000 */  mtc1  $at, $f8
/* 10F32C 802A5D1C 3C068015 */  lui   $a2, %hi(D_80150130) # $a2, 0x8015
/* 10F330 802A5D20 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 10F334 802A5D24 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 10F370 802A5D60 3C098015 */  lui   $t1, %hi(gDynamicIcp) # $t1, 0x8015
...
/* 10F380 802A5D70 2529EF40 */  addiu $t1, %lo(gDynamicIcp) # addiu $t1, $t1, -0x10c0
...
/* 10F438 802A5E28 3C0C8015 */  lui   $t4, %hi(gDynamicIcp) # $t4, 0x8015
/* 10F43C 802A5E2C AC4B0000 */  sw    $t3, ($v0)
/* 10F440 802A5E30 8D8CEF40 */  lw    $t4, %lo(gDynamicIcp)($t4)
...
/* 10F458 802A5E48 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10F45C 802A5E4C AC4E0004 */   sw    $t6, 4($v0)
/* 10F460 802A5E50 27A40058 */  addiu $a0, $sp, 0x58
/* 10F464 802A5E54 0C0AD3FE */  jal   SetMatrix
...
/* 10F488 802A5E78 3C198015 */  lui   $t9, %hi(gDynamicIcp) # $t9, 0x8015
/* 10F48C 802A5E7C AC580000 */  sw    $t8, ($v0)
/* 10F490 802A5E80 8F39EF40 */  lw    $t9, %lo(gDynamicIcp)($t9)
...
.L802A5E98:
/* 10F4A8 802A5E98 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F4AC 802A5E9C 0C0A568E */  jal   DisplayMap
/* 10F4B0 802A5EA0 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
...
/* 10F4DC 802A5ECC 3C0F8015 */  lui   $t7, %hi(gDynamicIcp) # $t7, 0x8015
/* 10F4E0 802A5ED0 AC4E0000 */  sw    $t6, ($v0)
/* 10F4E4 802A5ED4 8DEFEF40 */  lw    $t7, %lo(gDynamicIcp)($t7)
...
/* 10F4FC 802A5EEC 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10F500 802A5EF0 AC590004 */   sw    $t9, 4($v0)
/* 10F504 802A5EF4 27A40058 */  addiu $a0, $sp, 0x58
/* 10F508 802A5EF8 0C0AD3FE */  jal   SetMatrix
/* 10F50C 802A5EFC 00002825 */   move  $a1, $zero
.L802A5F00:
/* 10F510 802A5F00 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F514 802A5F04 0C0A8C02 */  jal   DisplayObject
/* 10F518 802A5F08 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10F51C 802A5F0C 0C016024 */  jal   KWDisplay3D
/* 10F520 802A5F10 24040001 */   li    $a0, 1
/* 10F524 802A5F14 0C0084AD */  jal   DrawKart
/* 10F528 802A5F18 00000000 */   nop   
/* 10F52C 802A5F1C 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F530 802A5F20 8C84C5EC */  lw    $a0, %lo(gScreen1)($a0)
/* 10F534 802A5F24 0C0A448B */  jal   DisplayMap2
/* 10F538 802A5F28 00002825 */   move  $a1, $zero
/* 10F53C 802A5F2C 0C0086C3 */  jal   DrawKartAfter
/* 10F540 802A5F30 00000000 */   nop   
/* 10F544 802A5F34 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F548 802A5F38 0C0A8BCD */  jal   DisplayObject2
/* 10F54C 802A5F3C 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10F550 802A5F40 0C01614E */  jal   KWDisplay3DAfter
/* 10F554 802A5F44 24040001 */   li    $a0, 1
/* 10F558 802A5F48 0C0162FD */  jal   KWDisplay2DInit
/* 10F55C 802A5F4C 00000000 */   nop   
/* 10F560 802A5F50 3C10800E */  lui   $s0, %hi(gTwoDFlag) # $s0, 0x800e
/* 10F564 802A5F54 2610C5B8 */  addiu $s0, %lo(gTwoDFlag) # addiu $s0, $s0, -0x3a48
/* 10F568 802A5F58 960A0000 */  lhu   $t2, ($s0)
/* 10F56C 802A5F5C 11400003 */  beqz  $t2, .L802A5F6C
/* 10F570 802A5F60 00000000 */   nop   
/* 10F574 802A5F64 0C016308 */  jal   KWDisplay2D
/* 10F578 802A5F68 24040001 */   li    $a0, 1
.L802A5F6C:
/* 10F57C 802A5F6C 0C024E97 */  jal   KawanoDraw2
...
/* 10F590 802A5F80 0C01636D */  jal   KWdisplay2DAfter
/* 10F594 802A5F84 24040001 */   li    $a0, 1
.L802A5F88:
/* 10F598 802A5F88 3C028016 */  lui   $v0, %hi(gScreenCounter) # $v0, 0x8016
/* 10F59C 802A5F8C 2442F788 */  addiu $v0, %lo(gScreenCounter) # addiu $v0, $v0, -0x878
...
glabel DrawRightScreen
/* 10F5BC 802A5FAC 27BDFF58 */  addiu $sp, $sp, -0xa8
/* 10F5C0 802A5FB0 AFBF0034 */  sw    $ra, 0x34($sp)
/* 10F5C4 802A5FB4 0C0A9401 */  jal   InitialDrawRight
/* 10F5C8 802A5FB8 AFB00030 */   sw    $s0, 0x30($sp)
/* 10F5CC 802A5FBC 0C0A8F8F */  jal   InitRDP
/* 10F5D0 802A5FC0 00000000 */   nop   
/* 10F5D4 802A5FC4 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10F5D8 802A5FC8 0C0A8DCC */  jal   func_802A3730
/* 10F5DC 802A5FCC 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10F5E0 802A5FD0 3C108015 */  lui   $s0, %hi(gGraphPtr) # $s0, 0x8015
/* 10F5E4 802A5FD4 26100298 */  addiu $s0, %lo(gGraphPtr) # addiu $s0, $s0, 0x298
...
/* 10F618 802A6008 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 10F61C 802A600C 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 10F620 802A6010 44814000 */  mtc1  $at, $f8
/* 10F624 802A6014 3C068015 */  lui   $a2, %hi(D_80150134) # $a2, 0x8015
/* 10F628 802A6018 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 10F62C 802A601C 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 10F668 802A6058 3C098015 */  lui   $t1, %hi(gDynamicIcp) # $t1, 0x8015
...
/* 10F678 802A6068 2529EF40 */  addiu $t1, %lo(gDynamicIcp) # addiu $t1, $t1, -0x10c0
...
/* 10F730 802A6120 3C0C8015 */  lui   $t4, %hi(gDynamicIcp) # $t4, 0x8015
/* 10F734 802A6124 AC4B0000 */  sw    $t3, ($v0)
/* 10F738 802A6128 8D8CEF40 */  lw    $t4, %lo(gDynamicIcp)($t4)
...
/* 10F750 802A6140 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10F754 802A6144 AC4E0004 */   sw    $t6, 4($v0)
/* 10F758 802A6148 27A40058 */  addiu $a0, $sp, 0x58
/* 10F75C 802A614C 0C0AD3FE */  jal   SetMatrix
...
/* 10F780 802A6170 3C198015 */  lui   $t9, %hi(gDynamicIcp) # $t9, 0x8015
/* 10F784 802A6174 AC580000 */  sw    $t8, ($v0)
/* 10F788 802A6178 8F39EF40 */  lw    $t9, %lo(gDynamicIcp)($t9)
...
.L802A6190:
/* 10F7A0 802A6190 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10F7A4 802A6194 0C0A568E */  jal   DisplayMap
/* 10F7A8 802A6198 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
...
/* 10F7D4 802A61C4 3C0F8015 */  lui   $t7, %hi(gDynamicIcp) # $t7, 0x8015
/* 10F7D8 802A61C8 AC4E0000 */  sw    $t6, ($v0)
/* 10F7DC 802A61CC 8DEFEF40 */  lw    $t7, %lo(gDynamicIcp)($t7)
...
/* 10F7F4 802A61E4 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10F7F8 802A61E8 AC590004 */   sw    $t9, 4($v0)
/* 10F7FC 802A61EC 27A40058 */  addiu $a0, $sp, 0x58
/* 10F800 802A61F0 0C0AD3FE */  jal   SetMatrix
/* 10F804 802A61F4 00002825 */   move  $a1, $zero
.L802A61F8:
/* 10F808 802A61F8 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10F80C 802A61FC 0C0A8C02 */  jal   DisplayObject
/* 10F810 802A6200 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10F814 802A6204 0C016024 */  jal   KWDisplay3D
/* 10F818 802A6208 24040002 */   li    $a0, 2
/* 10F81C 802A620C 0C008577 */  jal   DrawKart2P
/* 10F820 802A6210 00000000 */   nop   
/* 10F824 802A6214 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10F828 802A6218 8C84C5F0 */  lw    $a0, %lo(gScreen2)($a0)
/* 10F82C 802A621C 0C0A448B */  jal   DisplayMap2
/* 10F830 802A6220 24050001 */   li    $a1, 1
/* 10F834 802A6224 0C00871E */  jal   DrawKart2PAfter
/* 10F838 802A6228 00000000 */   nop   
/* 10F83C 802A622C 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10F840 802A6230 0C0A8BCD */  jal   DisplayObject2
/* 10F844 802A6234 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10F848 802A6238 0C0162FD */  jal   KWDisplay2DInit
/* 10F84C 802A623C 00000000 */   nop   
/* 10F850 802A6240 0C01614E */  jal   KWDisplay3DAfter
/* 10F854 802A6244 24040002 */   li    $a0, 2
/* 10F858 802A6248 3C10800E */  lui   $s0, %hi(gTwoDFlag) # $s0, 0x800e
/* 10F85C 802A624C 2610C5B8 */  addiu $s0, %lo(gTwoDFlag) # addiu $s0, $s0, -0x3a48
/* 10F860 802A6250 960A0000 */  lhu   $t2, ($s0)
/* 10F864 802A6254 11400003 */  beqz  $t2, .L802A6264
/* 10F868 802A6258 00000000 */   nop   
/* 10F86C 802A625C 0C016308 */  jal   KWDisplay2D
/* 10F870 802A6260 24040002 */   li    $a0, 2
.L802A6264:
/* 10F874 802A6264 0C024E97 */  jal   KawanoDraw2
...
/* 10F888 802A6278 0C01636D */  jal   KWdisplay2DAfter
/* 10F88C 802A627C 24040002 */   li    $a0, 2
.L802A6280:
/* 10F890 802A6280 3C028016 */  lui   $v0, %hi(gScreenCounter) # $v0, 0x8016
/* 10F894 802A6284 2442F788 */  addiu $v0, %lo(gScreenCounter) # addiu $v0, $v0, -0x878
...
/* 10F8C4 802A62B4 3C108015 */  lui   $s0, %hi(gGraphPtr) # $s0, 0x8015
/* 10F8C8 802A62B8 26100298 */  addiu $s0, %lo(gGraphPtr) # addiu $s0, $s0, 0x298
...
/* 10F8E8 802A62D8 0C0A8F8F */  jal   InitRDP
/* 10F8EC 802A62DC AC580004 */   sw    $t8, 4($v0)
/* 10F8F0 802A62E0 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10F8F4 802A62E4 0C0A8DCC */  jal   func_802A3730
/* 10F8F8 802A62E8 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
...
/* 10F92C 802A631C 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 10F930 802A6320 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 10F934 802A6324 44814000 */  mtc1  $at, $f8
/* 10F938 802A6328 3C068015 */  lui   $a2, %hi(D_80150130) # $a2, 0x8015
/* 10F93C 802A632C 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 10F940 802A6330 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 10F97C 802A636C 3C098015 */  lui   $t1, %hi(gDynamicIcp) # $t1, 0x8015
...
/* 10F98C 802A637C 2529EF40 */  addiu $t1, %lo(gDynamicIcp) # addiu $t1, $t1, -0x10c0
...
/* 10FA44 802A6434 3C0F8015 */  lui   $t7, %hi(gDynamicIcp) # $t7, 0x8015
/* 10FA48 802A6438 AC4E0000 */  sw    $t6, ($v0)
/* 10FA4C 802A643C 8DEFEF40 */  lw    $t7, %lo(gDynamicIcp)($t7)
...
/* 10FA64 802A6454 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10FA68 802A6458 AC590004 */   sw    $t9, 4($v0)
/* 10FA6C 802A645C 27A40058 */  addiu $a0, $sp, 0x58
/* 10FA70 802A6460 0C0AD3FE */  jal   SetMatrix
...
/* 10FA94 802A6484 3C0C8015 */  lui   $t4, %hi(gDynamicIcp) # $t4, 0x8015
/* 10FA98 802A6488 AC4B0000 */  sw    $t3, ($v0)
/* 10FA9C 802A648C 8D8CEF40 */  lw    $t4, %lo(gDynamicIcp)($t4)
...
.L802A64A4:
/* 10FAB4 802A64A4 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10FAB8 802A64A8 0C0A568E */  jal   DisplayMap
/* 10FABC 802A64AC 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
...
/* 10FAE8 802A64D8 3C0A8015 */  lui   $t2, %hi(gDynamicIcp) # $t2, 0x8015
/* 10FAEC 802A64DC AC590000 */  sw    $t9, ($v0)
/* 10FAF0 802A64E0 8D4AEF40 */  lw    $t2, %lo(gDynamicIcp)($t2)
...
/* 10FB08 802A64F8 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10FB0C 802A64FC AC4C0004 */   sw    $t4, 4($v0)
/* 10FB10 802A6500 27A40058 */  addiu $a0, $sp, 0x58
/* 10FB14 802A6504 0C0AD3FE */  jal   SetMatrix
/* 10FB18 802A6508 00002825 */   move  $a1, $zero
.L802A650C:
/* 10FB1C 802A650C 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10FB20 802A6510 0C0A8C02 */  jal   DisplayObject
/* 10FB24 802A6514 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10FB28 802A6518 0C016024 */  jal   KWDisplay3D
/* 10FB2C 802A651C 24040003 */   li    $a0, 3
/* 10FB30 802A6520 0C0084AD */  jal   DrawKart
/* 10FB34 802A6524 00000000 */   nop   
/* 10FB38 802A6528 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10FB3C 802A652C 8C84C5EC */  lw    $a0, %lo(gScreen1)($a0)
/* 10FB40 802A6530 0C0A448B */  jal   DisplayMap2
/* 10FB44 802A6534 00002825 */   move  $a1, $zero
/* 10FB48 802A6538 0C0086C3 */  jal   DrawKartAfter
/* 10FB4C 802A653C 00000000 */   nop   
/* 10FB50 802A6540 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10FB54 802A6544 0C0A8BCD */  jal   DisplayObject2
/* 10FB58 802A6548 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10FB5C 802A654C 0C01614E */  jal   KWDisplay3DAfter
/* 10FB60 802A6550 24040003 */   li    $a0, 3
/* 10FB64 802A6554 0C0162FD */  jal   KWDisplay2DInit
/* 10FB68 802A6558 00000000 */   nop   
/* 10FB6C 802A655C 3C10800E */  lui   $s0, %hi(gTwoDFlag) # $s0, 0x800e
/* 10FB70 802A6560 2610C5B8 */  addiu $s0, %lo(gTwoDFlag) # addiu $s0, $s0, -0x3a48
/* 10FB74 802A6564 960D0000 */  lhu   $t5, ($s0)
/* 10FB78 802A6568 11A00003 */  beqz  $t5, .L802A6578
/* 10FB7C 802A656C 00000000 */   nop   
/* 10FB80 802A6570 0C016308 */  jal   KWDisplay2D
/* 10FB84 802A6574 24040003 */   li    $a0, 3
.L802A6578:
/* 10FB88 802A6578 0C024E97 */  jal   KawanoDraw2
...
/* 10FB9C 802A658C 0C01636D */  jal   KWdisplay2DAfter
/* 10FBA0 802A6590 24040003 */   li    $a0, 3
.L802A6594:
/* 10FBA4 802A6594 3C028016 */  lui   $v0, %hi(gScreenCounter) # $v0, 0x8016
/* 10FBA8 802A6598 2442F788 */  addiu $v0, %lo(gScreenCounter) # addiu $v0, $v0, -0x878
...
/* 10FBD8 802A65C8 3C108015 */  lui   $s0, %hi(gGraphPtr) # $s0, 0x8015
/* 10FBDC 802A65CC 26100298 */  addiu $s0, %lo(gGraphPtr) # addiu $s0, $s0, 0x298
...
/* 10FBFC 802A65EC 0C0A8F8F */  jal   InitRDP
/* 10FC00 802A65F0 AC580004 */   sw    $t8, 4($v0)
/* 10FC04 802A65F4 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10FC08 802A65F8 0C0A8DCC */  jal   func_802A3730
/* 10FC0C 802A65FC 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
...
/* 10FC40 802A6630 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 10FC44 802A6634 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 10FC48 802A6638 44814000 */  mtc1  $at, $f8
/* 10FC4C 802A663C 3C068015 */  lui   $a2, %hi(D_80150134) # $a2, 0x8015
/* 10FC50 802A6640 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 10FC54 802A6644 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 10FC90 802A6680 3C098015 */  lui   $t1, %hi(gDynamicIcp) # $t1, 0x8015
...
/* 10FCA0 802A6690 2529EF40 */  addiu $t1, %lo(gDynamicIcp) # addiu $t1, $t1, -0x10c0
...
/* 10FD58 802A6748 3C0F8015 */  lui   $t7, %hi(gDynamicIcp) # $t7, 0x8015
/* 10FD5C 802A674C AC4E0000 */  sw    $t6, ($v0)
/* 10FD60 802A6750 8DEFEF40 */  lw    $t7, %lo(gDynamicIcp)($t7)
...
/* 10FD78 802A6768 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10FD7C 802A676C AC590004 */   sw    $t9, 4($v0)
/* 10FD80 802A6770 27A40058 */  addiu $a0, $sp, 0x58
/* 10FD84 802A6774 0C0AD3FE */  jal   SetMatrix
...
/* 10FDA8 802A6798 3C0C8015 */  lui   $t4, %hi(gDynamicIcp) # $t4, 0x8015
/* 10FDAC 802A679C AC4B0000 */  sw    $t3, ($v0)
/* 10FDB0 802A67A0 8D8CEF40 */  lw    $t4, %lo(gDynamicIcp)($t4)
...
.L802A67B8:
/* 10FDC8 802A67B8 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10FDCC 802A67BC 0C0A568E */  jal   DisplayMap
/* 10FDD0 802A67C0 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
...
/* 10FDFC 802A67EC 3C0A8015 */  lui   $t2, %hi(gDynamicIcp) # $t2, 0x8015
/* 10FE00 802A67F0 AC590000 */  sw    $t9, ($v0)
/* 10FE04 802A67F4 8D4AEF40 */  lw    $t2, %lo(gDynamicIcp)($t2)
...
/* 10FE1C 802A680C 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 10FE20 802A6810 AC4C0004 */   sw    $t4, 4($v0)
/* 10FE24 802A6814 27A40058 */  addiu $a0, $sp, 0x58
/* 10FE28 802A6818 0C0AD3FE */  jal   SetMatrix
/* 10FE2C 802A681C 00002825 */   move  $a1, $zero
.L802A6820:
/* 10FE30 802A6820 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10FE34 802A6824 0C0A8C02 */  jal   DisplayObject
/* 10FE38 802A6828 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10FE3C 802A682C 0C016024 */  jal   KWDisplay3D
/* 10FE40 802A6830 24040004 */   li    $a0, 4
/* 10FE44 802A6834 0C008577 */  jal   DrawKart2P
/* 10FE48 802A6838 00000000 */   nop   
/* 10FE4C 802A683C 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10FE50 802A6840 8C84C5F0 */  lw    $a0, %lo(gScreen2)($a0)
/* 10FE54 802A6844 0C0A448B */  jal   DisplayMap2
/* 10FE58 802A6848 24050001 */   li    $a1, 1
/* 10FE5C 802A684C 0C00871E */  jal   DrawKart2PAfter
/* 10FE60 802A6850 00000000 */   nop   
/* 10FE64 802A6854 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 10FE68 802A6858 0C0A8BCD */  jal   DisplayObject2
/* 10FE6C 802A685C 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 10FE70 802A6860 0C01614E */  jal   KWDisplay3DAfter
/* 10FE74 802A6864 24040004 */   li    $a0, 4
/* 10FE78 802A6868 0C0162FD */  jal   KWDisplay2DInit
/* 10FE7C 802A686C 00000000 */   nop   
/* 10FE80 802A6870 3C10800E */  lui   $s0, %hi(gTwoDFlag) # $s0, 0x800e
/* 10FE84 802A6874 2610C5B8 */  addiu $s0, %lo(gTwoDFlag) # addiu $s0, $s0, -0x3a48
/* 10FE88 802A6878 960D0000 */  lhu   $t5, ($s0)
/* 10FE8C 802A687C 11A00003 */  beqz  $t5, .L802A688C
/* 10FE90 802A6880 00000000 */   nop   
/* 10FE94 802A6884 0C016308 */  jal   KWDisplay2D
/* 10FE98 802A6888 24040004 */   li    $a0, 4
.L802A688C:
/* 10FE9C 802A688C 0C024E97 */  jal   KawanoDraw2
...
/* 10FEB0 802A68A0 0C01636D */  jal   KWdisplay2DAfter
/* 10FEB4 802A68A4 24040004 */   li    $a0, 4
.L802A68A8:
/* 10FEB8 802A68A8 3C028016 */  lui   $v0, %hi(gScreenCounter) # $v0, 0x8016
/* 10FEBC 802A68AC 2442F788 */  addiu $v0, %lo(gScreenCounter) # addiu $v0, $v0, -0x878
...
glabel DrawUpLeftScreen
/* 10FEDC 802A68CC 3C03800E */  lui   $v1, %hi(gCamera1) # $v1, 0x800e
/* 10FEE0 802A68D0 8C63DB40 */  lw    $v1, %lo(gCamera1)($v1)
...
/* 10FEF8 802A68E8 0C0A8F8F */  jal   InitRDP
/* 10FEFC 802A68EC 00000000 */   nop   
/* 10FF00 802A68F0 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 10FF04 802A68F4 0C0A8DCC */  jal   func_802A3730
/* 10FF08 802A68F8 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 10FF0C 802A68FC 3C108015 */  lui   $s0, %hi(gGraphPtr) # $s0, 0x8015
/* 10FF10 802A6900 26100298 */  addiu $s0, %lo(gGraphPtr) # addiu $s0, $s0, 0x298
...
/* 10FF44 802A6934 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 10FF48 802A6938 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 10FF4C 802A693C 44814000 */  mtc1  $at, $f8
/* 10FF50 802A6940 3C068015 */  lui   $a2, %hi(D_80150130) # $a2, 0x8015
/* 10FF54 802A6944 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 10FF58 802A6948 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 10FF98 802A6988 3C0A8015 */  lui   $t2, %hi(gDynamicIcp) # $t2, 0x8015
...
/* 10FFA8 802A6998 254AEF40 */  addiu $t2, %lo(gDynamicIcp) # addiu $t2, $t2, -0x10c0
...
/* 11003C 802A6A2C 3C0E8015 */  lui   $t6, %hi(gDynamicIcp) # $t6, 0x8015
/* 110040 802A6A30 AC4D0000 */  sw    $t5, ($v0)
/* 110044 802A6A34 8DCEEF40 */  lw    $t6, %lo(gDynamicIcp)($t6)
...
/* 11005C 802A6A4C 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 110060 802A6A50 AC580004 */   sw    $t8, 4($v0)
/* 110064 802A6A54 27A40058 */  addiu $a0, $sp, 0x58
/* 110068 802A6A58 0C0AD3FE */  jal   SetMatrix
...
/* 11008C 802A6A7C 3C0C8015 */  lui   $t4, %hi(gDynamicIcp) # $t4, 0x8015
/* 110090 802A6A80 AC4B0000 */  sw    $t3, ($v0)
/* 110094 802A6A84 8D8CEF40 */  lw    $t4, %lo(gDynamicIcp)($t4)
...
.L802A6A9C:
/* 1100AC 802A6A9C 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 1100B0 802A6AA0 0C0A568E */  jal   DisplayMap
/* 1100B4 802A6AA4 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
...
/* 1100E0 802A6AD0 3C0B8015 */  lui   $t3, %hi(gDynamicIcp) # $t3, 0x8015
/* 1100E4 802A6AD4 AC590000 */  sw    $t9, ($v0)
/* 1100E8 802A6AD8 8D6BEF40 */  lw    $t3, %lo(gDynamicIcp)($t3)
...
/* 110100 802A6AF0 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 110104 802A6AF4 AC4D0004 */   sw    $t5, 4($v0)
/* 110108 802A6AF8 27A40058 */  addiu $a0, $sp, 0x58
/* 11010C 802A6AFC 0C0AD3FE */  jal   SetMatrix
/* 110110 802A6B00 00002825 */   move  $a1, $zero
.L802A6B04:
/* 110114 802A6B04 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 110118 802A6B08 0C0A8C02 */  jal   DisplayObject
/* 11011C 802A6B0C 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 110120 802A6B10 0C016024 */  jal   KWDisplay3D
/* 110124 802A6B14 24040008 */   li    $a0, 8
/* 110128 802A6B18 0C0084AD */  jal   DrawKart
/* 11012C 802A6B1C 00000000 */   nop   
/* 110130 802A6B20 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 110134 802A6B24 8C84C5EC */  lw    $a0, %lo(gScreen1)($a0)
/* 110138 802A6B28 0C0A448B */  jal   DisplayMap2
/* 11013C 802A6B2C 00002825 */   move  $a1, $zero
/* 110140 802A6B30 0C0086C3 */  jal   DrawKartAfter
/* 110144 802A6B34 00000000 */   nop   
/* 110148 802A6B38 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 11014C 802A6B3C 0C0A8BCD */  jal   DisplayObject2
/* 110150 802A6B40 8C84C5EC */   lw    $a0, %lo(gScreen1)($a0)
/* 110154 802A6B44 0C01614E */  jal   KWDisplay3DAfter
/* 110158 802A6B48 24040008 */   li    $a0, 8
/* 11015C 802A6B4C 0C0162FD */  jal   KWDisplay2DInit
/* 110160 802A6B50 00000000 */   nop   
/* 110164 802A6B54 3C10800E */  lui   $s0, %hi(gTwoDFlag) # $s0, 0x800e
/* 110168 802A6B58 2610C5B8 */  addiu $s0, %lo(gTwoDFlag) # addiu $s0, $s0, -0x3a48
/* 11016C 802A6B5C 960E0000 */  lhu   $t6, ($s0)
/* 110170 802A6B60 11C00003 */  beqz  $t6, .L802A6B70
/* 110174 802A6B64 00000000 */   nop   
/* 110178 802A6B68 0C016308 */  jal   KWDisplay2D
/* 11017C 802A6B6C 24040008 */   li    $a0, 8
.L802A6B70:
/* 110180 802A6B70 0C024E97 */  jal   KawanoDraw2
...
/* 110194 802A6B84 0C01636D */  jal   KWdisplay2DAfter
/* 110198 802A6B88 24040008 */   li    $a0, 8
.L802A6B8C:
/* 11019C 802A6B8C 3C028016 */  lui   $v0, %hi(gScreenCounter) # $v0, 0x8016
/* 1101A0 802A6B90 2442F788 */  addiu $v0, %lo(gScreenCounter) # addiu $v0, $v0, -0x878
...
glabel DrawUpRightScreen
/* 1101C0 802A6BB0 3C03800E */  lui   $v1, %hi(gCamera2) # $v1, 0x800e
/* 1101C4 802A6BB4 8C63DB44 */  lw    $v1, %lo(gCamera2)($v1)
...
/* 1101DC 802A6BCC 0C0A8F8F */  jal   InitRDP
/* 1101E0 802A6BD0 00000000 */   nop   
/* 1101E4 802A6BD4 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 1101E8 802A6BD8 0C0A8DCC */  jal   func_802A3730
/* 1101EC 802A6BDC 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 1101F0 802A6BE0 3C108015 */  lui   $s0, %hi(gGraphPtr) # $s0, 0x8015
/* 1101F4 802A6BE4 26100298 */  addiu $s0, %lo(gGraphPtr) # addiu $s0, $s0, 0x298
...
/* 110228 802A6C18 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 11022C 802A6C1C 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 110230 802A6C20 44814000 */  mtc1  $at, $f8
/* 110234 802A6C24 3C068015 */  lui   $a2, %hi(D_80150134) # $a2, 0x8015
/* 110238 802A6C28 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 11023C 802A6C2C 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 11027C 802A6C6C 3C0A8015 */  lui   $t2, %hi(gDynamicIcp) # $t2, 0x8015
...
/* 11028C 802A6C7C 254AEF40 */  addiu $t2, %lo(gDynamicIcp) # addiu $t2, $t2, -0x10c0
...
/* 110320 802A6D10 3C0E8015 */  lui   $t6, %hi(gDynamicIcp) # $t6, 0x8015
/* 110324 802A6D14 AC4D0000 */  sw    $t5, ($v0)
/* 110328 802A6D18 8DCEEF40 */  lw    $t6, %lo(gDynamicIcp)($t6)
...
/* 110340 802A6D30 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 110344 802A6D34 AC580004 */   sw    $t8, 4($v0)
/* 110348 802A6D38 27A40058 */  addiu $a0, $sp, 0x58
/* 11034C 802A6D3C 0C0AD3FE */  jal   SetMatrix
...
/* 110370 802A6D60 3C0C8015 */  lui   $t4, %hi(gDynamicIcp) # $t4, 0x8015
/* 110374 802A6D64 AC4B0000 */  sw    $t3, ($v0)
/* 110378 802A6D68 8D8CEF40 */  lw    $t4, %lo(gDynamicIcp)($t4)
...
.L802A6D80:
/* 110390 802A6D80 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 110394 802A6D84 0C0A568E */  jal   DisplayMap
/* 110398 802A6D88 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
...
/* 1103C4 802A6DB4 3C0B8015 */  lui   $t3, %hi(gDynamicIcp) # $t3, 0x8015
/* 1103C8 802A6DB8 AC590000 */  sw    $t9, ($v0)
/* 1103CC 802A6DBC 8D6BEF40 */  lw    $t3, %lo(gDynamicIcp)($t3)
...
/* 1103E4 802A6DD4 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 1103E8 802A6DD8 AC4D0004 */   sw    $t5, 4($v0)
/* 1103EC 802A6DDC 27A40058 */  addiu $a0, $sp, 0x58
/* 1103F0 802A6DE0 0C0AD3FE */  jal   SetMatrix
/* 1103F4 802A6DE4 00002825 */   move  $a1, $zero
.L802A6DE8:
/* 1103F8 802A6DE8 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 1103FC 802A6DEC 0C0A8C02 */  jal   DisplayObject
/* 110400 802A6DF0 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 110404 802A6DF4 0C016024 */  jal   KWDisplay3D
/* 110408 802A6DF8 24040009 */   li    $a0, 9
/* 11040C 802A6DFC 0C008577 */  jal   DrawKart2P
/* 110410 802A6E00 00000000 */   nop   
/* 110414 802A6E04 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 110418 802A6E08 8C84C5F0 */  lw    $a0, %lo(gScreen2)($a0)
/* 11041C 802A6E0C 0C0A448B */  jal   DisplayMap2
/* 110420 802A6E10 24050001 */   li    $a1, 1
/* 110424 802A6E14 0C00871E */  jal   DrawKart2PAfter
/* 110428 802A6E18 00000000 */   nop   
/* 11042C 802A6E1C 3C04800E */  lui   $a0, %hi(gScreen2) # $a0, 0x800e
/* 110430 802A6E20 0C0A8BCD */  jal   DisplayObject2
/* 110434 802A6E24 8C84C5F0 */   lw    $a0, %lo(gScreen2)($a0)
/* 110438 802A6E28 0C01614E */  jal   KWDisplay3DAfter
/* 11043C 802A6E2C 24040009 */   li    $a0, 9
/* 110440 802A6E30 0C0162FD */  jal   KWDisplay2DInit
/* 110444 802A6E34 00000000 */   nop   
/* 110448 802A6E38 3C10800E */  lui   $s0, %hi(gTwoDFlag) # $s0, 0x800e
/* 11044C 802A6E3C 2610C5B8 */  addiu $s0, %lo(gTwoDFlag) # addiu $s0, $s0, -0x3a48
/* 110450 802A6E40 960E0000 */  lhu   $t6, ($s0)
/* 110454 802A6E44 11C00003 */  beqz  $t6, .L802A6E54
/* 110458 802A6E48 00000000 */   nop   
/* 11045C 802A6E4C 0C016308 */  jal   KWDisplay2D
/* 110460 802A6E50 24040009 */   li    $a0, 9
.L802A6E54:
/* 110464 802A6E54 0C024E97 */  jal   KawanoDraw2
...
/* 110478 802A6E68 0C01636D */  jal   KWdisplay2DAfter
/* 11047C 802A6E6C 24040009 */   li    $a0, 9
.L802A6E70:
/* 110480 802A6E70 3C028016 */  lui   $v0, %hi(gScreenCounter) # $v0, 0x8016
/* 110484 802A6E74 2442F788 */  addiu $v0, %lo(gScreenCounter) # addiu $v0, $v0, -0x878
...
glabel DrawDownLeftScreen
/* 1104A4 802A6E94 3C03800E */  lui   $v1, %hi(gCamera3) # $v1, 0x800e
/* 1104A8 802A6E98 8C63DB48 */  lw    $v1, %lo(gCamera3)($v1)
...
/* 1104C0 802A6EB0 0C0A8F8F */  jal   InitRDP
/* 1104C4 802A6EB4 00000000 */   nop   
/* 1104C8 802A6EB8 3C04800E */  lui   $a0, %hi(gScreen3) # $a0, 0x800e
/* 1104CC 802A6EBC 0C0A8DCC */  jal   func_802A3730
/* 1104D0 802A6EC0 8C84C5F4 */   lw    $a0, %lo(gScreen3)($a0)
/* 1104D4 802A6EC4 3C108015 */  lui   $s0, %hi(gGraphPtr) # $s0, 0x8015
/* 1104D8 802A6EC8 26100298 */  addiu $s0, %lo(gGraphPtr) # addiu $s0, $s0, 0x298
...
/* 11050C 802A6EFC 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 110510 802A6F00 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 110514 802A6F04 44814000 */  mtc1  $at, $f8
/* 110518 802A6F08 3C068015 */  lui   $a2, %hi(D_80150138) # $a2, 0x8015
/* 11051C 802A6F0C 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 110520 802A6F10 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 110560 802A6F50 3C0A8015 */  lui   $t2, %hi(gDynamicIcp) # $t2, 0x8015
...
/* 110570 802A6F60 254AEF40 */  addiu $t2, %lo(gDynamicIcp) # addiu $t2, $t2, -0x10c0
...
/* 110604 802A6FF4 3C0E8015 */  lui   $t6, %hi(gDynamicIcp) # $t6, 0x8015
/* 110608 802A6FF8 AC4D0000 */  sw    $t5, ($v0)
/* 11060C 802A6FFC 8DCEEF40 */  lw    $t6, %lo(gDynamicIcp)($t6)
...
/* 110624 802A7014 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 110628 802A7018 AC580004 */   sw    $t8, 4($v0)
/* 11062C 802A701C 27A40058 */  addiu $a0, $sp, 0x58
/* 110630 802A7020 0C0AD3FE */  jal   SetMatrix
...
/* 110654 802A7044 3C0C8015 */  lui   $t4, %hi(gDynamicIcp) # $t4, 0x8015
/* 110658 802A7048 AC4B0000 */  sw    $t3, ($v0)
/* 11065C 802A704C 8D8CEF40 */  lw    $t4, %lo(gDynamicIcp)($t4)
...
.L802A7064:
/* 110674 802A7064 3C04800E */  lui   $a0, %hi(gScreen3) # $a0, 0x800e
/* 110678 802A7068 0C0A568E */  jal   DisplayMap
/* 11067C 802A706C 8C84C5F4 */   lw    $a0, %lo(gScreen3)($a0)
...
/* 1106A8 802A7098 3C0B8015 */  lui   $t3, %hi(gDynamicIcp) # $t3, 0x8015
/* 1106AC 802A709C AC590000 */  sw    $t9, ($v0)
/* 1106B0 802A70A0 8D6BEF40 */  lw    $t3, %lo(gDynamicIcp)($t3)
...
/* 1106C8 802A70B8 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 1106CC 802A70BC AC4D0004 */   sw    $t5, 4($v0)
/* 1106D0 802A70C0 27A40058 */  addiu $a0, $sp, 0x58
/* 1106D4 802A70C4 0C0AD3FE */  jal   SetMatrix
/* 1106D8 802A70C8 00002825 */   move  $a1, $zero
.L802A70CC:
/* 1106DC 802A70CC 3C04800E */  lui   $a0, %hi(gScreen3) # $a0, 0x800e
/* 1106E0 802A70D0 0C0A8C02 */  jal   DisplayObject
/* 1106E4 802A70D4 8C84C5F4 */   lw    $a0, %lo(gScreen3)($a0)
/* 1106E8 802A70D8 0C016024 */  jal   KWDisplay3D
/* 1106EC 802A70DC 2404000A */   li    $a0, 10
/* 1106F0 802A70E0 0C00861B */  jal   DrawKart3P
/* 1106F4 802A70E4 00000000 */   nop   
/* 1106F8 802A70E8 3C04800E */  lui   $a0, %hi(gScreen3) # $a0, 0x800e
/* 1106FC 802A70EC 8C84C5F4 */  lw    $a0, %lo(gScreen3)($a0)
/* 110700 802A70F0 0C0A448B */  jal   DisplayMap2
/* 110704 802A70F4 24050002 */   li    $a1, 2
/* 110708 802A70F8 0C008750 */  jal   DrawKArt3PAfter
/* 11070C 802A70FC 00000000 */   nop   
/* 110710 802A7100 3C04800E */  lui   $a0, %hi(gScreen3) # $a0, 0x800e
/* 110714 802A7104 0C0A8BCD */  jal   DisplayObject2
/* 110718 802A7108 8C84C5F4 */   lw    $a0, %lo(gScreen3)($a0)
/* 11071C 802A710C 0C01614E */  jal   KWDisplay3DAfter
/* 110720 802A7110 2404000A */   li    $a0, 10
/* 110724 802A7114 0C0162FD */  jal   KWDisplay2DInit
/* 110728 802A7118 00000000 */   nop   
/* 11072C 802A711C 3C10800E */  lui   $s0, %hi(gTwoDFlag) # $s0, 0x800e
/* 110730 802A7120 2610C5B8 */  addiu $s0, %lo(gTwoDFlag) # addiu $s0, $s0, -0x3a48
/* 110734 802A7124 960E0000 */  lhu   $t6, ($s0)
/* 110738 802A7128 11C00003 */  beqz  $t6, .L802A7138
/* 11073C 802A712C 00000000 */   nop   
/* 110740 802A7130 0C016308 */  jal   KWDisplay2D
/* 110744 802A7134 2404000A */   li    $a0, 10
.L802A7138:
/* 110748 802A7138 0C024E97 */  jal   KawanoDraw2
...
/* 11075C 802A714C 0C01636D */  jal   KWdisplay2DAfter
/* 110760 802A7150 2404000A */   li    $a0, 10
.L802A7154:
/* 110764 802A7154 3C028016 */  lui   $v0, %hi(gScreenCounter) # $v0, 0x8016
/* 110768 802A7158 2442F788 */  addiu $v0, %lo(gScreenCounter) # addiu $v0, $v0, -0x878
...
glabel DrawDownRightScreen
/* 110788 802A7178 3C03800E */  lui   $v1, %hi(gCamera4) # $v1, 0x800e
/* 11078C 802A717C 8C63DB4C */  lw    $v1, %lo(gCamera4)($v1)
...
/* 1107A0 802A7190 3C0E800E */  lui   $t6, %hi(gPlayerNumber) # $t6, 0x800e
/* 1107A4 802A7194 8DCEC538 */  lw    $t6, %lo(gPlayerNumber)($t6)
...
/* 1107B8 802A71A8 0C024E97 */  jal   KawanoDraw2
/* 1107BC 802A71AC 2404000B */   li    $a0, 11
/* 1107C0 802A71B0 3C0F800E */  lui   $t7, %hi(gTwoDFlag) # $t7, 0x800e
/* 1107C4 802A71B4 95EFC5B8 */  lhu   $t7, %lo(gTwoDFlag)($t7)
/* 1107C8 802A71B8 11E00003 */  beqz  $t7, .L802A71C8
/* 1107CC 802A71BC 00000000 */   nop   
/* 1107D0 802A71C0 0C01636D */  jal   KWdisplay2DAfter
/* 1107D4 802A71C4 2404000B */   li    $a0, 11
.L802A71C8:
/* 1107D8 802A71C8 3C028016 */  lui   $v0, %hi(gScreenCounter) # $v0, 0x8016
/* 1107DC 802A71CC 2442F788 */  addiu $v0, %lo(gScreenCounter) # addiu $v0, $v0, -0x878
...
.L802A71E0:
/* 1107F0 802A71E0 0C0A8F8F */  jal   InitRDP
/* 1107F4 802A71E4 AFA3009C */   sw    $v1, 0x9c($sp)
/* 1107F8 802A71E8 3C04800E */  lui   $a0, %hi(gScreen4) # $a0, 0x800e
/* 1107FC 802A71EC 0C0A8DCC */  jal   func_802A3730
/* 110800 802A71F0 8C84C5F8 */   lw    $a0, %lo(gScreen4)($a0)
/* 110804 802A71F4 3C0A8015 */  lui   $t2, %hi(gGraphPtr) # $t2, 0x8015
/* 110808 802A71F8 254A0298 */  addiu $t2, %lo(gGraphPtr) # addiu $t2, $t2, 0x298
...
/* 11083C 802A722C 3C048015 */  lui   $a0, %hi(gDynamicIcp) # $a0, 0x8015
/* 110840 802A7230 8C84EF40 */  lw    $a0, %lo(gDynamicIcp)($a0)
/* 110844 802A7234 44814000 */  mtc1  $at, $f8
/* 110848 802A7238 3C068015 */  lui   $a2, %hi(D_8015013C) # $a2, 0x8015
/* 11084C 802A723C 3C078015 */  lui   $a3, %hi(gAspectRatio) # $a3, 0x8015
/* 110850 802A7240 8CE70148 */  lw    $a3, %lo(gAspectRatio)($a3)
...
/* 110870 802A7260 3C0A8015 */  lui   $t2, %hi(gGraphPtr) # $t2, 0x8015
/* 110874 802A7264 254A0298 */  addiu $t2, %lo(gGraphPtr) # addiu $t2, $t2, 0x298
...
/* 110898 802A7288 3C0B8015 */  lui   $t3, %hi(gDynamicIcp) # $t3, 0x8015
...
/* 1108A8 802A7298 256BEF40 */  addiu $t3, %lo(gDynamicIcp) # addiu $t3, $t3, -0x10c0
...
/* 110920 802A7310 3C0A8015 */  lui   $t2, %hi(gGraphPtr) # $t2, 0x8015
/* 110924 802A7314 254A0298 */  addiu $t2, %lo(gGraphPtr) # addiu $t2, $t2, 0x298
...
/* 110944 802A7334 3C0E8015 */  lui   $t6, %hi(gDynamicIcp) # $t6, 0x8015
/* 110948 802A7338 AC4D0000 */  sw    $t5, ($v0)
/* 11094C 802A733C 8DCEEF40 */  lw    $t6, %lo(gDynamicIcp)($t6)
...
/* 110964 802A7354 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 110968 802A7358 AC580004 */   sw    $t8, 4($v0)
/* 11096C 802A735C 27A40050 */  addiu $a0, $sp, 0x50
/* 110970 802A7360 0C0AD3FE */  jal   SetMatrix
...
/* 110994 802A7384 3C0D8015 */  lui   $t5, %hi(gDynamicIcp) # $t5, 0x8015
/* 110998 802A7388 AC4C0000 */  sw    $t4, ($v0)
/* 11099C 802A738C 8DADEF40 */  lw    $t5, %lo(gDynamicIcp)($t5)
...
.L802A73A4:
/* 1109B4 802A73A4 3C04800E */  lui   $a0, %hi(gScreen4) # $a0, 0x800e
/* 1109B8 802A73A8 0C0A568E */  jal   DisplayMap
/* 1109BC 802A73AC 8C84C5F8 */   lw    $a0, %lo(gScreen4)($a0)
/* 1109C0 802A73B0 3C18800E */  lui   $t8, %hi(D_800DC5C8) # $t8, 0x800e
/* 1109C4 802A73B4 9718C5C8 */  lhu   $t8, %lo(D_800DC5C8)($t8)
/* 1109C8 802A73B8 3C0A8015 */  lui   $t2, %hi(gGraphPtr) # $t2, 0x8015
/* 1109CC 802A73BC 24010001 */  li    $at, 1
/* 1109D0 802A73C0 17010013 */  bne   $t8, $at, .L802A7410
/* 1109D4 802A73C4 254A0298 */   addiu $t2, %lo(gGraphPtr) # addiu $t2, $t2, 0x298
...
/* 1109EC 802A73DC 3C0D8015 */  lui   $t5, %hi(gDynamicIcp) # $t5, 0x8015
/* 1109F0 802A73E0 AC4C0000 */  sw    $t4, ($v0)
/* 1109F4 802A73E4 8DADEF40 */  lw    $t5, %lo(gDynamicIcp)($t5)
...
/* 110A0C 802A73FC 0C0AD4F2 */  jal   LoadItentAffineMatx
/* 110A10 802A7400 AC4F0004 */   sw    $t7, 4($v0)
/* 110A14 802A7404 27A40050 */  addiu $a0, $sp, 0x50
/* 110A18 802A7408 0C0AD3FE */  jal   SetMatrix
/* 110A1C 802A740C 00002825 */   move  $a1, $zero
.L802A7410:
/* 110A20 802A7410 3C04800E */  lui   $a0, %hi(gScreen4) # $a0, 0x800e
/* 110A24 802A7414 0C0A8C02 */  jal   DisplayObject
/* 110A28 802A7418 8C84C5F8 */   lw    $a0, %lo(gScreen4)($a0)
/* 110A2C 802A741C 0C016024 */  jal   KWDisplay3D
/* 110A30 802A7420 2404000B */   li    $a0, 11
/* 110A34 802A7424 0C00866F */  jal   DrawKart4P
/* 110A38 802A7428 00000000 */   nop   
/* 110A3C 802A742C 3C04800E */  lui   $a0, %hi(gScreen4) # $a0, 0x800e
/* 110A40 802A7430 8C84C5F8 */  lw    $a0, %lo(gScreen4)($a0)
/* 110A44 802A7434 0C0A448B */  jal   DisplayMap2
/* 110A48 802A7438 24050003 */   li    $a1, 3
/* 110A4C 802A743C 0C00876A */  jal   DrawKart4PAfter
/* 110A50 802A7440 00000000 */   nop   
/* 110A54 802A7444 3C04800E */  lui   $a0, %hi(gScreen4) # $a0, 0x800e
/* 110A58 802A7448 0C0A8BCD */  jal   DisplayObject2
/* 110A5C 802A744C 8C84C5F8 */   lw    $a0, %lo(gScreen4)($a0)
/* 110A60 802A7450 0C01614E */  jal   KWDisplay3DAfter
/* 110A64 802A7454 2404000B */   li    $a0, 11
/* 110A68 802A7458 0C0162FD */  jal   KWDisplay2DInit
/* 110A6C 802A745C 00000000 */   nop   
/* 110A70 802A7460 3C18800E */  lui   $t8, %hi(gTwoDFlag) # $t8, 0x800e
/* 110A74 802A7464 9718C5B8 */  lhu   $t8, %lo(gTwoDFlag)($t8)
/* 110A78 802A7468 13000003 */  beqz  $t8, .L802A7478
/* 110A7C 802A746C 00000000 */   nop   
/* 110A80 802A7470 0C016308 */  jal   KWDisplay2D
/* 110A84 802A7474 2404000B */   li    $a0, 11
.L802A7478:
/* 110A88 802A7478 0C024E97 */  jal   KawanoDraw2
/* 110A8C 802A747C 2404000B */   li    $a0, 11
/* 110A90 802A7480 3C19800E */  lui   $t9, %hi(gTwoDFlag) # $t9, 0x800e
/* 110A94 802A7484 9739C5B8 */  lhu   $t9, %lo(gTwoDFlag)($t9)
/* 110A98 802A7488 13200003 */  beqz  $t9, .L802A7498
/* 110A9C 802A748C 00000000 */   nop   
/* 110AA0 802A7490 0C01636D */  jal   KWdisplay2DAfter
/* 110AA4 802A7494 2404000B */   li    $a0, 11
.L802A7498:
/* 110AA8 802A7498 3C028016 */  lui   $v0, %hi(gScreenCounter) # $v0, 0x8016
/* 110AAC 802A749C 2442F788 */  addiu $v0, %lo(gScreenCounter) # addiu $v0, $v0, -0x878
...
InitialScreenDataglabel InitialScreenData
...
/* 110AE8 802A74D8 3C028016 */  lui   $v0, %hi(gScreenData) # $v0, 0x8016
/* 110AEC 802A74DC 3C03800F */  lui   $v1, %hi(gKartData) # $v1, 0x800f
/* 110AF0 802A74E0 3C048016 */  lui   $a0, %hi(D_801646F0) # $a0, 0x8016
/* 110AF4 802A74E4 3C058016 */  lui   $a1, %hi(D_8015F790) # $a1, 0x8016
/* 110AF8 802A74E8 3C0B800E */  lui   $t3, %hi(gScreenMode) # $t3, 0x800e
/* 110AFC 802A74EC 3C08800F */  lui   $t0, %hi(gPlayer1Controller) # $t0, 0x800f
/* 110B00 802A74F0 2442F480 */  addiu $v0, %lo(gScreenData) # addiu $v0, $v0, -0xb80
/* 110B04 802A74F4 24636990 */  addiu $v1, %lo(gKartData) # addiu $v1, $v1, 0x6990
...
/* 110B14 802A7504 256BC52C */  addiu $t3, %lo(gScreenMode) # addiu $t3, $t3, -0x3ad4
...
glabel TakeSnapshot15
/* 110D38 802A7728 27BDFFC8 */  addiu $sp, $sp, -0x38
/* 110D3C 802A772C 3C0E800E */  lui   $t6, %hi(gScreenMode) # $t6, 0x800e
/* 110D40 802A7730 8DCEC52C */  lw    $t6, %lo(gScreenMode)($t6)
...
/* 110D90 802A7780 3C02800E */  lui   $v0, %hi(gDispFrame) # $v0, 0x800e
/* 110D94 802A7784 8442C55C */  lh    $v0, %lo(gDispFrame)($v0)
...
.L802A77BC:
/* 110DCC 802A77BC 3C098015 */  lui   $t1, %hi(gCfbPtrs) # $t1, 0x8015
/* 110DD0 802A77C0 252902A8 */  addiu $t1, %lo(gCfbPtrs) # addiu $t1, $t1, 0x2a8
...
/* 110E08 802A77F8 0C0A9D96 */  jal   GetFramebuffer
...
/* 110E40 802A7830 0C0A9D96 */  jal   GetFramebuffer
...
/* 110E78 802A7868 0C0A9D96 */  jal   GetFramebuffer
...
/* 110EB4 802A78A4 0C0A9D96 */  jal   GetFramebuffer
...
/* 110EEC 802A78DC 0C0A9D96 */  jal   GetFramebuffer
...
/* 110F28 802A7918 0C0A9D96 */  jal   GetFramebuffer
...
glabel TakeSnapshot9
/* 110F50 802A7940 27BDFFC8 */  addiu $sp, $sp, -0x38
/* 110F54 802A7944 3C0E800E */  lui   $t6, %hi(gScreenMode) # $t6, 0x800e
/* 110F58 802A7948 8DCEC52C */  lw    $t6, %lo(gScreenMode)($t6)
...
/* 110FA8 802A7998 3C02800E */  lui   $v0, %hi(gDispFrame) # $v0, 0x800e
/* 110FAC 802A799C 8442C55C */  lh    $v0, %lo(gDispFrame)($v0)
...
.L802A79D4:
/* 110FE4 802A79D4 3C098015 */  lui   $t1, %hi(gCfbPtrs) # $t1, 0x8015
/* 110FE8 802A79D8 252902A8 */  addiu $t1, %lo(gCfbPtrs) # addiu $t1, $t1, 0x2a8
...
/* 111020 802A7A10 0C0A9D96 */  jal   GetFramebuffer
...
/* 11105C 802A7A4C 0C0A9D96 */  jal   GetFramebuffer
...
/* 111098 802A7A88 0C0A9D96 */  jal   GetFramebuffer
...
/* 1110D8 802A7AC8 0C0A9D96 */  jal   GetFramebuffer
...
/* 111114 802A7B04 0C0A9D96 */  jal   GetFramebuffer
...
/* 111154 802A7B44 0C0A9D96 */  jal   GetFramebuffer
