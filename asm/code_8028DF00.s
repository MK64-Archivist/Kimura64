...
# matched variables and function names to Drive.c
...
glabel SaveKeyStatus
/* 0F7510 8028DF00 3C0E800F */  lui   $t6, %hi(gController) # $t6, 0x800f
/* 0F7514 8028DF04 95CE6914 */  lhu   $t6, %lo(gController)($t6)
...
/* 0F7524 8028DF14 A42EA040 */  sh    $t6, %lo(gSaveStatus)($at)
...
glabel LoadKeyStatus
/* 0F7548 8028DF38 3C04800F */  lui   $a0, %hi(gController) # $a0, 0x800f
/* 0F754C 8028DF3C 3C0E802C */  lui   $t6, %hi(gSaveStatus) # $t6, 0x802c
/* 0F7550 8028DF40 85CEA040 */  lh    $t6, %lo(gSaveStatus)($t6)
/* 0F7554 8028DF44 94846914 */  lhu   $a0, %lo(gController)($a0)
...
/* 0F757C 8028DF6C 3C01800F */  lui   $at, %hi(gController) # $at, 0x800f
...
/* 0F7588 8028DF78 A42E6914 */  sh    $t6, %lo(gController)($at)
...
glabel BattleEnd
/* 0F7638 8028E028 3C02800E */  lui   $v0, %hi(gPlayerNumber) # $v0, 0x800e
/* 0F763C 8028E02C 8C42C538 */  lw    $v0, %lo(gPlayerNumber)($v0)
...
/* 0F7658 8028E048 3C088016 */   lui   $t0, %hi(gBattleWinCount3P) # $t0, 0x8016
/* 0F765C 8028E04C 24010004 */  li    $at, 4
/* 0F7660 8028E050 10410014 */  beq   $v0, $at, .L8028E0A4
/* 0F7664 8028E054 3C0C8016 */   lui   $t4, %hi(gBattleWinCount4P) # $t4, 0x8016
/* 0F7668 8028E058 10000019 */  b     .L8028E0C0
/* 0F766C 8028E05C 00000000 */   nop
.L8028E060:
/* 0F7670 8028E060 3C0E8016 */  lui   $t6, %hi(gBattleWinCount2P) # $t6, 0x8016
/* 0F7674 8028E064 3C0F800E */  lui   $t7, %hi(gWinKart) # $t7, 0x800e
/* 0F7678 8028E068 8DEFC5E8 */  lw    $t7, %lo(gWinKart)($t7)
/* 0F767C 8028E06C 8DCEF8C4 */  lw    $t6, %lo(gBattleWinCount2P)($t6)
...
.L8028E084:
/* 0F7694 8028E084 3C09800E */  lui   $t1, %hi(gWinKart) # $t1, 0x800e
/* 0F7698 8028E088 8D29C5E8 */  lw    $t1, %lo(gWinKart)($t1)
/* 0F769C 8028E08C 8D08F8C8 */  lw    $t0, %lo(gBattleWinCount3P)($t0)
...
.L8028E0A4:
/* 0F76B4 8028E0A4 3C0D800E */  lui   $t5, %hi(gWinKart) # $t5, 0x800e
/* 0F76B8 8028E0A8 8DADC5E8 */  lw    $t5, %lo(gWinKart)($t5)
/* 0F76BC 8028E0AC 8D8CF8CC */  lw    $t4, %lo(gBattleWinCount4P)($t4)
...
/* 0F76D4 8028E0C4 0C032846 */  jal   NaSeMuteGoal
/* 0F76D8 8028E0C8 9084C5EB */   lbu   $a0, %lo(D_800DC5EB)($a0)
/* 0F76DC 8028E0CC 8FBF0014 */  lw    $ra, 0x14($sp)
/* 0F76E0 8028E0D0 24180005 */  li    $t8, 5
/* 0F76E4 8028E0D4 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F76E8 8028E0D8 AC38C510 */  sw    $t8, %lo(gRaceControlMode)($at)
/* 0F76EC 8028E0DC 3C01802C */  lui   $at, %hi(gFinishCount) # $at, 0x802c
/* 0F76F0 8028E0E0 2419000A */  li    $t9, 10
/* 0F76F4 8028E0E4 AC39A038 */  sw    $t9, %lo(gFinishCount)($at)
/* 0F76F8 8028E0E8 03E00008 */  jr    $ra
/* 0F76FC 8028E0EC 27BD0018 */   addiu $sp, $sp, 0x18

glabel CheckBattleStatus
...
/* 0F7728 8028E118 3C10800F */  lui   $s0, %hi(gKartData) # $s0, 0x800f
/* 0F772C 8028E11C 3C14800E */  lui   $s4, %hi(gKart1) # $s4, 0x800e
/* 0F7730 8028E120 3C178019 */  lui   $s7, %hi(gBalloonNumber) # $s7, 0x8019
/* 0F7734 8028E124 AFBF003C */  sw    $ra, 0x3c($sp)
/* 0F7738 8028E128 00009825 */  move  $s3, $zero
/* 0F773C 8028E12C 00009025 */  move  $s2, $zero
/* 0F7740 8028E130 26F7D8C0 */  addiu $s7, %lo(gBalloonNumber) # addiu $s7, $s7, -0x2740
/* 0F7744 8028E134 2694C4DC */  addiu $s4, %lo(gKart1) # addiu $s4, $s4, -0x3b24
/* 0F7748 8028E138 26106990 */  addiu $s0, %lo(gKartData) # addiu $s0, $s0, 0x6990
...
/* 0F77E0 8028E1D0 0C032846 */  jal   NaSeMuteGoal
...
/* 0F7850 8028E240 3C01800E */  lui   $at, %hi(gWinKart) # $at, 0x800e
/* 0F7854 8028E244 0C0A380A */  jal   BattleEnd
/* 0F7858 8028E248 AC2EC5E8 */   sw    $t6, %lo(gWinKart)($at)
...
/* 0F786C 8028E25C 3C01800E */  lui   $at, %hi(gWinKart) # $at, 0x800e
/* 0F7870 8028E260 0C0A380A */  jal   BattleEnd
/* 0F7874 8028E264 AC2FC5E8 */   sw    $t7, %lo(gWinKart)($at)
.L8028E268:
...
/* 0F78B8 8028E2A8 3C05800F */  lui   $a1, %hi(gKartData) # $a1, 0x800f
/* 0F78BC 8028E2AC 3C0D800E */  lui   $t5, %hi(gRaceTimer) # $t5, 0x800e
/* 0F78C0 8028E2B0 3C0C8016 */  lui   $t4, %hi(gGoalInTime) # $t4, 0x8016
/* 0F78C4 8028E2B4 3C0B8016 */  lui   $t3, %hi(gRateCountF) # $t3, 0x8016
/* 0F78C8 8028E2B8 3C098016 */  lui   $t1, %hi(gCenterLineMaxBP) # $t1, 0x8016
/* 0F78CC 8028E2BC 3C088016 */  lui   $t0, %hi(gOGABPLine) # $t0, 0x8016
/* 0F78D0 8028E2C0 44811000 */  mtc1  $at, $f2
/* 0F78D4 8028E2C4 AFBF0014 */  sw    $ra, 0x14($sp)
/* 0F78D8 8028E2C8 250845B0 */  addiu $t0, %lo(gOGABPLine) # addiu $t0, $t0, 0x45b0
/* 0F78DC 8028E2CC 252945C8 */  addiu $t1, %lo(gCenterLineMaxBP) # addiu $t1, $t1, 0x45c8
/* 0F78E0 8028E2D0 256B44A8 */  addiu $t3, %lo(gRateCountF) # addiu $t3, $t3, 0x44a8
/* 0F78E4 8028E2D4 258CF898 */  addiu $t4, %lo(gGoalInTime) # addiu $t4, $t4, -0x768
/* 0F78E8 8028E2D8 25ADC598 */  addiu $t5, %lo(gRaceTimer) # addiu $t5, $t5, -0x3a68
/* 0F78EC 8028E2DC 24A56990 */  addiu $a1, %lo(gKartData) # addiu $a1, $a1, 0x6990
...
/* 0F7994 8028E384 3C018016 */  lui   $at, %hi(OGAGoalKakuteiFLG) # $at, 0x8016
/* 0F7998 8028E388 0C001C3D */  jal   SortGoalRank
/* 0F799C 8028E38C A439348C */   sh    $t9, %lo(OGAGoalKakuteiFLG)($at)
...
glabel CheckFinishRace
/* 0F79B0 8028E3A0 3C0E8015 */  lui   $t6, %hi(gRaceClearFlag) # $t6, 0x8015
/* 0F79B4 8028E3A4 8DCE0120 */  lw    $t6, %lo(gRaceClearFlag)($t6)
/* 0F79B8 8028E3A8 3C038019 */  lui   $v1, %hi(gCircuitSelect) # $v1, 0x8019
/* 0F79BC 8028E3AC 2463EE0B */  addiu $v1, %lo(gCircuitSelect) # addiu $v1, $v1, -0x11f5
/* 0F79C0 8028E3B0 11C00015 */  beqz  $t6, .L8028E408
/* 0F79C4 8028E3B4 3C04800E */   lui   $a0, 0x800e
/* 0F79C8 8028E3B8 3C038019 */  lui   $v1, %hi(gCircuitSelect) # $v1, 0x8019
/* 0F79CC 8028E3BC 2463EE0B */  addiu $v1, %lo(gCircuitSelect) # addiu $v1, $v1, -0x11f5
/* 0F79D0 8028E3C0 80620000 */  lb    $v0, ($v1)
/* 0F79D4 8028E3C4 24010003 */  li    $at, 3
/* 0F79D8 8028E3C8 3C04800E */  lui   $a0, %hi(gCupNumber) # $a0, 0x800e
/* 0F79DC 8028E3CC 14410005 */  bne   $v0, $at, .L8028E3E4
/* 0F79E0 8028E3D0 2484C544 */   addiu $a0, %lo(gCupNumber) # addiu $a0, $a0, -0x3abc
...
/* 0F7A38 8028E428 3C018015 */  lui   $at, %hi(gNextSequenceMode) # $at, 0x8015
/* 0F7A3C 8028E42C AC2E0124 */  sw    $t6, %lo(gNextSequenceMode)($at)
/* 0F7A40 8028E430 03E00008 */  jr    $ra
/* 0F7A44 8028E434 00000000 */   nop

glabel FinishVSZoom
/* 0F7A48 8028E438 24040001 */  li    $a0, 1
/* 0F7A4C 8028E43C 3C078016 */  lui   $a3, %hi(gFinishZoomFlag) # $a3, 0x8016
/* 0F7A50 8028E440 3C0E800E */  lui   $t6, %hi(gWinKart) # $t6, 0x800e
/* 0F7A54 8028E444 3C01800E */  lui   $at, %hi(gClearCFBFlag) # $at, 0x800e
/* 0F7A58 8028E448 8DCEC5E8 */  lw    $t6, %lo(gWinKart)($t6)
/* 0F7A5C 8028E44C 24E7F894 */  addiu $a3, %lo(gFinishZoomFlag) # addiu $a3, $a3, -0x76c
/* 0F7A60 8028E450 A424C5B0 */  sh    $a0, %lo(gClearCFBFlag)($at)
/* 0F7A64 8028E454 94E30000 */  lhu   $v1, ($a3)
/* 0F7A68 8028E458 3C188016 */  lui   $t8, %hi(gScreenData) # $t8, 0x8016
/* 0F7A6C 8028E45C 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 0F7A70 8028E460 2718F480 */  addiu $t8, %lo(gScreenData) # addiu $t8, $t8, -0xb80
...
.L8028E490:
/* 0F7AA0 8028E490 3C01800E */  lui   $at, %hi(gTwoDFlag) # $at, 0x800e
/* 0F7AA4 8028E494 A420C5B8 */  sh    $zero, %lo(gTwoDFlag)($at)
/* 0F7AA8 8028E498 A4E40000 */  sh    $a0, ($a3)
/* 0F7AAC 8028E49C 3C19800E */  lui   $t9, %hi(gPlayerNumber) # $t9, 0x800e
/* 0F7AB0 8028E4A0 8F39C538 */  lw    $t9, %lo(gPlayerNumber)($t9)
/* 0F7AB4 8028E4A4 24010003 */  li    $at, 3
/* 0F7AB8 8028E4A8 57210070 */  bnel  $t9, $at, .L8028E66C
/* 0F7ABC 8028E4AC 8FBF0014 */   lw    $ra, 0x14($sp)
/* 0F7AC0 8028E4B0 0C024973 */  jal   EraseInfo3P
...
/* 0F7BBC 8028E5AC 3C018015 */  lui   $at, %hi(gAspectRatio) # $at, 0x8015
/* 0F7BC0 8028E5B0 468042A0 */  cvt.s.w $f10, $f8
/* 0F7BC4 8028E5B4 460A3403 */  div.s $f16, $f6, $f10
/* 0F7BC8 8028E5B8 E4300148 */  swc1  $f16, %lo(gAspectRatio)($at)
...
/* 0F7BDC 8028E5CC 3C01800E */  lui   $at, %hi(gScreenMode) # $at, 0x800e
/* 0F7BE0 8028E5D0 3C03800E */  lui   $v1, %hi(gScreen1) # $v1, 0x800e
/* 0F7BE4 8028E5D4 AC20C52C */  sw    $zero, %lo(gScreenMode)($at)
/* 0F7BE8 8028E5D8 2463C5EC */  addiu $v1, %lo(gScreen1) # addiu $v1, $v1, -0x3a14
/* 0F7BEC 8028E5DC 8C6A0000 */  lw    $t2, ($v1)
/* 0F7BF0 8028E5E0 8449002C */  lh    $t1, 0x2c($v0)
/* 0F7BF4 8028E5E4 3C04800E */  lui   $a0, %hi(gGameMode) # $a0, 0x800e
...
/* 0F7C24 8028E614 8C84C53C */  lw    $a0, %lo(gGameMode)($a0)
/* 0F7C28 8028E618 54810006 */  bnel  $a0, $at, .L8028E634
/* 0F7C2C 8028E61C 24010002 */   li    $at, 2
/* 0F7C30 8028E620 0C024981 */  jal   DispVSResult
...
/* 0F7C4C 8028E63C 0C024981 */  jal   DispVSResult
/* 0F7C50 8028E640 00000000 */   nop
/* 0F7C54 8028E644 0C00677D */  jal   OGAVSWinnerCameraInit
/* 0F7C58 8028E648 00000000 */   nop
/* 0F7C5C 8028E64C 10000007 */  b     .L8028E66C
/* 0F7C60 8028E650 8FBF0014 */   lw    $ra, 0x14($sp)
.L8028E654:
/* 0F7C64 8028E654 0C024959 */  jal   DispGPLose
/* 0F7C68 8028E658 00000000 */   nop
/* 0F7C6C 8028E65C 24190007 */  li    $t9, 7
/* 0F7C70 8028E660 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F7C74 8028E664 AC39C510 */  sw    $t9, %lo(gRaceControlMode)($at)
...
/* 0F7C8C 8028E67C 3C078016 */  lui   $a3, %hi(gFinishZoomFlag) # $a3, 0x8016
/* 0F7C90 8028E680 3C01800E */  lui   $at, %hi(gClearCFBFlag) # $at, 0x800e
/* 0F7C94 8028E684 24E7F894 */  addiu $a3, %lo(gFinishZoomFlag) # addiu $a3, $a3, -0x76c
/* 0F7C98 8028E688 A423C5B0 */  sh    $v1, %lo(gClearCFBFlag)($at)
...
/* 0F7CB8 8028E6A8 3C01802C */  lui   $at, %hi(JTBL_FINISHZOOM)
/* 0F7CBC 8028E6AC 002E0821 */  addu  $at, $at, $t6
/* 0F7CC0 8028E6B0 8C2E91E0 */  lw    $t6, %lo(JTBL_FINISHZOOM)($at)
/* 0F7CC4 8028E6B4 01C00008 */  jr    $t6
/* 0F7CC8 8028E6B8 00000000 */   nop
glabel L8028E6BC
/* 0F7CCC 8028E6BC 3C02800E */  lui   $v0, %hi(gGameMode) # $v0, 0x800e
/* 0F7CD0 8028E6C0 8C42C53C */  lw    $v0, %lo(gGameMode)($v0)
/* 0F7CD4 8028E6C4 10400000 */  beqz  $v0, .L8028E6C8
.L8028E6C8:
/* 0F7CD8 8028E6C8 3C02800E */   lui   $v0, %hi(gRaceScreenMode) # $v0, 0x800e
/* 0F7CDC 8028E6CC 8C42C530 */  lw    $v0, %lo(gRaceScreenMode)($v0)
/* 0F7CE0 8028E6D0 3C01800E */  lui   $at, %hi(gTwoDFlag) # $at, 0x800e
/* 0F7CE4 8028E6D4 A420C5B8 */  sh    $zero, %lo(gTwoDFlag)($at)
...
glabel L8028E714
/* 0F7D24 8028E714 3C05800E */  lui   $a1, %hi(gScreen1) # $a1, 0x800e
/* 0F7D28 8028E718 24A5C5EC */  addiu $a1, %lo(gScreen1) # addiu $a1, $a1, -0x3a14
/* 0F7D2C 8028E71C 8CA20000 */  lw    $v0, ($a1)
/* 0F7D30 8028E720 3C06800E */  lui   $a2, %hi(gScreen2) # $a2, 0x800e
/* 0F7D34 8028E724 24C6C5F0 */  addiu $a2, %lo(gScreen2) # addiu $a2, $a2, -0x3a10
...
.L8028E7E8:
/* 0F7DF8 8028E7E8 3C018015 */  lui   $at, %hi(gAspectRatio) # $at, 0x8015
...
/* 0F7E18 8028E808 E4300148 */  swc1  $f16, %lo(gAspectRatio)($at)
/* 0F7E1C 8028E80C 24010004 */  li    $at, 4
/* 0F7E20 8028E810 54810106 */  bnel  $a0, $at, .L8028EC2C
/* 0F7E24 8028E814 8FBF0014 */   lw    $ra, 0x14($sp)
/* 0F7E28 8028E818 0C024940 */  jal   DispResultTime
/* 0F7E2C 8028E81C A4F80000 */   sh    $t8, ($a3)
/* 0F7E30 8028E820 0C006779 */  jal   OgaDriversPointCameraInit
/* 0F7E34 8028E824 00000000 */   nop
/* 0F7E38 8028E828 0C010749 */  jal   KWSwitchDemo2PGP
/* 0F7E3C 8028E82C 00000000 */   nop
/* 0F7E40 8028E830 100000FE */  b     .L8028EC2C
/* 0F7E44 8028E834 8FBF0014 */   lw    $ra, 0x14($sp)
glabel L8028E838
/* 0F7E48 8028E838 3C05800E */  lui   $a1, %hi(gScreen1) # $a1, 0x800e
/* 0F7E4C 8028E83C 24A5C5EC */  addiu $a1, %lo(gScreen1) # addiu $a1, $a1, -0x3a14
/* 0F7E50 8028E840 8CA20000 */  lw    $v0, ($a1)
/* 0F7E54 8028E844 3C06800E */  lui   $a2, %hi(gScreen2) # $a2, 0x800e
/* 0F7E58 8028E848 24C6C5F0 */  addiu $a2, %lo(gScreen2) # addiu $a2, $a2, -0x3a10
...
.L8028E910:
/* 0F7F20 8028E910 3C018015 */  lui   $at, %hi(gAspectRatio) # $at, 0x8015
...
/* 0F7F40 8028E930 E42A0148 */  swc1  $f10, %lo(gAspectRatio)($at)
/* 0F7F44 8028E934 24010004 */  li    $at, 4
/* 0F7F48 8028E938 548100BC */  bnel  $a0, $at, .L8028EC2C
/* 0F7F4C 8028E93C 8FBF0014 */   lw    $ra, 0x14($sp)
/* 0F7F50 8028E940 0C024940 */  jal   DispResultTime
/* 0F7F54 8028E944 A4F90000 */   sh    $t9, ($a3)
/* 0F7F58 8028E948 0C006779 */  jal   OgaDriversPointCameraInit
/* 0F7F5C 8028E94C 00000000 */   nop
/* 0F7F60 8028E950 100000B6 */  b     .L8028EC2C
/* 0F7F64 8028E954 8FBF0014 */   lw    $ra, 0x14($sp)
glabel L8028E958
/* 0F7F68 8028E958 3C05800E */  lui   $a1, %hi(gScreen1) # $a1, 0x800e
/* 0F7F6C 8028E95C 24A5C5EC */  addiu $a1, %lo(gScreen1) # addiu $a1, $a1, -0x3a14
...
/* 0F7FF0 8028E9E0 3C06800E */  lui   $a2, %hi(gScreen2) # $a2, 0x800e
/* 0F7FF4 8028E9E4 240A0002 */  li    $t2, 2
/* 0F7FF8 8028E9E8 8458002E */  lh    $t8, 0x2e($v0)
/* 0F7FFC 8028E9EC 24C6C5F0 */  addiu $a2, %lo(gScreen2) # addiu $a2, $a2, -0x3a10
...
/* 0F805C 8028EA4C 3C01800E */  lui   $at, %hi(gScreenMode) # $at, 0x800e
...
/* 0F8090 8028EA80 AC2EC52C */  sw    $t6, %lo(gScreenMode)($at)
/* 0F8094 8028EA84 3C01802C */  lui   $at, %hi(D_802B9200) # $at, 0x802c
/* 0F8098 8028EA88 C4309200 */  lwc1  $f16, %lo(D_802B9200)($at)
/* 0F809C 8028EA8C 3C018015 */  lui   $at, %hi(gAspectRatio) # $at, 0x8015
/* 0F80A0 8028EA90 E4300148 */  swc1  $f16, %lo(gAspectRatio)($at)
/* 0F80A4 8028EA94 3C01800E */  lui   $at, %hi(gPlayerNumber) # $at, 0x800e
/* 0F80A8 8028EA98 0C00F6D7 */  jal   InitResultKart
/* 0F80AC 8028EA9C AC2FC538 */   sw    $t7, %lo(gPlayerNumber)($at)
/* 0F80B0 8028EAA0 0C016653 */  jal   KWResultScreenStart
/* 0F80B4 8028EAA4 00000000 */   nop
/* 0F80B8 8028EAA8 10000060 */  b     .L8028EC2C
/* 0F80BC 8028EAAC 8FBF0014 */   lw    $ra, 0x14($sp)
glabel L8028EAB0
/* 0F80C0 8028EAB0 3C05800E */  lui   $a1, %hi(gScreen1) # $a1, 0x800e
/* 0F80C4 8028EAB4 24A5C5EC */  addiu $a1, %lo(gScreen1) # addiu $a1, $a1, -0x3a14
/* 0F80C8 8028EAB8 8CA20000 */  lw    $v0, ($a1)
/* 0F80CC 8028EABC 3C06800E */  lui   $a2, %hi(gScreen2) # $a2, 0x800e
/* 0F80D0 8028EAC0 240C0050 */  li    $t4, 80
/* 0F80D4 8028EAC4 84580030 */  lh    $t8, 0x30($v0)
/* 0F80D8 8028EAC8 240E003C */  li    $t6, 60
/* 0F80DC 8028EACC 24C6C5F0 */  addiu $a2, %lo(gScreen2) # addiu $a2, $a2, -0x3a10
...
/* 0F8114 8028EB04 3C02800E */  lui   $v0, %hi(gScreen1) # $v0, 0x800e
/* 0F8118 8028EB08 8C42C5EC */  lw    $v0, %lo(gScreen1)($v0)
...
/* 0F8140 8028EB30 3C02802C */  lui   $v0, %hi(gKawanoWait) # $v0, 0x802c
/* 0F8144 8028EB34 2442A030 */  addiu $v0, %lo(gKawanoWait) # addiu $v0, $v0, -0x5fd0
...
/* 0F8180 8028EB70 3C03800E */  lui   $v1, %hi(gScreen2) # $v1, 0x800e
/* 0F8184 8028EB74 8C63C5F0 */  lw    $v1, %lo(gScreen2)($v1)
...
glabel L8028EBAC
/* 0F81BC 8028EBAC 3C02802C */  lui   $v0, %hi(gKawanoWait) # $v0, 0x802c
/* 0F81C0 8028EBB0 2442A030 */  addiu $v0, %lo(gKawanoWait) # addiu $v0, $v0, -0x5fd0
...
/* 0F81DC 8028EBCC 0C024940 */  jal   DispResultTime
/* 0F81E0 8028EBD0 A4E90000 */   sh    $t1, ($a3)
/* 0F81E4 8028EBD4 3C0A800E */  lui   $t2, %hi(gGameMode) # $t2, 0x800e
/* 0F81E8 8028EBD8 8D4AC53C */  lw    $t2, %lo(gGameMode)($t2)
/* 0F81EC 8028EBDC 15400005 */  bnez  $t2, .L8028EBF4
/* 0F81F0 8028EBE0 00000000 */   nop
/* 0F81F4 8028EBE4 0C006779 */  jal   OgaDriversPointCameraInit
/* 0F81F8 8028EBE8 00000000 */   nop
/* 0F81FC 8028EBEC 1000000F */  b     .L8028EC2C
/* 0F8200 8028EBF0 8FBF0014 */   lw    $ra, 0x14($sp)
.L8028EBF4:
/* 0F8204 8028EBF4 0C006796 */  jal   OGATimeattackCameraInit
/* 0F8208 8028EBF8 00000000 */   nop
/* 0F820C 8028EBFC 1000000B */  b     .L8028EC2C
/* 0F8210 8028EC00 8FBF0014 */   lw    $ra, 0x14($sp)
glabel L8028EC04
/* 0F8214 8028EC04 3C01800E */  lui   $at, %hi(gFadeoutFlag) # $at, 0x800e
/* 0F8218 8028EC08 A423C5C0 */  sh    $v1, %lo(gFadeoutFlag)($at)
/* 0F821C 8028EC0C 3C01800E */  lui   $at, %hi(gFadeoutCount) # $at, 0x800e
/* 0F8220 8028EC10 240B0005 */  li    $t3, 5
/* 0F8224 8028EC14 A42BC5C4 */  sh    $t3, %lo(gFadeoutCount)($at)
/* 0F8228 8028EC18 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F822C 8028EC1C 240C0007 */  li    $t4, 7
/* 0F8230 8028EC20 0C0A38E8 */  jal   CheckFinishRace
/* 0F8234 8028EC24 AC2CC510 */   sw    $t4, %lo(gRaceControlMode)($at)
.L8028EC28:
glabel L8028EC28
...
glabel CallNextSequence
/* 0F8248 8028EC38 3C018015 */  lui   $at, %hi(gNextSequenceMode) # $at, 0x8015
/* 0F824C 8028EC3C 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 0F8250 8028EC40 AC240124 */  sw    $a0, %lo(gNextSequenceMode)($at)
/* 0F8254 8028EC44 AFBF0014 */  sw    $ra, 0x14($sp)
/* 0F8258 8028EC48 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F825C 8028EC4C 240E0006 */  li    $t6, 6
/* 0F8260 8028EC50 AC2EC510 */  sw    $t6, %lo(gRaceControlMode)($at)
/* 0F8264 8028EC54 0C0328CC */  jal   NaSeqFadeout
/* 0F8268 8028EC58 24040019 */   li    $a0, 25
/* 0F826C 8028EC5C 0C0328E2 */  jal   NaSEFadeout
/* 0F8270 8028EC60 24040019 */   li    $a0, 25
/* 0F8274 8028EC64 24020001 */  li    $v0, 1
/* 0F8278 8028EC68 3C01800E */  lui   $at, %hi(gBackgroundFlag) # $at, 0x800e
/* 0F827C 8028EC6C A422C5B4 */  sh    $v0, %lo(gBackgroundFlag)($at)
/* 0F8280 8028EC70 3C01800E */  lui   $at, %hi(gClearCFBFlag) # $at, 0x800e
/* 0F8284 8028EC74 A422C5B0 */  sh    $v0, %lo(gClearCFBFlag)($at)
/* 0F8288 8028EC78 8FBF0014 */  lw    $ra, 0x14($sp)
/* 0F828C 8028EC7C 3C01800E */  lui   $at, %hi(gTwoDFlag) # $at, 0x800e
/* 0F8290 8028EC80 A420C5B8 */  sh    $zero, %lo(gTwoDFlag)($at)
/* 0F8294 8028EC84 3C01802C */  lui   $at, %hi(gFinishCount) # $at, 0x802c
/* 0F8298 8028EC88 240F0005 */  li    $t7, 5
/* 0F829C 8028EC8C AC2FA038 */  sw    $t7, %lo(gFinishCount)($at)
/* 0F82A0 8028EC90 03E00008 */  jr    $ra
/* 0F82A4 8028EC94 27BD0018 */   addiu $sp, $sp, 0x18

glabel StartRaceBGM
/* 0F82A8 8028EC98 3C0E800E */  lui   $t6, %hi(gRaceScreenMode) # $t6, 0x800e
/* 0F82AC 8028EC9C 8DCEC530 */  lw    $t6, %lo(gRaceScreenMode)($t6)
...
/* 0F82C4 8028ECB4 0C000A6C */  jal   SetMusicVolume
...
glabel StartRacing
/* 0F83B8 8028EDA8 3C0F800E */  lui   $t7, %hi(gDemoFlag) # $t7, 0x800e
/* 0F83BC 8028EDAC 95EFC51C */  lhu   $t7, %lo(gDemoFlag)($t7)
/* 0F83C0 8028EDB0 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 0F83C4 8028EDB4 340EFFFF */  li    $t6, 65535
/* 0F83C8 8028EDB8 3C018015 */  lui   $at, %hi(gTimeFlag) # $at, 0x8015
/* 0F83CC 8028EDBC AFBF0014 */  sw    $ra, 0x14($sp)
/* 0F83D0 8028EDC0 15E00004 */  bnez  $t7, .L8028EDD4
/* 0F83D4 8028EDC4 A42E011E */   sh    $t6, %lo(gTimeFlag)($at)
/* 0F83D8 8028EDC8 3C04800E */  lui   $a0, %hi(gMapNumber) # $a0, 0x800e
/* 0F83DC 8028EDCC 0C0A3B26 */  jal   StartRaceBGM
/* 0F83E0 8028EDD0 8484C5A0 */   lh    $a0, %lo(gMapNumber)($a0)
.L8028EDD4:
/* 0F83E4 8028EDD4 3C02800E */  lui   $v0, %hi(gRaceControlMode) # $v0, 0x800e
/* 0F83E8 8028EDD8 2442C510 */  addiu $v0, %lo(gRaceControlMode) # addiu $v0, $v0, -0x3af0
/* 0F83EC 8028EDDC 8C580000 */  lw    $t8, ($v0)
/* 0F83F0 8028EDE0 24010002 */  li    $at, 2
/* 0F83F4 8028EDE4 3C03800F */  lui   $v1, %hi(gKartData) # $v1, 0x800f
/* 0F83F8 8028EDE8 17010003 */  bne   $t8, $at, .L8028EDF8
/* 0F83FC 8028EDEC 24636990 */   addiu $v1, %lo(gKartData) # addiu $v1, $v1, 0x6990
...
/* 0F84B4 8028EEA4 3C0F800F */  lui   $t7, %hi(gKartData) # $t7, 0x800f
/* 0F84B8 8028EEA8 25EF6990 */  addiu $t7, %lo(gKartData) # addiu $t7, $t7, 0x6990
...
/* 0F84E0 8028EED0 3C01800E */  lui   $at, %hi(gRaceTimer) # $at, 0x800e
/* 0F84E4 8028EED4 46106481 */  sub.s $f18, $f12, $f16
/* 0F84E8 8028EED8 460E2182 */  mul.s $f6, $f4, $f14
/* 0F84EC 8028EEDC C424C598 */  lwc1  $f4, %lo(gRaceTimer)($at)
...
/* 0F8518 8028EF08 3C0F800F */  lui   $t7, %hi(gKartData) # $t7, 0x800f
/* 0F851C 8028EF0C 25EF6990 */  addiu $t7, %lo(gKartData) # addiu $t7, $t7, 0x6990
...
glabel CheckKartLap //Also called CheckKartRap
...
/* 0F855C 8028EF4C 3C10800F */  lui   $s0, %hi(gKartData) # $s0, 0x800f
/* 0F8560 8028EF50 3C16802C */  lui   $s6, %hi(gSoundSetFlag) # $s6, 0x802c
/* 0F8564 8028EF54 3C17800E */  lui   $s7, %hi(gRaceControlMode) # $s7, 0x800e
/* 0F8568 8028EF58 AFBF003C */  sw    $ra, 0x3c($sp)
/* 0F856C 8028EF5C AFB1001C */  sw    $s1, 0x1c($sp)
/* 0F8570 8028EF60 26F7C510 */  addiu $s7, %lo(gRaceControlMode) # addiu $s7, $s7, -0x3af0
/* 0F8574 8028EF64 26D6A032 */  addiu $s6, %lo(gSoundSetFlag) # addiu $s6, $s6, -0x5fce
/* 0F8578 8028EF68 26106990 */  addiu $s0, %lo(gKartData) # addiu $s0, $s0, 0x6990
...
/* 0F85E8 8028EFD8 0C0A3BBC */  jal   GoalInSubroutine
...
/* 0F8608 8028EFF8 3C018015 */  lui   $at, %hi(gRaceClearFlag) # $at, 0x8015
/* 0F860C 8028EFFC AC350120 */  sw    $s5, %lo(gRaceClearFlag)($at)
.L8028F000:
/* 0F8610 8028F000 0C032846 */  jal   NaSeMuteGoal
/* 0F8614 8028F004 324400FF */   andi  $a0, $s2, 0xff
/* 0F8618 8028F008 96C20000 */  lhu   $v0, ($s6)
/* 0F861C 8028F00C 3C0D800E */  lui   $t5, %hi(gPlayerNumber) # $t5, 0x800e
...
.L8028F024:
/* 0F8634 8028F024 3C02800E */  lui   $v0, %hi(gGameMode) # $v0, 0x800e
/* 0F8638 8028F028 8C42C53C */  lw    $v0, %lo(gGameMode)($v0)
/* 0F863C 8028F02C 5440000C */  bnel  $v0, $zero, .L8028F060
/* 0F8640 8028F030 96180000 */   lhu   $t8, ($s0)
/* 0F8644 8028F034 8DADC538 */  lw    $t5, %lo(gPlayerNumber)($t5)
/* 0F8648 8028F038 3C0E802C */  lui   $t6, %hi(D_802BA048) # $t6, 0x802c
/* 0F864C 8028F03C 566D0008 */  bnel  $s3, $t5, .L8028F060 //Check on 2 player
...
/* 0F8688 8028F078 0C0016BA */  jal   KillGhost
/* 0F868C 8028F07C 02002025 */   move  $a0, $s0
/* 0F8690 8028F080 3C02800E */  lui   $v0, %hi(gGameMode) # $v0, 0x800e
/* 0F8694 8028F084 8C42C53C */  lw    $v0, %lo(gGameMode)($v0)
.L8028F088:
/* 0F8698 8028F088 166200BD */  bne   $s3, $v0, .L8028F380
/* 0F869C 8028F08C 240900B4 */   li    $t1, 180
/* 0F86A0 8028F090 3C01802C */  lui   $at, %hi(gFinishCount) # $at, 0x802c
/* 0F86A4 8028F094 3C03800E */  lui   $v1, %hi(gPlayerNumber) # $v1, 0x800e
/* 0F86A8 8028F098 AC29A038 */  sw    $t1, %lo(gFinishCount)($at)
/* 0F86AC 8028F09C 16200003 */  bnez  $s1, .L8028F0AC
/* 0F86B0 8028F0A0 8C63C538 */   lw    $v1, %lo(gPlayerNumber)($v1)
/* 0F86B4 8028F0A4 3C01800E */  lui   $at, %hi(gWinKart) # $at, 0x800e
/* 0F86B8 8028F0A8 AC32C5E8 */  sw    $s2, %lo(gWinKart)($at)
.L8028F0AC:
...
/* 0F86E4 8028F0D4 3C0D8016 */   lui   $t5, %hi(gWinCount2p) # $t5, 0x8016
/* 0F86E8 8028F0D8 3C0A8016 */  lui   $t2, %hi(gWinCount2p) # $t2, 0x8016
/* 0F86EC 8028F0DC 8D4AF8B8 */  lw    $t2, %lo(gWinCount2p)($t2)
...
.L8028F0F0:
/* 0F8700 8028F0F0 8DADF8B8 */  lw    $t5, %lo(gWinCount2p)($t5)
/* 0F8704 8028F0F4 240F0005 */  li    $t7, 5
/* 0F8708 8028F0F8 3C19800F */  lui   $t9, %hi(gKartData) # $t9, 0x800f
...
/* 0F8730 8028F120 27396990 */  addiu $t9, %lo(gKartData) # addiu $t9, $t9, 0x6990
...
/* 0F8770 8028F160 0C032846 */  jal   NaSeMuteGoal
...
/* 0F878C 8028F17C 3C0C8016 */  lui   $t4, %hi(gWinCount3p) # $t4, 0x8016
/* 0F8790 8028F180 8D8CF8BC */  lw    $t4, %lo(gWinCount3p)($t4)
...
.L8028F198:
/* 0F87A8 8028F198 3C188016 */  lui   $t8, %hi(gWinCount3p) # $t8, 0x8016
/* 0F87AC 8028F19C 8F18F8BC */  lw    $t8, %lo(gWinCount3p)($t8)
...
/* 0F87C0 8028F1B0 3C18800F */  lui   $t8, %hi(gKartData) # $t8, 0x800f
/* 0F87C4 8028F1B4 27186990 */  addiu $t8, %lo(gKartData) # addiu $t8, $t8, 0x6990
...
/* 0F87EC 8028F1DC 3C0A8016 */  lui   $t2, %hi(gWinCount3p) # $t2, 0x8016
/* 0F87F0 8028F1E0 8D4AF8BC */  lw    $t2, %lo(gWinCount3p)($t2)
/* 0F87F4 8028F1E4 02540019 */  multu $s2, $s4
/* 0F87F8 8028F1E8 3C0D8016 */  lui   $t5, %hi(gWinCount3p) # $t5, 0x8016
...
/* 0F8834 8028F224 8DADF8BC */  lw    $t5, %lo(gWinCount3p)($t5)
...
/* 0F8868 8028F258 0C032846 */  jal   NaSeMuteGoal
...
/* 0F8884 8028F274 3C0B8016 */  lui   $t3, %hi(gWincount4p) # $t3, 0x8016
/* 0F8888 8028F278 8D6BF8C0 */  lw    $t3, %lo(gWincount4p)($t3)
...
.L8028F290:
/* 0F88A0 8028F290 3C0F8016 */  lui   $t7, %hi(gWincount4p) # $t7, 0x8016
/* 0F88A4 8028F294 8DEFF8C0 */  lw    $t7, %lo(gWincount4p)($t7)
/* 0F88A8 8028F298 24080005 */  li    $t0, 5
/* 0F88AC 8028F29C 3C0A800F */  lui   $t2, %hi(gKartData) # $t2, 0x800f
...
/* 0F88E0 8028F2D0 254A6990 */  addiu $t2, %lo(gKartData) # addiu $t2, $t2, 0x6990
...
/* 0F8920 8028F310 0C032846 */  jal   NaSeMuteGoal
...
/* 0F8970 8028F360 0C0A3BBC */  jal   GoalInSubroutine
/* 0F8974 8028F364 02402025 */   move  $a0, $s2
/* 0F8978 8028F368 3C09800E */  lui   $t1, %hi(gGameMode) # $t1, 0x800e
/* 0F897C 8028F36C 8D29C53C */  lw    $t1, %lo(gGameMode)($t1)
/* 0F8980 8028F370 56A90004 */  bnel  $s5, $t1, .L8028F384
/* 0F8984 8028F374 26520001 */   addiu $s2, $s2, 1
/* 0F8988 8028F378 0C0016BA */  jal   KillGhost
...
glabel CheckKartRank
/* 0F8A00 8028F3F0 3C088016 */  lui   $t0, %hi(RankBuffer) # $t0, 0x8016
/* 0F8A04 8028F3F4 3C078016 */  lui   $a3, %hi(OgawaRank) # $a3, 0x8016
/* 0F8A08 8028F3F8 3C05800F */  lui   $a1, %hi(gKartData) # $a1, 0x800f
/* 0F8A0C 8028F3FC 24A56990 */  addiu $a1, %lo(gKartData) # addiu $a1, $a1, 0x6990
/* 0F8A10 8028F400 24E743B8 */  addiu $a3, %lo(OgawaRank) # addiu $a3, $a3, 0x43b8
/* 0F8A14 8028F404 2508F8F0 */  addiu $t0, %lo(RankBuffer) # addiu $t0, $t0, -0x710
...
glabel EnemyControl
/* 0F8A84 8028F474 3C0E800E */  lui   $t6, %hi(gRaceControlMode) # $t6, 0x800e
/* 0F8A88 8028F478 8DCEC510 */  lw    $t6, %lo(gRaceControlMode)($t6)
...
/* 0F8AAC 8028F49C 3C01802C */  lui   $at, %hi(JTBL_ENEMYCONTROL)
/* 0F8AB0 8028F4A0 002F0821 */  addu  $at, $at, $t7
/* 0F8AB4 8028F4A4 8C2F9258 */  lw    $t7, %lo(JTBL_ENEMYCONTROL)($at)
...
.L8028F4B8:
/* 0F8AC8 8028F4B8 0C0026D8 */  jal   DriveEnemyKart
...
glabel L8028F4CC
/* 0F8ADC 8028F4CC 0C0025F8 */  jal   EtcEnemyDrive
...
glabel RaceResetCheck
/* 0F8AF8 8028F4E8 3C0E800E */  lui   $t6, %hi(gDebugFlag) # $t6, 0x800e
/* 0F8AFC 8028F4EC 95CEC520 */  lhu   $t6, %lo(gDebugFlag)($t6)
...
/* 0F8B0C 8028F4FC 3C0F800E */   lui   $t7, %hi(gContOR) # $t7, 0x800e
/* 0F8B10 8028F500 8DEFC4CC */  lw    $t7, %lo(gContOR)($t7)
...
/* 0F8B3C 8028F52C 0C0328CC */  jal   NaSeqFadeout
/* 0F8B40 8028F530 24040019 */   li    $a0, 25
/* 0F8B44 8028F534 0C0328E2 */  jal   NaSEFadeout
/* 0F8B48 8028F538 24040019 */   li    $a0, 25
/* 0F8B4C 8028F53C 3C018015 */  lui   $at, %hi(gNextSequenceMode) # $at, 0x8015
/* 0F8B50 8028F540 AC200124 */  sw    $zero, %lo(gNextSequenceMode)($at)
/* 0F8B54 8028F544 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F8B58 8028F548 240A0006 */  li    $t2, 6
/* 0F8B5C 8028F54C AC2AC510 */  sw    $t2, %lo(gRaceControlMode)($at)
/* 0F8B60 8028F550 24020001 */  li    $v0, 1
/* 0F8B64 8028F554 3C01800E */  lui   $at, %hi(gBackgroundFlag) # $at, 0x800e
/* 0F8B68 8028F558 A422C5B4 */  sh    $v0, %lo(gBackgroundFlag)($at)
/* 0F8B6C 8028F55C 3C01800E */  lui   $at, %hi(gClearCFBFlag) # $at, 0x800e
/* 0F8B70 8028F560 A422C5B0 */  sh    $v0, %lo(gClearCFBFlag)($at)
/* 0F8B74 8028F564 3C01800E */  lui   $at, %hi(gTwoDFlag) # $at, 0x800e
/* 0F8B78 8028F568 A420C5B8 */  sh    $zero, %lo(gTwoDFlag)($at)
/* 0F8B7C 8028F56C 3C01802C */  lui   $at, %hi(gFinishCount) # $at, 0x802c
/* 0F8B80 8028F570 240B0005 */  li    $t3, 5
/* 0F8B84 8028F574 AC2BA038 */  sw    $t3, %lo(gFinishCount)($at)
.L8028F578:
...
glabel SetVPScale
/* 0F8B98 8028F588 3C02800E */  lui   $v0, %hi(gScreenMode) # $v0, 0x800e
/* 0F8B9C 8028F58C 8C42C52C */  lw    $v0, %lo(gScreenMode)($v0)
/* 0F8BA0 8028F590 3C03802C */  lui   $v1, %hi(gScreenZoom) # $v1, 0x802c
/* 0F8BA4 8028F594 2463A034 */  addiu $v1, %lo(gScreenZoom) # addiu $v1, $v1, -0x5fcc
...
/* 0F8BDC 8028F5CC 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 0F8BE0 8028F5D0 2484C5EC */  addiu $a0, %lo(gScreen1) # addiu $a0, $a0, -0x3a14
...
.L8028F63C:
/* 0F8C4C 8028F63C 3C03802C */  lui   $v1, %hi(gScreenZoom) # $v1, 0x802c
/* 0F8C50 8028F640 2463A034 */  addiu $v1, %lo(gScreenZoom) # addiu $v1, $v1, -0x5fcc
...
/* 0F8C60 8028F650 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 0F8C64 8028F654 2484C5EC */  addiu $a0, %lo(gScreen1) # addiu $a0, $a0, -0x3a14
...
.L8028F694:
/* 0F8CA4 8028F694 3C05800E */  lui   $a1, %hi(gScreen2) # $a1, 0x800e
/* 0F8CA8 8028F698 24A5C5F0 */  addiu $a1, %lo(gScreen2) # addiu $a1, $a1, -0x3a10
...
.L8028F700:
/* 0F8D10 8028F700 3C03802C */  lui   $v1, %hi(gScreenZoom) # $v1, 0x802c
/* 0F8D14 8028F704 2463A034 */  addiu $v1, %lo(gScreenZoom) # addiu $v1, $v1, -0x5fcc
...
/* 0F8D24 8028F714 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 0F8D28 8028F718 2484C5EC */  addiu $a0, %lo(gScreen1) # addiu $a0, $a0, -0x3a14
...
.L8028F758:
/* 0F8D68 8028F758 3C05800E */  lui   $a1, %hi(gScreen2) # $a1, 0x800e
/* 0F8D6C 8028F75C 24A5C5F0 */  addiu $a1, %lo(gScreen2) # addiu $a1, $a1, -0x3a10
...
.L8028F7C4:
/* 0F8DD4 8028F7C4 3C03802C */  lui   $v1, %hi(gScreenZoom) # $v1, 0x802c
/* 0F8DD8 8028F7C8 2463A034 */  addiu $v1, %lo(gScreenZoom) # addiu $v1, $v1, -0x5fcc
...
/* 0F8DE8 8028F7D8 3C04800E */  lui   $a0, %hi(gScreen1) # $a0, 0x800e
/* 0F8DEC 8028F7DC 2484C5EC */  addiu $a0, %lo(gScreen1) # addiu $a0, $a0, -0x3a14
...
.L8028F81C:
/* 0F8E2C 8028F81C 3C05800E */  lui   $a1, %hi(gScreen2) # $a1, 0x800e
/* 0F8E30 8028F820 24A5C5F0 */  addiu $a1, %lo(gScreen2) # addiu $a1, $a1, -0x3a10
/* 0F8E34 8028F824 A5E2002C */  sh    $v0, 0x2c($t7)
/* 0F8E38 8028F828 8CB80000 */  lw    $t8, ($a1)
/* 0F8E3C 8028F82C 3C06800E */  lui   $a2, %hi(gScreen3) # $a2, 0x800e
/* 0F8E40 8028F830 24C6C5F4 */  addiu $a2, %lo(gScreen3) # addiu $a2, $a2, -0x3a0c
/* 0F8E44 8028F834 A702002C */  sh    $v0, 0x2c($t8)
/* 0F8E48 8028F838 8CD90000 */  lw    $t9, ($a2)
/* 0F8E4C 8028F83C 3C07800E */  lui   $a3, %hi(gScreen4) # $a3, 0x800e
/* 0F8E50 8028F840 24E7C5F8 */  addiu $a3, %lo(gScreen4) # addiu $a3, $a3, -0x3a08
...
glabel ZoomOutScreen
/* 0F8ECC 8028F8BC 3C02802C */  lui   $v0, %hi(gScreenZoom) # $v0, 0x802c
/* 0F8ED0 8028F8C0 2442A034 */  addiu $v0, %lo(gScreenZoom) # addiu $v0, $v0, -0x5fcc
...
.L8028F8FC:
/* 0F8F0C 8028F8FC 0C0A3D62 */  jal   SetVPScale
...
/* 0F8F2C 8028F91C 3C02802C */  lui   $v0, %hi(gScreenZoom) # $v0, 0x802c
/* 0F8F30 8028F920 2442A034 */  addiu $v0, %lo(gScreenZoom) # addiu $v0, $v0, -0x5fcc
...
.L8028F958:
/* 0F8F68 8028F958 0C0A3D62 */  jal   SetVPScale
...
/* 0F8F84 8028F974 3C0E8016 */  lui   $t6, %hi(gReplayFlag) # $t6, 0x8016
/* 0F8F88 8028F978 95CEF890 */  lhu   $t6, %lo(gReplayFlag)($t6)
...
/* 0F8FA4 8028F994 3C13800F */  lui   $s3, %hi(gKartData) # $s3, 0x800f
/* 0F8FA8 8028F998 3C11800E */  lui   $s1, %hi(gVolumeToggle) # $s1, 0x800e
/* 0F8FAC 8028F99C 2631C5A8 */  addiu $s1, %lo(gVolumeToggle) # addiu $s1, $s1, -0x3a58
/* 0F8FB0 8028F9A0 26736990 */  addiu $s3, %lo(gKartData) # addiu $s3, $s3, 0x6990
...
/* 0F8FD0 8028F9C0 3C09800E */  lui   $t1, %hi(gScreenMode) # $t1, 0x800e
/* 0F8FD4 8028F9C4 8D29C52C */  lw    $t1, %lo(gScreenMode)($t1)
...
.L8028FA24:
/* 0F9034 8028FA24 0C032384 */  jal   NaSystemStart
/* 0F9038 8028FA28 3484801C */   ori   $a0, (0x4900801C & 0xFFFF) # ori $a0, $a0, 0x801c
/* 0F903C 8028FA2C 0C000A6C */  jal   SetMusicVolume
...
/* 0F906C 8028FA5C 0C0A37C0 */  jal   SaveKeyStatus
/* 0F9070 8028FA60 00000000 */   nop
/* 0F9074 8028FA64 3C0B800E */  lui   $t3, %hi(gCont1P) # $t3, 0x800e
/* 0F9078 8028FA68 8D6BC4BC */  lw    $t3, %lo(gCont1P)($t3)
/* 0F907C 8028FA6C 3C01800E */  lui   $at, %hi(gPauseFlag) # $at, 0x800e
...
/* 0F9090 8028FA80 A42EC5FC */  sh    $t6, %lo(gPauseFlag)($at)
/* 0F9094 8028FA84 0C0327E4 */  jal   NAPauseSet
/* 0F9098 8028FA88 A6000006 */   sh    $zero, 6($s0)
/* 0F909C 8028FA8C 3C0F800E */  lui   $t7, %hi(gGameMode) # $t7, 0x800e
/* 0F90A0 8028FA90 8DEFC53C */  lw    $t7, %lo(gGameMode)($t7)
/* 0F90A4 8028FA94 24020001 */  li    $v0, 1
/* 0F90A8 8028FA98 3C018016 */  lui   $at, %hi(gGhostWrite) # $at, 0x8016
/* 0F90AC 8028FA9C 144F0046 */  bne   $v0, $t7, .L8028FBB8
/* 0F90B0 8028FAA0 AC222DF0 */   sw    $v0, %lo(gGhostWrite)($at)
/* 0F90B4 8028FAA4 3C04800E */  lui   $a0, %hi(gKart1) # $a0, 0x800e
/* 0F90B8 8028FAA8 8C84C4DC */  lw    $a0, %lo(gKart1)($a0)
...
/* 0F90CC 8028FABC 0C0016BA */  jal   KillGhost
/* 0F90D0 8028FAC0 00000000 */   nop
.L8028FAC4:
/* 0F90D4 8028FAC4 3C04800E */  lui   $a0, %hi(gKart2) # $a0, 0x800e
/* 0F90D8 8028FAC8 8C84C4E0 */  lw    $a0, %lo(gKart2)($a0)
...
/* 0F90EC 8028FADC 0C0016BA */  jal   KillGhost
/* 0F90F0 8028FAE0 00000000 */   nop
.L8028FAE4:
/* 0F90F4 8028FAE4 3C04800E */  lui   $a0, %hi(gKart3) # $a0, 0x800e
/* 0F90F8 8028FAE8 8C84C4E4 */  lw    $a0, %lo(gKart3)($a0)
...
/* 0F910C 8028FAFC 0C0016BA */  jal   KillGhost
...
/* 0F912C 8028FB1C 3C0C800E */  lui   $t4, %hi(gDebugFlag) # $t4, 0x800e
/* 0F9130 8028FB20 958CC520 */  lhu   $t4, %lo(gDebugFlag)($t4)
/* 0F9134 8028FB24 3C0D800E */  lui   $t5, %hi(gGameMode) # $t5, 0x800e
/* 0F9138 8028FB28 51800024 */  beql  $t4, $zero, .L8028FBBC
/* 0F913C 8028FB2C 8FBF0024 */   lw    $ra, 0x24($sp)
/* 0F9140 8028FB30 8DADC53C */  lw    $t5, %lo(gGameMode)($t5)
/* 0F9144 8028FB34 24010003 */  li    $at, 3
/* 0F9148 8028FB38 3C05800E */  lui   $a1, %hi(gCont1P) # $a1, 0x800e
/* 0F914C 8028FB3C 51A1001F */  beql  $t5, $at, .L8028FBBC
/* 0F9150 8028FB40 8FBF0024 */   lw    $ra, 0x24($sp)
/* 0F9154 8028FB44 8CA5C4BC */  lw    $a1, %lo(gCont1P)($a1)
/* 0F9158 8028FB48 3C028016 */  lui   $v0, %hi(gOgawaLap) # $v0, 0x8016
/* 0F915C 8028FB4C 24424390 */  addiu $v0, %lo(gOgawaLap) # addiu $v0, $v0, 0x4390
...
.L8028FB6C:
/* 0F917C 8028FB6C 3C028016 */  lui   $v0, %hi(gOgawaLap) # $v0, 0x8016
/* 0F9180 8028FB70 308F0100 */  andi  $t7, $a0, 0x100
/* 0F9184 8028FB74 24424390 */  addiu $v0, %lo(gOgawaLap) # addiu $v0, $v0, 0x4390
...
glabel StartFadeout
/* 0F91E4 8028FBD4 3C018015 */  lui   $at, %hi(gNextSequenceMode) # $at, 0x8015
/* 0F91E8 8028FBD8 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 0F91EC 8028FBDC AC200124 */  sw    $zero, %lo(gNextSequenceMode)($at)
/* 0F91F0 8028FBE0 AFBF0014 */  sw    $ra, 0x14($sp)
/* 0F91F4 8028FBE4 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F91F8 8028FBE8 240E0006 */  li    $t6, 6
/* 0F91FC 8028FBEC AC2EC510 */  sw    $t6, %lo(gRaceControlMode)($at)
/* 0F9200 8028FBF0 0C0328CC */  jal   NaSeqFadeout
/* 0F9204 8028FBF4 24040019 */   li    $a0, 25
/* 0F9208 8028FBF8 0C0328E2 */  jal   NaSEFadeout
/* 0F920C 8028FBFC 24040019 */   li    $a0, 25
/* 0F9210 8028FC00 24020001 */  li    $v0, 1
/* 0F9214 8028FC04 3C01800E */  lui   $at, %hi(gBackgroundFlag) # $at, 0x800e
/* 0F9218 8028FC08 A422C5B4 */  sh    $v0, %lo(gBackgroundFlag)($at)
/* 0F921C 8028FC0C 3C01800E */  lui   $at, %hi(gClearCFBFlag) # $at, 0x800e
/* 0F9220 8028FC10 A422C5B0 */  sh    $v0, %lo(gClearCFBFlag)($at)
/* 0F9224 8028FC14 8FBF0014 */  lw    $ra, 0x14($sp)
/* 0F9228 8028FC18 3C01800E */  lui   $at, %hi(gTwoDFlag) # $at, 0x800e
/* 0F922C 8028FC1C A420C5B8 */  sh    $zero, %lo(gTwoDFlag)($at)
/* 0F9230 8028FC20 3C01802C */  lui   $at, %hi(gFinishCount) # $at, 0x802c
/* 0F9234 8028FC24 240F0005 */  li    $t7, 5
/* 0F9238 8028FC28 AC2FA038 */  sw    $t7, %lo(gFinishCount)($at)
/* 0F923C 8028FC2C 03E00008 */  jr    $ra
/* 0F9240 8028FC30 27BD0018 */   addiu $sp, $sp, 0x18

glabel CheckTitleDemo
/* 0F9244 8028FC34 3C03802C */  lui   $v1, %hi(gFinishCount) # $v1, 0x802c
/* 0F9248 8028FC38 2463A038 */  addiu $v1, %lo(gFinishCount) # addiu $v1, $v1, -0x5fc8
...
glabel RaceControl
/* 0F92CC 8028FCBC 3C0E8019 */  lui   $t6, %hi(gDemoPlayFlag) # $t6, 0x8019
/* 0F92D0 8028FCC0 81CEEE08 */  lb    $t6, %lo(gDemoPlayFlag)($t6)
/* 0F92D4 8028FCC4 27BDFFD8 */  addiu $sp, $sp, -0x28
/* 0F92D8 8028FCC8 3C05800F */  lui   $a1, %hi(gKartData) # $a1, 0x800f
/* 0F92DC 8028FCCC AFBF0014 */  sw    $ra, 0x14($sp)
/* 0F92E0 8028FCD0 11C00004 */  beqz  $t6, .L8028FCE4
/* 0F92E4 8028FCD4 24A56990 */   addiu $a1, %lo(gKartData) # addiu $a1, $a1, 0x6990
/* 0F92E8 8028FCD8 0C0A3F0D */  jal   CheckTitleDemo
/* 0F92EC 8028FCDC AFA50024 */   sw    $a1, 0x24($sp)
/* 0F92F0 8028FCE0 8FA50024 */  lw    $a1, 0x24($sp)
.L8028FCE4:
/* 0F92F4 8028FCE4 3C06800E */  lui   $a2, %hi(gRaceControlMode) # $a2, 0x800e
/* 0F92F8 8028FCE8 24C6C510 */  addiu $a2, %lo(gRaceControlMode) # addiu $a2, $a2, -0x3af0
...
/* 0F930C 8028FCFC 3C01802C */  lui   $at, %hi(JTBL_RaceControl)
/* 0F9310 8028FD00 002F0821 */  addu  $at, $at, $t7
/* 0F9314 8028FD04 8C2F927C */  lw    $t7, %lo(JTBL_RaceControl)($at)
/* 0F9318 8028FD08 01E00008 */  jr    $t7
/* 0F931C 8028FD0C 00000000 */   nop
glabel L8028FD10
/* 0F9320 8028FD10 3C18800E */  lui   $t8, %hi(gDemoFlag) # $t8, 0x800e
/* 0F9324 8028FD14 9718C51C */  lhu   $t8, %lo(gDemoFlag)($t8)
/* 0F9328 8028FD18 3C19800E */  lui   $t9, %hi(gGameMode) # $t9, 0x800e
/* 0F932C 8028FD1C 17000013 */  bnez  $t8, .L8028FD6C
/* 0F9330 8028FD20 00000000 */   nop
/* 0F9334 8028FD24 8F39C53C */  lw    $t9, %lo(gGameMode)($t9)
...
/* 0F9360 8028FD50 0C032384 */  jal   NaSystemStart
...
.L8028FD60:
/* 0F9370 8028FD60 0C0323BE */  jal   NaFanStart
/* 0F9374 8028FD64 AFA50024 */   sw    $a1, 0x24($sp)
/* 0F9378 8028FD68 8FA50024 */  lw    $a1, 0x24($sp)
.L8028FD6C:
/* 0F937C 8028FD6C 0C000B6B */  jal   DelayInitialMap
/* 0F9380 8028FD70 AFA50024 */   sw    $a1, 0x24($sp)
/* 0F9384 8028FD74 24040001 */  li    $a0, 1
/* 0F9388 8028FD78 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F938C 8028FD7C AC24C510 */  sw    $a0, %lo(gRaceControlMode)($at)
/* 0F9390 8028FD80 3C014040 */  li    $at, 0x40400000 # 3.000000
/* 0F9394 8028FD84 44812000 */  mtc1  $at, $f4
/* 0F9398 8028FD88 3C018015 */  lui   $at, %hi(CountdownCounter) # $at, 0x8015
/* 0F939C 8028FD8C 44800000 */  mtc1  $zero, $f0
/* 0F93A0 8028FD90 E4240118 */  swc1  $f4, %lo(CountdownCounter)($at)
/* 0F93A4 8028FD94 3C01800E */  lui   $at, %hi(gDisplayFlag) # $at, 0x800e
/* 0F93A8 8028FD98 A420C518 */  sh    $zero, %lo(gDisplayFlag)($at)
/* 0F93AC 8028FD9C 3C01802C */  lui   $at, %hi(gSoundSetFlag) # $at, 0x802c
/* 0F93B0 8028FDA0 A420A032 */  sh    $zero, %lo(gSoundSetFlag)($at)
/* 0F93B4 8028FDA4 3C018015 */  lui   $at, %hi(gTimeFlag) # $at, 0x8015
/* 0F93B8 8028FDA8 A420011E */  sh    $zero, %lo(gTimeFlag)($at)
/* 0F93BC 8028FDAC 3C01800E */  lui   $at, %hi(gRaceTimer) # $at, 0x800e
/* 0F93C0 8028FDB0 E420C598 */  swc1  $f0, %lo(gRaceTimer)($at)
/* 0F93C4 8028FDB4 3C01800E */  lui   $at, %hi(gTimer) # $at, 0x800e
/* 0F93C8 8028FDB8 E420C594 */  swc1  $f0, %lo(gTimer)($at)
/* 0F93CC 8028FDBC 24070001 */  li    $a3, 1
/* 0F93D0 8028FDC0 3C01800E */  lui   $at, %hi(gClearCFBFlag) # $at, 0x800e
/* 0F93D4 8028FDC4 A427C5B0 */  sh    $a3, %lo(gClearCFBFlag)($at)
/* 0F93D8 8028FDC8 3C01800E */  lui   $at, %hi(gBackgroundFlag) # $at, 0x800e
/* 0F93DC 8028FDCC A427C5B4 */  sh    $a3, %lo(gBackgroundFlag)($at)
/* 0F93E0 8028FDD0 3C01802C */  lui   $at, %hi(D_802B929C) # $at, 0x802c
/* 0F93E4 8028FDD4 C426929C */  lwc1  $f6, %lo(D_802B929C)($at)
/* 0F93E8 8028FDD8 3C08800E */  lui   $t0, %hi(gRaceScreenMode) # $t0, 0x800e
/* 0F93EC 8028FDDC 8D08C530 */  lw    $t0, %lo(gRaceScreenMode)($t0)
/* 0F93F0 8028FDE0 3C01802C */  lui   $at, %hi(gScreenZoom) # $at, 0x802c
/* 0F93F4 8028FDE4 E426A034 */  swc1  $f6, %lo(gScreenZoom)($at)
/* 0F93F8 8028FDE8 3C018016 */  lui   $at, %hi(gFinishZoomFlag) # $at, 0x8016
/* 0F93FC 8028FDEC 8FA50024 */  lw    $a1, 0x24($sp)
/* 0F9400 8028FDF0 11000007 */  beqz  $t0, .L8028FE10
/* 0F9404 8028FDF4 A420F894 */   sh    $zero, %lo(gFinishZoomFlag)($at)
/* 0F9408 8028FDF8 3C048019 */  lui   $a0, %hi(OrderDispSW) # $a0, 0x8019
/* 0F940C 8028FDFC 2484D2AC */  addiu $a0, %lo(OrderDispSW) # addiu $a0, $a0, -0x2d54
/* 0F9410 8028FE00 0C017193 */  jal   KWDisplayOn
...
/* 0F9494 8028FE84 3C01800E */  lui   $at, %hi(gTwoDFlag) # $at, 0x800e
/* 0F9498 8028FE88 1000011E */  b     .L80290304
/* 0F949C 8028FE8C A427C5B8 */   sh    $a3, %lo(gTwoDFlag)($at)
glabel L8028FE90
/* 0F94A0 8028FE90 0C0A3E45 */  jal   ZoomInScreen
/* 0F94A4 8028FE94 00000000 */   nop
/* 0F94A8 8028FE98 3C013F80 */  li    $at, 0x3F800000 # 1.000000
/* 0F94AC 8028FE9C 44814000 */  mtc1  $at, $f8
/* 0F94B0 8028FEA0 3C01802C */  lui   $at, %hi(gScreenZoom) # $at, 0x802c
/* 0F94B4 8028FEA4 C42AA034 */  lwc1  $f10, %lo(gScreenZoom)($at)
/* 0F94B8 8028FEA8 3C0D800E */  lui   $t5, %hi(gScreenMode) # $t5, 0x800e
...
/* 0F94CC 8028FEBC 8DADC52C */  lw    $t5, %lo(gScreenMode)($t5)
/* 0F94D0 8028FEC0 3C03800E */  lui   $v1, %hi(gMapNumber) # $v1, 0x800e
/* 0F94D4 8028FEC4 51A0000F */  beql  $t5, $zero, .L8028FF04
/* 0F94D8 8028FEC8 240E0002 */   li    $t6, 2
/* 0F94DC 8028FECC 8463C5A0 */  lh    $v1, %lo(gMapNumber)($v1)
...
/* 0F94F0 8028FEE0 0C0A9E50 */  jal   TakeSnapshot9
...
/* 0F9508 8028FEF8 0C0A9DCA */  jal   TakeSnapshot15
/* 0F950C 8028FEFC 00000000 */   nop
/* 0F9510 8028FF00 240E0002 */  li    $t6, 2
.L8028FF04:
/* 0F9514 8028FF04 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F9518 8028FF08 AC2EC510 */  sw    $t6, %lo(gRaceControlMode)($at)
/* 0F951C 8028FF0C 3C01800E */  lui   $at, %hi(gClearCFBFlag) # $at, 0x800e
/* 0F9520 8028FF10 A420C5B0 */  sh    $zero, %lo(gClearCFBFlag)($at)
/* 0F9524 8028FF14 24070001 */  li    $a3, 1
/* 0F9528 8028FF18 3C01800E */  lui   $at, %hi(gTwoDFlag) # $at, 0x800e
/* 0F952C 8028FF1C 0C01E3D9 */  jal   KWJugemuStart
/* 0F9530 8028FF20 A427C5B8 */   sh    $a3, %lo(gTwoDFlag)($at)
/* 0F9534 8028FF24 3C0F800E */  lui   $t7, %hi(gGameMode) # $t7, 0x800e
/* 0F9538 8028FF28 8DEFC53C */  lw    $t7, %lo(gGameMode)($t7)
/* 0F953C 8028FF2C 24040001 */  li    $a0, 1
/* 0F9540 8028FF30 3C188016 */  lui   $t8, %hi(gROMGhostStatus) # $t8, 0x8016
/* 0F9544 8028FF34 148F0020 */  bne   $a0, $t7, .L8028FFB8
/* 0F9548 8028FF38 00000000 */   nop
/* 0F954C 8028FF3C 97182DD6 */  lhu   $t8, %lo(gROMGhostStatus)($t8)
/* 0F9550 8028FF40 3C03800E */  lui   $v1, %hi(gMapNumber) # $v1, 0x800e
/* 0F9554 8028FF44 3C088016 */  lui   $t0, %hi(gReplayFlag) # $t0, 0x8016
/* 0F9558 8028FF48 1700001B */  bnez  $t8, .L8028FFB8
/* 0F955C 8028FF4C 00000000 */   nop
/* 0F9560 8028FF50 8463C5A0 */  lh    $v1, %lo(gMapNumber)($v1)
...
.L8028FF74:
/* 0F9584 8028FF74 9508F890 */  lhu   $t0, %lo(gReplayFlag)($t0)
/* 0F9588 8028FF78 3C03800E */  lui   $v1, %hi(gGhostMessageFlag) # $v1, 0x800e
/* 0F958C 8028FF7C 2463C5AC */  addiu $v1, %lo(gGhostMessageFlag) # addiu $v1, $v1, -0x3a54
...
/* 0F95A8 8028FF98 0C02498C */  jal   DispMessageRomGhost
/* 0F95AC 8028FF9C AFA2001C */   sw    $v0, 0x1c($sp)
/* 0F95B0 8028FFA0 3C03800E */  lui   $v1, %hi(gGhostMessageFlag) # $v1, 0x800e
/* 0F95B4 8028FFA4 2463C5AC */  addiu $v1, %lo(gGhostMessageFlag) # addiu $v1, $v1, -0x3a54
...
.L8028FFB8:
/* 0F95C8 8028FFB8 3C0D800E */  lui   $t5, %hi(gPlayerNumber) # $t5, 0x800e
/* 0F95CC 8028FFBC 8DADC538 */  lw    $t5, %lo(gPlayerNumber)($t5)
/* 0F95D0 8028FFC0 24010003 */  li    $at, 3
/* 0F95D4 8028FFC4 15A10003 */  bne   $t5, $at, .L8028FFD4
/* 0F95D8 8028FFC8 00000000 */   nop
/* 0F95DC 8028FFCC 0C024968 */  jal   DispInfo3P
/* 0F95E0 8028FFD0 00000000 */   nop
.L8028FFD4:
/* 0F95E4 8028FFD4 0C0A3D3A */  jal   RaceResetCheck
/* 0F95E8 8028FFD8 00000000 */   nop
/* 0F95EC 8028FFDC 100000CA */  b     .L80290308
/* 0F95F0 8028FFE0 8FBF0014 */   lw    $ra, 0x14($sp)
glabel L8028FFE4
/* 0F95F4 8028FFE4 3C0E800E */  lui   $t6, %hi(gDemoFlag) # $t6, 0x800e
/* 0F95F8 8028FFE8 95CEC51C */  lhu   $t6, %lo(gDemoFlag)($t6)
/* 0F95FC 8028FFEC 11C00003 */  beqz  $t6, .L8028FFFC
/* 0F9600 8028FFF0 00000000 */   nop
/* 0F9604 8028FFF4 0C0A3B6A */  jal   StartRacing
/* 0F9608 8028FFF8 00000000 */   nop
.L8028FFFC:
/* 0F960C 8028FFFC 3C0F800E */  lui   $t7, %hi(gDebugFlag) # $t7, 0x800e
/* 0F9610 80290000 95EFC520 */  lhu   $t7, %lo(gDebugFlag)($t7)
/* 0F9614 80290004 3C18800E */  lui   $t8, %hi(gContOR) # $t8, 0x800e
/* 0F9618 80290008 11E00008 */  beqz  $t7, .L8029002C
/* 0F961C 8029000C 00000000 */   nop
/* 0F9620 80290010 8F18C4CC */  lw    $t8, %lo(gContOR)($t8)
...
/* 0F96B0 802900A0 3C03802C */   lui   $v1, %hi(gFinishCount)
...
.L802900B8:
/* 0F96C8 802900B8 0C0A3D3A */  jal   RaceResetCheck
/* 0F96CC 802900BC 00000000 */   nop
/* 0F96D0 802900C0 0C0A3CFC */  jal   CheckKartRank
/* 0F96D4 802900C4 00000000 */   nop
/* 0F96D8 802900C8 0C0A3BCA */  jal   CheckKartLap
/* 0F96DC 802900CC 00000000 */   nop
/* 0F96E0 802900D0 0C0A3E5C */  jal   CheckPause
/* 0F96E4 802900D4 00000000 */   nop
/* 0F96E8 802900D8 3C02800E */  lui   $v0, %hi(gRaceScreenMode) # $v0, 0x800e
/* 0F96EC 802900DC 8C42C530 */  lw    $v0, %lo(gRaceScreenMode)($v0)
/* 0F96F0 802900E0 3C03802C */  lui   $v1, %hi(gFinishCount) # $v1, 0x802c
/* 0F96F4 802900E4 2463A038 */  addiu $v1, %lo(gFinishCount) # addiu $v1, $v1, -0x5fc8
...
/* 0F9724 80290114 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F9728 80290118 0C0A38A6 */  jal   CheckGoalInTime
/* 0F972C 8029011C AC2BC510 */   sw    $t3, %lo(gRaceControlMode)($at)
/* 0F9730 80290120 10000079 */  b     .L80290308
/* 0F9734 80290124 8FBF0014 */   lw    $ra, 0x14($sp)
.L80290128:
/* 0F9738 80290128 3C02800E */  lui   $v0, %hi(gKart1) # $v0, 0x800e
/* 0F973C 8029012C 8C42C4DC */  lw    $v0, %lo(gKart1)($v0)
/* 0F9740 80290130 3C03800E */  lui   $v1, %hi(gKart2) # $v1, 0x800e
...
/* 0F9754 80290144 8C63C4E0 */  lw    $v1, %lo(gKart2)($v1)
...
/* 0F9778 80290168 3C01800E */   lui   $at, %hi(gWinKart) # $at, 0x800e
/* 0F977C 8029016C 10000003 */  b     .L8029017C
/* 0F9780 80290170 AC24C5E8 */   sw    $a0, %lo(gWinKart)($at)
.L80290174:
/* 0F9784 80290174 3C01800E */  lui   $at, %hi(gWinKart) # $at, 0x800e
/* 0F9788 80290178 AC20C5E8 */  sw    $zero, %lo(gWinKart)($at)
.L8029017C:
/* 0F978C 8029017C 0C0A38A6 */  jal   CheckGoalInTime
/* 0F9790 80290180 00000000 */   nop
/* 0F9794 80290184 3C03802C */  lui   $v1, %hi(gFinishCount) # $v1, 0x802c
/* 0F9798 80290188 2463A038 */  addiu $v1, %lo(gFinishCount) # addiu $v1, $v1, -0x5fc8
/* 0F979C 8029018C 24080258 */  li    $t0, 600
/* 0F97A0 80290190 AC680000 */  sw    $t0, ($v1)
/* 0F97A4 80290194 24090005 */  li    $t1, 5
/* 0F97A8 80290198 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F97AC 8029019C 10000059 */  b     .L80290304
/* 0F97B0 802901A0 AC29C510 */   sw    $t1, %lo(gRaceControlMode)($at)
.L802901A4:
/* 0F97B4 802901A4 0C0A3D3A */  jal   RaceResetCheck
/* 0F97B8 802901A8 00000000 */   nop
/* 0F97BC 802901AC 0C0A3CFC */  jal   CheckKartRank
/* 0F97C0 802901B0 00000000 */   nop
/* 0F97C4 802901B4 0C0A3BCA */  jal   CheckKartLap
/* 0F97C8 802901B8 00000000 */   nop
/* 0F97CC 802901BC 0C0A3E5C */  jal   CheckPause
/* 0F97D0 802901C0 00000000 */   nop
/* 0F97D4 802901C4 10000050 */  b     .L80290308
/* 0F97D8 802901C8 8FBF0014 */   lw    $ra, 0x14($sp)
.L802901CC:
/* 0F97DC 802901CC 2463A038 */  addiu $v1, $v1, %lo(gFinishCount)
/* 0F97E0 802901D0 240A0168 */  li    $t2, 360
/* 0F97E4 802901D4 AC6A0000 */  sw    $t2, ($v1)
/* 0F97E8 802901D8 3C0B8016 */  lui   $t3, %hi(gReplayFlag) # $t3, 0x8016
/* 0F97EC 802901DC 956BF890 */  lhu   $t3, %lo(gReplayFlag)($t3)
...
glabel L80290200
/* 0F9810 80290200 3C03802C */  lui   $v1, %hi(gFinishCount) # $v1, 0x802c
/* 0F9814 80290204 2463A038 */  addiu $v1, %lo(gFinishCount) # addiu $v1, $v1, -0x5fc8
...
.L8029021C:
/* 0F982C 8029021C 3C02800E */  lui   $v0, %hi(gGameMode) # $v0, 0x800e
/* 0F9830 80290220 8C42C53C */  lw    $v0, %lo(gGameMode)($v0)
...
.L8029024C:
/* 0F985C 8029024C 3C0F8015 */  lui   $t7, %hi(gRaceClearFlag) # $t7, 0x8015
/* 0F9860 80290250 8DEF0120 */  lw    $t7, %lo(gRaceClearFlag)($t7)
/* 0F9864 80290254 3C18800E */  lui   $t8, %hi(gRaceScreenMode) # $t8, 0x800e
/* 0F9868 80290258 11E00005 */  beqz  $t7, .L80290270
/* 0F986C 8029025C 00000000 */   nop
/* 0F9870 80290260 0C0A399E */  jal   FinishZoom
/* 0F9874 80290264 00000000 */   nop
/* 0F9878 80290268 10000014 */  b     .L802902BC
/* 0F987C 8029026C 00000000 */   nop
.L80290270:
/* 0F9880 80290270 8F18C530 */  lw    $t8, %lo(gRaceScreenMode)($t8)
/* 0F9884 80290274 17000007 */  bnez  $t8, .L80290294
/* 0F9888 80290278 00000000 */   nop
/* 0F988C 8029027C 0C024959 */  jal   DispGPLose
/* 0F9890 80290280 00000000 */   nop
/* 0F9894 80290284 24190007 */  li    $t9, 7
/* 0F9898 80290288 3C01800E */  lui   $at, %hi(gRaceControlMode) # $at, 0x800e
/* 0F989C 8029028C 1000000B */  b     .L802902BC
/* 0F98A0 80290290 AC39C510 */   sw    $t9, %lo(gRaceControlMode)($at)
.L80290294:
/* 0F98A4 80290294 0C0A390E */  jal   FinishVSZoom
/* 0F98A8 80290298 00000000 */   nop
/* 0F98AC 8029029C 10000007 */  b     .L802902BC
/* 0F98B0 802902A0 00000000 */   nop
.L802902A4:
/* 0F98B4 802902A4 0C0A399E */  jal   FinishZoom
/* 0F98B8 802902A8 00000000 */   nop
/* 0F98BC 802902AC 10000003 */  b     .L802902BC
/* 0F98C0 802902B0 00000000 */   nop
.L802902B4:
/* 0F98C4 802902B4 0C0A390E */  jal   FinishVSZoom
/* 0F98C8 802902B8 00000000 */   nop
.L802902BC:
/* 0F98CC 802902BC 0C0A3D3A */  jal   RaceResetCheck
/* 0F98D0 802902C0 00000000 */   nop
/* 0F98D4 802902C4 10000010 */  b     .L80290308
/* 0F98D8 802902C8 8FBF0014 */   lw    $ra, 0x14($sp)
glabel L802902CC
/* 0F98DC 802902CC 0C0A3E2F */  jal   ZoomOutScreen
/* 0F98E0 802902D0 00000000 */   nop
/* 0F98E4 802902D4 3C01802C */  lui   $at, %hi(gScreenZoom) # $at, 0x802c
/* 0F98E8 802902D8 C432A034 */  lwc1  $f18, %lo(gScreenZoom)($at)
/* 0F98EC 802902DC 44808000 */  mtc1  $zero, $f16
/* 0F98F0 802902E0 24070001 */  li    $a3, 1
/* 0F98F4 802902E4 3C01800E */  lui   $at, %hi(gFadeoutFlag) # $at, 0x800e
...
/* 0F9908 802902F8 A427C5C0 */  sh    $a3, %lo(gFadeoutFlag)($at)
/* 0F990C 802902FC 3C01800E */  lui   $at, %hi(gFadeoutCount) # $at, 0x800e
/* 0F9910 80290300 A428C5C4 */  sh    $t0, %lo(gFadeoutCount)($at)
.L80290304:
glabel L80290304
...
/* 0F9928 80290318 3C01800E */  lui   $at, %hi(gFadeoutFlag) # $at, 0x800e
/* 0F992C 8029031C A42EC5C0 */  sh    $t6, %lo(gFadeoutFlag)($at)
/* 0F9930 80290320 3C01800E */  lui   $at, %hi(gFadeoutCount) # $at, 0x800e
/* 0F9934 80290324 240F0005 */  li    $t7, 5
/* 0F9938 80290328 A42FC5C4 */  sh    $t7, %lo(gFadeoutCount)($at)
...
/* 0F994C 8029033C 3C01800E */  lui   $at, %hi(gFadeoutFlag) # $at, 0x800e
/* 0F9950 80290340 A42EC5C0 */  sh    $t6, %lo(gFadeoutFlag)($at)
/* 0F9954 80290344 3C01800E */  lui   $at, %hi(gFadeoutCount) # $at, 0x800e
/* 0F9958 80290348 240F0005 */  li    $t7, 5
/* 0F995C 8029034C A42FC5C4 */  sh    $t7, %lo(gFadeoutCount)($at)
...
glabel GoToGameSelect
/* 0F9970 80290360 240E0001 */  li    $t6, 1
/* 0F9974 80290364 3C01800E */  lui   $at, %hi(gFadeoutFlag) # $at, 0x800e
/* 0F9978 80290368 A42EC5C0 */  sh    $t6, %lo(gFadeoutFlag)($at)
/* 0F997C 8029036C 3C01800E */  lui   $at, %hi(gFadeoutCount) # $at, 0x800e
/* 0F9980 80290370 240F0005 */  li    $t7, 5
/* 0F9984 80290374 A42FC5C4 */  sh    $t7, %lo(gFadeoutCount)($at)
...
glabel GoToKartSelect
/* 0F9998 80290388 240E0001 */  li    $t6, 1
/* 0F999C 8029038C 3C01800E */  lui   $at, %hi(gFadeoutFlag) # $at, 0x800e
/* 0F99A0 80290390 A42EC5C0 */  sh    $t6, %lo(gFadeoutFlag)($at)
/* 0F99A4 80290394 3C01800E */  lui   $at, %hi(gFadeoutCount) # $at, 0x800e
/* 0F99A8 80290398 240F0005 */  li    $t7, 5
/* 0F99AC 8029039C A42FC5C4 */  sh    $t7, %lo(gFadeoutCount)($at)
...
glabel GoToMapSelect
/* 0F99C0 802903B0 240E0001 */  li    $t6, 1
/* 0F99C4 802903B4 3C01800E */  lui   $at, %hi(gFadeoutFlag) # $at, 0x800e
/* 0F99C8 802903B8 A42EC5C0 */  sh    $t6, %lo(gFadeoutFlag)($at)
/* 0F99CC 802903BC 3C01800E */  lui   $at, %hi(gFadeoutCount) # $at, 0x800e
/* 0F99D0 802903C0 240F0005 */  li    $t7, 5
/* 0F99D4 802903C4 A42FC5C4 */  sh    $t7, %lo(gFadeoutCount)($at)
...
/* 0F9B64 80290554 0C023F07 */  jal   KillBombKart
/* 0F9B68 80290558 AFA5007C */   sw    $a1, 0x7c($sp)
/* 0F9B6C 8029055C 0C023F07 */  jal   KillBombKart
/* 0F9B70 80290560 8FA4007C */   lw    $a0, 0x7c($sp)
/* 0F9B74 80290564 3C08800E */  lui   $t0, %hi(gKart1) # $t0, 0x800e
/* 0F9B78 80290568 8FA6007C */  lw    $a2, 0x7c($sp)
/* 0F9B7C 8029056C 8D08C4DC */  lw    $t0, %lo(gKart1)($t0)
...
/* 0F9B98 80290588 0C032418 */  jal   NaPlyTrgStart
...
/* 0F9BC4 802905B4 0C023F07 */  jal   KillBombKart
/* 0F9BC8 802905B8 AFA6007C */   sw    $a2, 0x7c($sp)
/* 0F9BCC 802905BC 3C0D800E */  lui   $t5, %hi(gKart1) # $t5, 0x800e
/* 0F9BD0 802905C0 8FA6007C */  lw    $a2, 0x7c($sp)
/* 0F9BD4 802905C4 8DADC4DC */  lw    $t5, %lo(gKart1)($t5)
...
/* 0F9BF0 802905E0 0C032418 */  jal   NaPlyTrgStart
...
/* 0F9C2C 8029061C 0C023F07 */  jal   KillBombKart
/* 0F9C30 80290620 AFA70078 */   sw    $a3, 0x78($sp)
/* 0F9C34 80290624 3C0A800E */  lui   $t2, %hi(gKart1) # $t2, 0x800e
/* 0F9C38 80290628 8FA70078 */  lw    $a3, 0x78($sp)
/* 0F9C3C 8029062C 8D4AC4DC */  lw    $t2, %lo(gKart1)($t2)
...
/* 0F9C58 80290648 0C032418 */  jal   NaPlyTrgStart
...
/* 0F9DE4 802907D4 3C0B800E */  lui   $t3, %hi(gKart1) # $t3, 0x800e
...
/* 0F9F8C 8029097C 8D6BC4DC */  lw    $t3, %lo(gKart1)($t3)
...
/* 0F9FA8 80290998 0C032418 */  jal   NaPlyTrgStart
...
.L802909AC:
/* 0F9FBC 802909AC 3C0E800E */  lui   $t6, %hi(gKart1) # $t6, 0x800e
...
/* 0F9FCC 802909BC 8DCEC4DC */  lw    $t6, %lo(gKart1)($t6)
...
/* 0F9FE8 802909D8 0C032418 */  jal   NaPlyTrgStart
...
/* 0FA01C 80290A0C 3C11800F */  lui   $s1, %hi(gKartData) # $s1, 0x800f
...
/* 0FA030 80290A20 26316990 */  addiu $s1, %lo(gKartData) # addiu $s1, $s1, 0x6990
...
/* 0FA098 80290A88 3C09800F */  lui   $t1, %hi(gKartData) # $t1, 0x800f
/* 0FA09C 80290A8C 25296990 */  addiu $t1, %lo(gKartData) # addiu $t1, $t1, 0x6990
...
/* 0FA0DC 80290ACC 0C0A40F6 */  jal   CheckCol
...
glabel PauseSequence
/* 0FA124 80290B14 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 0FA128 80290B18 AFBF0014 */  sw    $ra, 0x14($sp)
/* 0FA12C 80290B1C 0C016714 */  jal   KWPausesYori
/* 0FA130 80290B20 00000000 */   nop
/* 0FA134 80290B24 3C02800E */  lui   $v0, %hi(gScreenMode) # $v0, 0x800e
/* 0FA138 80290B28 8C42C52C */  lw    $v0, %lo(gScreenMode)($v0)
/* 0FA13C 80290B2C 3C04800E */  lui   $a0, 0x800e
/* 0FA140 80290B30 3C05800E */  lui   $a1, %hi(gCamera1) # $a1, 0x800e
...
/* 0FA168 80290B58 3C04800E */   lui   $a0, %hi(gMyKart1) # $a0, 0x800e
/* 0FA16C 80290B5C 1000002B */  b     .L80290C0C
/* 0FA170 80290B60 8FBF0014 */   lw    $ra, 0x14($sp)
.L80290B64:
/* 0FA174 80290B64 8C84C4FC */  lw    $a0, %lo(gMyKart1)($a0)
/* 0FA178 80290B68 0C007BA6 */  jal   CameraControl
/* 0FA17C 80290B6C 8CA5DB40 */   lw    $a1, %lo(gCamera1)($a1)
/* 0FA180 80290B70 10000026 */  b     .L80290C0C
/* 0FA184 80290B74 8FBF0014 */   lw    $ra, 0x14($sp)
.L80290B78:
/* 0FA188 80290B78 3C05800E */  lui   $a1, %hi(gCamera1) # $a1, 0x800e
/* 0FA18C 80290B7C 8CA5DB40 */  lw    $a1, %lo(gCamera1)($a1)
/* 0FA190 80290B80 8C84C4FC */  lw    $a0, -0x3b04($a0)
/* 0FA194 80290B84 0C007BA6 */  jal   CameraControl
/* 0FA198 80290B88 00003025 */   move  $a2, $zero
/* 0FA19C 80290B8C 3C04800E */  lui   $a0, %hi(gMyKart2) # $a0, 0x800e
/* 0FA1A0 80290B90 3C05800E */  lui   $a1, %hi(gCamera2) # $a1, 0x800e
/* 0FA1A4 80290B94 8CA5DB44 */  lw    $a1, %lo(gCamera2)($a1)
/* 0FA1A8 80290B98 8C84C500 */  lw    $a0, %lo(gMyKart2)($a0)
/* 0FA1AC 80290B9C 0C007BA6 */  jal   CameraControl
/* 0FA1B0 80290BA0 24060001 */   li    $a2, 1
/* 0FA1B4 80290BA4 10000019 */  b     .L80290C0C
/* 0FA1B8 80290BA8 8FBF0014 */   lw    $ra, 0x14($sp)
.L80290BAC:
/* 0FA1BC 80290BAC 3C05800E */  lui   $a1, %hi(gCamera1) # $a1, 0x800e
/* 0FA1C0 80290BB0 8CA5DB40 */  lw    $a1, %lo(gCamera1)($a1)
/* 0FA1C4 80290BB4 8C84C4FC */  lw    $a0, -0x3b04($a0)
/* 0FA1C8 80290BB8 0C007BA6 */  jal   CameraControl
/* 0FA1CC 80290BBC 00003025 */   move  $a2, $zero
/* 0FA1D0 80290BC0 3C04800E */  lui   $a0, %hi(gKart2) # $a0, 0x800e
/* 0FA1D4 80290BC4 3C05800E */  lui   $a1, %hi(gCamera2) # $a1, 0x800e
/* 0FA1D8 80290BC8 8CA5DB44 */  lw    $a1, %lo(gCamera2)($a1)
/* 0FA1DC 80290BCC 8C84C4E0 */  lw    $a0, %lo(gKart2)($a0)
/* 0FA1E0 80290BD0 0C007BA6 */  jal   CameraControl
/* 0FA1E4 80290BD4 24060001 */   li    $a2, 1
/* 0FA1E8 80290BD8 3C04800E */  lui   $a0, %hi(gKart3) # $a0, 0x800e
/* 0FA1EC 80290BDC 3C05800E */  lui   $a1, %hi(gCamera3) # $a1, 0x800e
/* 0FA1F0 80290BE0 8CA5DB48 */  lw    $a1, %lo(gCamera3)($a1)
/* 0FA1F4 80290BE4 8C84C4E4 */  lw    $a0, %lo(gKart3)($a0)
/* 0FA1F8 80290BE8 0C007BA6 */  jal   CameraControl
/* 0FA1FC 80290BEC 24060002 */   li    $a2, 2
/* 0FA200 80290BF0 3C04800E */  lui   $a0, %hi(gKart4) # $a0, 0x800e
/* 0FA204 80290BF4 3C05800E */  lui   $a1, %hi(gCamera4) # $a1, 0x800e
/* 0FA208 80290BF8 8CA5DB4C */  lw    $a1, %lo(gCamera4)($a1)
/* 0FA20C 80290BFC 8C84C4E8 */  lw    $a0, %lo(gKart4)($a0)
/* 0FA210 80290C00 0C007BA6 */  jal   CameraControl
